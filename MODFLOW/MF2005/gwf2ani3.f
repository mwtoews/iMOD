...
c ------------------------------------------------------------------------------
      ...
      call ani7fm(buff,dfu,dfd,dff,dfr,ncol,nrow,nlay,idir)
       ...
       do irow=1,nrow-1
        do icol=1,ncol-1
         if(ibound(icol,irow,ilay).lt.0)then
          ...
          if(ibound(icol+1,irow+1,ilay).lt.0)dcd(icol,irow,ilay)=0.0
          if(irow.gt.1)then
           if(ibound(icol+1,irow-1,ilay).lt.0)dcu(icol,irow,ilay)=0.0
          endif
         endif
        enddo
       enddo
