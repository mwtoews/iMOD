...
USE IMOD_UTL, ONLY : IMOD_UTL_IDATETOJDATE,IMOD_UTL_FILENAME,IMOD_UTL_PRINTTEXT,IMOD_UTL_ITOS, &
   ...
   XA,YA,ZA,FA,LN,CA,RA,INTERSECT_DEALLOCATE
...
DO I=1,NISGH
 ...
 IREC=ISEG-1
 DO J=1,NSEG
  READ(ISGIU(2),REC=IREC+J+ICF) XS,YS !X(J),Y(J)
  X(J)=XS
  Y(J)=YS
 END DO
...
DO I=1,NTYP
 ...
 DXY=REAL(SDIST,8)  !k=number,dxy=distance from beginning
