...
! parameters
character(len=1024), parameter :: licfile = 'I_accepted_v3_3.txt'
...
data hdr/'===============================================================================',&!01
         'iMODFLOW Version 3_3, March 2016                                               ',&!02
         '                                                                               ',&!03
         ...
         '                                                                               ',&!06
         'According to the file "I_accepted_v3_3.txt" on your computer you accepted the  ',&!07
         ...
         'the file "I_accepted_v3_3.txt", and invoke this Deltares-executable of iMOD    ',&!09
         'again.                                                                         ',&!10
         '                                                                               ',&!01
