...
!     RETURN
 ...
 DO IP1=1,SIZE(PARAM)
  ...
  IF(ABS(PARAM(IP1)%IACT).EQ.1.AND.PARAM(IP1)%IGROUP.GT.0)THEN
   WRITE(IUPESTOUT,'(3X,A2,2I5,A1,I3.3,A)') PARAM(IP1)%PTYPE,PARAM(IP1)%ILS,PARAM(IP1)%IZONE,'-',ABS(PARAM(IP1)%IGROUP),TRIM(LINE)
  ENDIF
 ...
 DO IP1=1,SIZE(PARAM)
  ...
  IF(ABS(PARAM(IP1)%IACT).EQ.1.AND.PARAM(IP1)%IGROUP.GT.0)THEN
   WRITE(IUPESTOUT,'(3X,A2,2I5,A1,I3.3,A)') PARAM(IP1)%PTYPE,PARAM(IP1)%ILS,PARAM(IP1)%IZONE,'-',ABS(PARAM(IP1)%IGROUP),TRIM(BLINE)
  ENDIF
 ...
 WRITE(BLINE,'(19X,99F10.3)') (GRADUPDATE(I),I=PEST_ITER,1,-1)
 CALL IMOD_UTL_PRINTTEXT(TRIM(BLINE),-1,IUPESTOUT)
