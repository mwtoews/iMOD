...
CHARACTER(LEN=10),PARAMETER :: RVERSION='v5_0'
REAL,PARAMETER :: IDFTINY=0.001          !needed to compute ir1,ir2,ic1,ic2 properly
...
CHARACTER(LEN=24),DIMENSION(:),ALLOCATABLE,SAVE :: TXTMOD !##
 ...
 REAL(KIND=8),SAVE :: MAXSIMCSIZE                              !## maximal # cells in the end
 REAL(KIND=4),SAVE :: DELT
 REAL(KIND=8),SAVE :: SIMCSIZE
 REAL(KIND=8),SAVE,DIMENSION(4) :: LAMBDA

 INTEGER,SAVE :: IURUN,IU

 INTEGER,SAVE :: ISAVE,KPER,IFTEST, &
            NMULT,IIDEBUG,IDOUBLE,IPOSWEL,ISCEN,IACT,MXNLAY,ICONCHK,&
            NLINES,IMULT,IBDG,isumbudget
 ...
 REAL(KIND=8),DIMENSION(4),SAVE :: USEBOX,SIMBOX,SAVEBOX
...
! DATA IRDIRNAMES/'default ','scenario'/
 REAL(KIND=8) :: WBALERROR

INTEGER,SAVE :: MXCNVG
REAL(KIND=8),SAVE :: MAXWBALERROR

CHARACTER(LEN=256) :: SCENFNAME

REAL(KIND=8),ALLOCATABLE,DIMENSION(:),SAVE :: DELR,DELC

REAL(KIND=8), SAVE :: MINKD, MINC
