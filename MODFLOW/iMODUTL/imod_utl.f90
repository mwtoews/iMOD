...
MODULE IMOD_UTL
 ...
 INTEGER,PARAMETER,PRIVATE :: MAXFILES=500 !9999
...
character(len=1024), parameter :: licfile = 'I_accepted_v3_5.txt' 
...
data hdr/'===============================================================================',&!01
         'iMODFLOW Version 3_5, November 2016                                            ',&!02
         '                                                                               ',&!03
         ...
         '                                                                               ',&!06
         'According to the file "I_accepted_v3_5.txt" on your computer you accepted the  ',&!07
         ...
         'the file "I_accepted_v3_5.txt", and invoke this Deltares-executable of iMOD    ',&!09
         'again.                                                                         ',&!10
         '                                                                               ',&!01
