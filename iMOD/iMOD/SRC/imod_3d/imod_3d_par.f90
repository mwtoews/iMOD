...
REAL(KIND=DP_KIND),DIMENSION(:),POINTER :: XBH,YBH,ZBH,RBH,XBH_DUMMY,YBH_DUMMY,ZBH_DUMMY,RBH_DUMMY
INTEGER,DIMENSION(:),POINTER :: CBH,CBH_DUMMY
!CHARACTER(LEN=256),DIMENSION(:),POINTER :: LBH,LBH_DUMMY
