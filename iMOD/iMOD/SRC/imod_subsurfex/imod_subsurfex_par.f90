...
MODULE MOD_SUBSURFEX_PAR
 ...
 REAL(KIND=DP_KIND) :: GRIDSIZE,INIXMIN,INIYMIN,INIXMAX,INIYMAX
 REAL(KIND=DP_KIND) :: XMIN,YMIN,XMAX,YMAX,OLDX,OLDY,NEWX,NEWY,FIRSTX,FIRSTY
 REAL(KIND=DP_KIND),ALLOCATABLE,DIMENSION(:) :: VERTICESX,VERTICESY 
