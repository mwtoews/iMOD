...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL,IPKS,ICHKCHD,IDOUBLE,ICONSISTENCY
 ...
 TYPE PSTOBJ
  ...
  REAL(KIND=DP_KIND) :: PE_DRES=0.0D00
 ...
 INTEGER :: PRJNLAY,PRJMXNLAY,IFORMAT,ISUBMODEL,PRJNPER
...
! REAL(KIND=DP_KIND),SAVE :: MINTHICKNESS=0.0D0
 ...
 INTEGER :: IUSCL   
 REAL(KIND=DP_KIND),PARAMETER :: MSWPMV=10.0D0       !##   add meter to surface level urban area
 INTEGER :: IARMWP

 !## usage of true modflow2005
 LOGICAL :: LMODFLOW2005=.FALSE.
