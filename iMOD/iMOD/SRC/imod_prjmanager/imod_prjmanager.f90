...
!  ENDDO
 ...
 CALL WDIALOGPUTDOUBLE(IDF_REAL4,PEST%PE_STOP,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL8,PEST%PE_PADJ ,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL5,PEST%PE_SENS,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL9,PEST%PE_DRES,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL6,PEST%PE_TARGET(1),'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL7,PEST%PE_TARGET(2),'(F10.2)')
