...
USE MOD_POLYGON_UTL, ONLY : POLYGONGETSHAPE
...
REAL(KIND=DP_KIND),PRIVATE :: XTAGMID,YTAGMID,RADIUS
REAL(KIND=DP_KIND),DIMENSION(:),ALLOCATABLE,PRIVATE :: XTAG,YTAG
...
! CALL IGRFILLPATTERN(HATCHED,DENSE1,DIAGDOWN)
 ...
 CALL UTL_SETTEXTSIZE(TWIDTH,THEIGHT,0.0D02)
...
!     CALL IGRLINEWIDTH(1)
   ...
   END SELECT
!   CALL IPFPLOTPOINT(XTAGMID,YTAGMID,2,1.0D0)
