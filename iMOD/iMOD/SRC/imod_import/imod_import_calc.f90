...
! ISTR=27
 ...
 IF(IU(IPCG).EQ.0)THEN
  MAXITER=500; NITER=20; HCLOSE=0.0D001; RCLOSE=1.0D0; RELAX=0.98
 ELSE 
...
!  WRITE(IURUN,'(A)') TRIM(LINE)
 ...
 READ(IU(IMOC),*,IOSTAT=IOS) !##     0           0   0.0D000864
...
! ENDDO
 ...
 IF(.NOT.IMPORT_READPACKAGE(IUF,NDRN,NCOLP,'DRAIN',MVERSION,(/FL,FL**2.0/FT,1.0D0/)))RETURN
 ...
 IF(.NOT.IMPORT_READPACKAGE(IUF,NRIV,NCOLP,'RIVER',MVERSION,(/FL,FL**2.0/FT,FL,1.0D0,1.0D0/)))RETURN
 ...
 NCOLP=10
 IF(.NOT.IMPORT_READPACKAGE(IUF,NSTR,NCOLP,'STREAM',MVERSION,(/1.0D0,1.0D0,FL,FL,FL,FL,FL,FL**2/FT,FL**2.0/FT,FL**3.0/FT/)))RETURN
