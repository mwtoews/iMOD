...
!  CALL SOLID_PROFILECLOSE()
 ...
 CALL WDIALOGPUTDOUBLE(IDF_REAL1,MPW%XMIN,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL2,MPW%YMIN,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL3,MPW%XMAX,'(F10.2)')
 CALL WDIALOGPUTDOUBLE(IDF_REAL4,MPW%YMAX,'(F10.2)')
