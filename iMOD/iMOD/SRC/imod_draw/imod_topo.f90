 ...
 ELSE
  ...
  DO I=1,NBMP
   IF(BMP(I)%IACT.EQ.1)THEN
    ...
    CALL WDIALOGPUTDOUBLE(IDF_REAL1,BMP(I)%XMIN/1000.0D0,'(F10.2)')
    CALL WDIALOGPUTDOUBLE(IDF_REAL2,BMP(I)%YMIN/1000.0D0,'(F10.2)')
    CALL WDIALOGPUTDOUBLE(IDF_REAL4,BMP(I)%XMAX/1000.0D0,'(F10.2)')
    CALL WDIALOGPUTDOUBLE(IDF_REAL3,BMP(I)%YMAX/1000.0D0,'(F10.2)')
    CALL WDIALOGPUTDOUBLE(IDF_REAL5,BMP(I)%DX,'(F10.2)')
    CALL WDIALOGPUTDOUBLE(IDF_REAL6,BMP(I)%DY,'(F10.2)')
    EXIT
   ENDIF
  ENDDO
 ENDIF
