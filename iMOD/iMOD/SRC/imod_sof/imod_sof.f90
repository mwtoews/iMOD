...
CONTAINS
 ...
 !## rain in m3/sec
 RAIN=(RAIN/1000.0D0)*IDF(1)%DX**2.0
 RAIN= RAIN/86400.0D0
...
!   IDF(8)%X(IC(I),IR(I))=IDF(8)%X(IC(I),IR(I))+RINF*RCOND   !## inffactor
 ...
 INTEGER :: MAXTHREAD,NTHREAD,MAXN,DTERM,ISTOP,IMENU,IYR,IMD,IDY
...
!   ENDIF
   ...
   ZCRIT=Z2-Z1; ZCRIT=0.0D001*ZCRIT
...
!      IP=IP+1
 ...
 !## sort list
 !call sortem(1,NP,PL(:,3),2,PL(:,1),PL(:,2),(/0.0D0/),(/0.0D0/),(/0.0D0/),(/0.0D0/),(/0.0D0/)) 
