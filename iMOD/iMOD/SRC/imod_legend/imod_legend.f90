...
!        CALL LEG_MINMAX(IPLOT)
 ...
 DATA CLEGEND/'GWS_NAP (-6:35)','GWS_SURFLEVEL (0:10)','FLUX_MMD (-1.5:0.05D0)','RESIDUAL (-2:2)','TRANSMISSIVITY (0:10.0D00)', &
 ...
 SELECT CASE (ILEG)
  CASE (1) !## gws_nap
   ...
   WRITE(IU,'(A)') '1.00000,0.000000E+00,206,255,0,  "0.0 - 1.0m"    '
   WRITE(IU,'(A)') '0.000000E+00,-1.00000,144,255,0, "-1.0 - 0.0m"   '
 ...
 CASE (5) !## c/kd
   ...
   WRITE(IU,'(A)') 'UPPERBND    LOWERBND    IRED    IGREEN    IBLUE    DOMAIN'
   WRITE(IU,'(A)') '100000.0    10000.0    98    0    0    "> 10.00"'
   WRITE(IU,'(A)') '10000.0    8000.00    147    0    0    "8.000"'
   WRITE(IU,'(A)') '8000.00    6000.00    166    4    0    "6.000"'
   WRITE(IU,'(A)') '6000.00    4000.00    221    58    11    "4.000"'
   WRITE(IU,'(A)') '4000.00    2500.00    234    117    0    "2.500"'
   WRITE(IU,'(A)') '2500.00    2000.00    234    165    10    "2.000"'
   WRITE(IU,'(A)') '2000.00    1500.00    255    199    6    "1.500"'
   WRITE(IU,'(A)') '1500.00    1000.00    245    222    5    "1.00"'
...
!  ENDDO
 ...
 IF(IOPTION.EQ.0)THEN
  ...
  DO K=1,2
   IF(K.EQ.2)DC=REAL(NLEG)/REAL(MAX(1,I-1))
