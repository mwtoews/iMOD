...
! MESHGEOM%NODEOFFSETS(1) = 0.000000000000000D+000 _ CALC. POINTS
 ...
 REAL(KIND=DP_KIND) :: DIST,WP,BH,MIND1,MIND2,D
 ...
 NCLC=0; DO I=1,MESHGEOM%NUMNODE
  ...
  ID1=0; ID2=0; MIND1=HUGE(1.0); MIND2=MIND1; DO II=1,NETWORK%CRS%COUNT
   ...
   IF(D.LE.DIST.AND.D.LT.MIND1)THEN
    MIND1=D; ID1=II
   ENDIF
   !## check closest after
   IF(D.GE.DIST.AND.D.LT.MIND2)THEN
    MIND2=D; ID2=II
   ENDIF
  ENDDO
  ...
  ELSE
   BH=0.5D0*NETWORK%CRS%CROSS(ID1)%BEDLEVEL+ &
      0.5D0*NETWORK%CRS%CROSS(ID2)%BEDLEVEL
  ENDIF
  WP=BH+1.0D0 
