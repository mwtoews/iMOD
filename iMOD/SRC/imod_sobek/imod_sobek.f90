...
! ENDDO
 ...
 WRITE(IU(ISD2),REC=1) UTL_PUTRECORDLENGTH(36) !20*256+247
 ...
 WRITE(IU(IST2),REC=1) UTL_PUTRECORDLENGTH(20) !12*256+247
  ...
  IF(TRIM(TP2(IB)%ID).EQ.TRIM(GR(I)%CI))THEN
   ...
   IF(NTIMES.GT.0)THEN
    ...
    DO J=1,N
     ...
     WRITE(IU(ISD2),REC=IREFSD+1) ID,SELECTEDVALUES(1,1,J),SELECTEDVALUES(2,1,J),1.0D0,0.3D0
    END DO
