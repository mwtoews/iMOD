...
USE MOD_LEGEND_UTL, ONLY : LEGWRITE_LEGEND,LEGREAD_LEGEND,LEGALLOCATE,LEGDEALLOCATE
...
CONTAINS
 ...
 DO I=1,N
  ...
  ENDIF
  !## read legend
  CALL LEGREAD_LEGEND(IU,MDF(I)%LEG)
 ENDDO
 ...
 DO I=1,N
  ...
  IF(IOS.NE.0)EXIT
  !## write legend
  CALL LEGWRITE_LEGEND(IU,MDF(I)%LEG)
 ENDDO
