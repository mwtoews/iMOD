   ...
   DO J=1,NU 
    ...
    DO IPERC=1,NPERC
     ...
     DO K=1,NRESULTS
      ...
      CALL UTL_GETMED(XSUM(1,K),N,NODATA,(/XPERC(IPERC)/),1,NAJ,XRES)
      XSUM(1,K)=XRES(1)
     ENDDO
     ...
     IF(IIPF+JIPF.EQ.3)THEN
      ...
      DO K=1,5 
       IF(IINVERSE.EQ.0)CALL UTL_GETMED(XSUM(1,K),N,NODATA_DEFAULT,(/XPERC(IPERC)/),1,NAJ,XRES)
       XSUM(5,K)=XRES(1)
       IF(IINVERSE.EQ.1)CALL UTL_GETMED_INVERSE(XSUM(1,K),N,NODATA_DEFAULT,(/XPERC(IPERC)/),1,NAJ,XRES)
       XSUM(5,K)=XRES(1)
       XSUM(1,K)=XSUM(5,K)
      ENDDO
