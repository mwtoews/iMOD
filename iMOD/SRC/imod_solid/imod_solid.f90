...
!       CALL SOLID_FIELDS()
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: I,J,IROW,ICOL,ILAY,JLAY,IL,IU,IOS
 REAL :: D,K,C1,C2,C3,TP,BT,X
...
ILLOOP: DO
 ...
 IF(IBATCH.EQ.1)THEN
  ...
  ENDDO
 ELSE
  CALL WMESSAGEBOX(OKONLY,INFORMATIONICON,COMMONOK,'Succesfully created masks','Information')
 ENDIF
...
!  CALL SOLIDPROFILECLOSE()
 ...
 INTEGER :: I,II,JJ,J,K,ICLIP,ISUP,IC,IR,ICLR,ITOPBOT
 ...
 INTEGER :: N,I,J,K,IROW,ICOL,JROW,JCOL,ITOPBOT,IOS
 REAL :: X,Y,TOP,BOT,DZZ,XMIN,YMIN,XMAX,YMAX,XTOP,XBOT
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: ITYPE
 ...
 CALL SOLIDINITSLDPOINTER(1,SLD(1)%NINT); SLD(1)%ICLC=1; SLD(1)%ICHECK=1
