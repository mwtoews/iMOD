...
!  IF(.NOT.IDFWRITE(SHM(I),'d:\iMOD-MODELS\ROTTERDAM\MODEL\DUMMY_SHM_L'//TRIM(ITOS(I))//'.IDF',1))RETURN
 ENDDO
 ...
 DO IROW=1,MDLIDF%NROW; DO ICOL=1,MDLIDF%NCOL
  ...
  DO I=1,SIZE(KHG)
!   IF(KHG(I)%X(ICOL,IROW).LE.0.0)CYCLE
   DO J=1,SIZE(TPM)
...
ILLOOP: DO
 ...
 !## turn off buttons, is more convenient
