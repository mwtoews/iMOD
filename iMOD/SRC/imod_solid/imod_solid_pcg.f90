...
!   IF(.NOT.IDFREAD(SOLIDF(I),SLD(1)%INTNAME(I),1))RETURN !## scale use mean algorithm
 ...
 !###======================================================================
 SUBROUTINE SOLID_PCGINT(XD,YD,ZD,ND,IERROR,IDF,IECHO,IDUPLICATE,HNOFLOW,CD,LCR,GENFILE) 
 !###======================================================================
 IMPLICIT NONE
 ...
 CHARACTER(LEN=*),OPTIONAL :: GENFILE
    ...
    DO I=2,SPF(ISPF)%NXY
     ...
     IF(SOLIDF(ILAY)%IEQ.EQ.0)THEN
      ...
      N=0; CALL INTERSECT_EQUI(SOLIDF(ILAY)%XMIN,SOLIDF(ILAY)%XMAX,SOLIDF(ILAY)%YMIN,SOLIDF(ILAY)%YMAX, &
                               SOLIDF(ILAY)%DX,X1,X2,Y1,Y2,N,.FALSE.)
     ELSE
