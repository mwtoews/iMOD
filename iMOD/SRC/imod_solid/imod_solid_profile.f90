...
! ENDDO 
 ...
 SELECT CASE (ISEL)
  CASE (3) !## delete nodes
   CALL SOLIDPROFILEDELNODE(SP(:,2),SP(:,1),IMENU=IMENU)
  CASE (5) !## split level
   CALL SOLIDPROFILESPLITLINE(SP(:,2),SP(:,1),X,IMENU)
...
ILLOOP: DO IL=MAX(1,IELEV-1),MIN(NTBSOL,IELEV+1)
 ...
 !###======================================================================
 SUBROUTINE SOLIDPROFILEDELNODE(VCRD,VIELEV,IMENU)
 !###======================================================================
 IMPLICIT NONE
 ...
 !###======================================================================
 SUBROUTINE SOLIDPROFILESPLITLINE(VCRD,VIELEV,XDIST,IMENU)
 !###======================================================================
 IMPLICIT NONE
 ...
 CALL WDIALOGPUTIMAGE(IDF_CHECK2,ID_ICONGLASSES_DESELECT,1)
