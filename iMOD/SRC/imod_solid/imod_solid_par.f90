...
TYPE SOLIDOBJ
 ...
 CHARACTER(LEN=256),POINTER,DIMENSION(:,:) :: TBNAME
 CHARACTER(LEN=256),POINTER,DIMENSION(:) :: KDNAME
 CHARACTER(LEN=256),POINTER,DIMENSION(:) :: CNAME 
 INTEGER,POINTER,DIMENSION(:,:) :: TBCLR,ICLC,ICHECK
 INTEGER,POINTER,DIMENSION(:) :: KDCLR,CCLR
END TYPE SOLIDOBJ
TYPE(SOLIDOBJ),ALLOCATABLE,DIMENSION(:),SAVE :: SLD
INTEGER,SAVE :: ISEL_SOLID
INTEGER,ALLOCATABLE,DIMENSION(:),SAVE :: JSEL_SOLID

INTEGER,SAVE :: NBOREHOLES   !## nuber of boreholes
CHARACTER(LEN=256),DIMENSION(:),ALLOCATABLE :: FBOREHOLES
INTEGER,SAVE :: NCONMODELS   !## number of consensus models

CHARACTER(LEN=256),SAVE :: KLEGEND
...
TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:),SAVE :: TB,SOLIDF,TOPIDF,BOTIDF,CIDF,KDHIDF,KDVIDF,CFRACIDF,KDFRACIDF,KH,KV,FFRAC
...
REAL,ALLOCATABLE,DIMENSION(:) :: GCODE,XEXCLUDE,DTOL,TOP,BOT
REAL,SAVE :: MINC
