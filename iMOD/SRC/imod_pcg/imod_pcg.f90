...
CONTAINS
 ...
 !###====================================================================
 SUBROUTINE PCGSETTINGS(NOUTER,NINNER,HCLOSE,RCLOSE,ITIGHT,MICNVG,RELAX,IDAMPING,IBREAK)
 !###====================================================================
 IMPLICIT NONE
 REAL,INTENT(INOUT) :: HCLOSE,RCLOSE,RELAX
 ...
 SUBROUTINE PCG2AP(NODES,NROW,NCOL,NLAY,IBOUND,CR,CC,CV,HCOF,RHS,V,SS,P, &
                   CD,HNEW,MXITER,ITER1,KITER,NITER,ICNVG,HCLOSE,RCLOSE,IECHO,NICNVG,RELAX,HCHG)
 !###====================================================================
 IMPLICIT NONE
