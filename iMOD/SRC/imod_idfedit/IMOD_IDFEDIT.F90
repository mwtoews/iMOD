...
!     CALL IDFEDITGETGRIDSIZE()
 ...
 INTEGER :: I,II,J,IPLOT,ISCALE,JSCALE,NC,NR,N,IPP,NSX,NSY,MSX,MSY
 REAL :: DX,DY,X1,X2,Y1,Y2,XMAX,XMIN,YMAX,YMIN
 ...
 CALL IDFINIT(IDFNAME,LPLOT=.TRUE.)
 CALL WMESSAGEBOX(OKONLY,INFORMATIONICON,COMMONYES,'Sucesfully resized IDF-file:'//CHAR(13)//TRIM(IDFNAME)//CHAR(13)// &
