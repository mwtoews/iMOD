...
!     CALL IDFEDITGETGRIDSIZE()
 ...
 INTEGER :: I,II,J,IPLOT,ISCALE,JSCALE,NC,NR,N,IPP,I1,I2,NSX,NSY,MSX
 REAL :: DX,DY,X1,X2,Y1,Y2
 TYPE(IDFOBJ) :: IDFRESIZE
 REAL,POINTER,DIMENSION(:) :: SX,SY,SX_BU,SY_BU
 ...
 DO II=1,SHPNO
  ...
  X1=MINVAL(SHPXC(1:SHPNCRD(II),J)); Y1=MINVAL(SHPYC(1:SHPNCRD(II),J))
  X2=MAXVAL(SHPXC(1:SHPNCRD(II),J)); Y2=MAXVAL(SHPYC(1:SHPNCRD(II),J)); DX=XGRIDSIZE(II)
  ...
  DEALLOCATE(SX); SX=>SX_BU; NSX=J
    
  CALL POL1LOCATE(SY,NSY,REAL(Y1,8),I1)
  CALL POL1LOCATE(SY,NSY,REAL(Y2,8),I2)
