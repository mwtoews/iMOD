...
USE RESOURCE
USE MODPLOT
USE MOD_UTL, ONLY : ITOS,UTL_GETUNIT,UTL_IDFGETCLASS,UTL_DEBUGLEVEL,UTL_GETHELP,UTL_DIALOGSHOW
...
CONTAINS
 ...
 INTEGER :: I,ITYPE,ICOL,IC1,IC2,IROW,IR1,IR2,NC,NR,JCOL,JROW,IPLOT,IU,IOS,ICLR,IPLTCLR,DID
   ...
   CASE (FIELDCHANGED)
    SELECT CASE (MESSAGE%VALUE1)
     CASE (IDF_CHECK1)
      ...
      DO I=1,SELIDF(1)%NTHREAD
       ICOL=INT(SELIDF(1)%YSEL(1,I)); IROW=INT(SELIDF(1)%YSEL(2,I))
       CALL WGRIDGETCELLDOUBLE(IDF_GRID1,(ICOL-IC1)+1,(IROW-IR1)+1,IDFVAL)
       IF(IDFVAL.EQ.-999999.0D0)CYCLE
     ...
     CASE (IDF_GRID1)
      ...
      CALL UTL_DEBUGLEVEL(0)
      CALL WGRIDGETCELLDOUBLE(IDF_GRID1,ICOL,IROW,IDFVAL)
