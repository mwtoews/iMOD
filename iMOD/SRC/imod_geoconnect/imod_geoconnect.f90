...
!IPFAC(I)%
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: I,J,K,IU,N,IOS
 CHARACTER(LEN=12),ALLOCATABLE,DIMENSION(:) :: RFORM
 ...
 IF(ALLOCATED(RFORM))DEALLOCATE(RFORM); ALLOCATE(RFORM(N))
 DO I=1,N; READ(IU,*,IOSTAT=IOS)RFORM(I); ENDDO; CLOSE(IU)
