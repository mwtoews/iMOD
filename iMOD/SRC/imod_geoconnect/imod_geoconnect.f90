...
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_SUBST,ITOS,UTL_DIRINFO_POINTER,UTL_CAP,UTL_WSELECTFILE
...
!       CALL GC_INIT_POSTPROCESSING_WRITE(FNAME)      
 ...
 CALL WDIALOGPUTIMAGE(ID_OPEN,ID_ICONOPEN) !## open folder where output files need to be stored
