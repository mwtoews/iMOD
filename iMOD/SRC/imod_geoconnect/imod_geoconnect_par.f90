...
USE WINTERACTER
USE RESOURCE
USE MOD_UTL, ONLY : UTL_READINITFILE,UTL_GETUNIT,ITOS,RTOS,UTL_IDFSNAPTOGRID
...
! WRITE(IU,'(A)') 'TXTFILE='//TRIM(TXTFILE)
 ...
 IF(.NOT.UTL_READINITFILE('NLAYR',LINE,IU,0))RETURN
 READ(LINE,*) NLAYR; WRITE(*,'(A,I10)') 'NLAYR=',NLAYR
...
! ENDDO
 ...
 !###======================================================================
 LOGICAL FUNCTION GC_INIT_POSTPROCESSING_READ(IU)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IU !# Unit number of GEOCONNECT.ini
 INTEGER :: IOS,I
 ...
 IF(GC_IFLAG.NE.3)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'The chosen INI file is not meant to be read in for the POST-processing tab.','Error')
 ENDIF
