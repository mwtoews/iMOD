...
!   I1=INDEX(TOPIDF(I)%FNAME,'\',.TRUE.); I2=INDEX(TOPIDF(I)%FNAME,'.',.TRUE.)
!   TOPIDF(I)%FNAME =TRIM(OUTPUTFOLDER)//'\topbottom\'  //TOPIDF(I)%FNAME(I1+1:I2-1)//'.idf'
   IF(.NOT.IDFREAD(TOPIDF(I),TOPIDF(I)%FNAME,0))RETURN

!   I1=INDEX(BOTIDF(I)%FNAME,'\',.TRUE.); I2=INDEX(BOTIDF(I)%FNAME,'.',.TRUE.)
!   BOTIDF(I)%FNAME =TRIM(OUTPUTFOLDER)//'\topbottom\'  //BOTIDF(I)%FNAME(I1+1:I2-1)//'.idf'
   IF(.NOT.IDFREAD(BOTIDF(I),BOTIDF(I)%FNAME,0))RETURN

   I1=INDEX(TOPIDF(I)%FNAME,'\',.TRUE.); I2=INDEX(TOPIDF(I)%FNAME,'.',.TRUE.)
   ZIDF(I)%FNAME =TRIM(OUTPUTFOLDER)//'\objects\'  //TOPIDF(I)%FNAME(I1+1:I2-1)//'_objects.idf'
...
!  IF(.NOT.IDFREAD(ZIDF(IIDF),ZIDF(IIDF)%FNAME,1))RETURN
...
!  IF(.NOT.IDFREAD(TOPIDF(IIDF),TOPIDF(IIDF)%FNAME,1))RETURN
...
!  IF(.NOT.IDFREAD(BOTIDF(IIDF),BOTIDF(IIDF)%FNAME,1))RETURN
