       ...
       SELECT CASE (MESSAGE%VALUE1)
        CASE (IDOK)   ! Start modelrun 
         ...
         IF(LEX)THEN
          ...
          CALL WDIALOGGETMENU(IDF_MENU2,I,PBMAN%MODELNAME) ! new convention, in stead of variable modelname
          ...
          SELECT CASE (PBMAN%IFORMAT)
           ...
           CASE (1,4)
            ...
            !PBMAN%RUNFILE=TRIM(PREFVAL(1))//'\RUNFILES\'//TRIM(MODELNAME)//'.RUN'
           !## mt3d
           CASE (5)
...
!         CASE (IDF_RADIO1,IDF_RADIO2,IDF_RADIO3,IDF_RADIO4,IDF_RADIO5,IDF_RADIO6,IDF_MENU3)
       CALL PMANAGER_INITSIM_FIELDS_TAB1(MESSAGE%VALUE1,MESSAGE%VALUE2)
!         END SELECT
!       ENDIF
...
!         CALL PMANAGER_INITSIM_FIELDS_TAB5()
 ...
 !## only refresh if 
 IF(ID1.EQ.IDF_RADIO5.OR.ID2.EQ.IDF_RADIO5)THEN
  SELECT CASE (IFORMAT)
 ...
 SELECT CASE (IWINDOW)
  ...
  CASE (4)
   ...
   IF(TRIM(PBMAN%GENFNAME).NE.'')THEN
    DIR=TRIM(PREFVAL(1))//'\TMP' !PBMAN%GENFNAME(:INDEX(PBMAN%GENFNAME,'.',.TRUE.)-1)
    !DIR=PBMAN%GENFNAME(:INDEX(PBMAN%GENFNAME,'.',.TRUE.)-1)
    CALL PMANAGER_GENERATEMFNETWORKS(PBMAN%GENFNAME,DIR,PBMAN%NSUBMODEL,0)
...
!  CALL WDIALOGFIELDSTATE(IDF_RADIO2,0)
 ...
 IF(IBATCH.EQ.0)THEN
  ...
  CALL PMANAGER_INITSIM_FIELDS_TAB1(IDF_RADIO5,IDF_RADIO1)
  CALL PMANAGER_INITSIM_FIELDS_TAB2()
  CALL PMANAGER_INITSIM_FIELDS_TAB3()
  CALL PMANAGER_INITSIM_FIELDS_TAB4()
 ENDIF
...
!   IF(J.GT.0)EXIT
 ...
 INTEGER :: IU,IOS,I,J,N1,N2,IFLAGS,IEXCOD,IERROR,IMODE
