...
!   IF(J.GT.0)EXIT
 ...
 DO I=1,SIZE(PEST%PARAM)
  ...
  ELSE
   IF(.NOT.UTL_READINITFILE('MEAN_P'//TRIM(ITOS(I)),LINE,IU,0))RETURN;  READ(LINE,*) PEST%PARAM(I)%PARMEAN
   IF(.NOT.UTL_READINITFILE('STD_P'//TRIM(ITOS(I)),LINE,IU,0))RETURN;   READ(LINE,*) PEST%PARAM(I)%PARSTD
