...
CONTAINS
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_GETPACKAGES(IBATCH,IOPTION)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IBATCH,IOPTION
 ...
 IF(PBMAN%IFORMAT.GT.2)THEN; TOPICS(TCAP)%DEFINED=.FALSE.
 ELSE; IF(ISS.EQ.0)TOPICS(TCAP)%DEFINED=.FALSE.; ENDIF
 ...
 SELECT CASE (PBMAN%IFORMAT)
  ...
  !## mt3d
  CASE (5)
   IF(.NOT.TOPICS(TGCG)%DEFINED)THEN
...
!         CALL PMANAGER_INITSIM_FIELDS_TAB5()
 ...
 ELSE  ! in case iMOD batch
  ...
  IF(PBMAN%IFORMAT.EQ.6)CALL WDIALOGPUTRADIOBUTTON(IDF_RADIO6) !## modpath
 ...
 !## FRANS HIER PBMAN% SHIT UITLEZEN
...
! CALL PMANAGER_INITSIM_GETISAVE()
 ...
 IF(.NOT.PMANAGER_GETPACKAGES(IBATCH,0))RETURN
 ...
 !## FRANS HIER DE MT3D SETTINGS PUTTEN
...
! TOPICS(TUZF)%SNAME(2) ='Saturated Vertical Conductivity (IDF)'
 ...
 TOPICS(TRCT)%SNAME(1) ='(RCT) Çhemical Reaction Package'
 ...
 !## for seawat
 ALLOCATE(MC(4)%T(36),MC(4)%IACT(36))
