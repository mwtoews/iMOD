...
!         CALL PMANAGER_INITSIM_FIELDS_TAB5()
 ...
 CALL WDIALOGSELECT(ID_DSIMMANAGER_TAB1)
 CALL WDIALOGGETRADIOBUTTON(IDF_RADIO1,PBMAN%IFORMAT)
 CALL WDIALOGGETMENU(IDF_MENU2,I,PBMAN%FLOW_RESULT_DIR)
! PBMAN%FLOW_RESULT_DIR=TRIM(PREFVAL(1))//'\MODELS\'//TRIM(MODELNAME)//'\MT3D\'//TRIM(PBMAN%FLOW_RESULT_DIR)//'.RUN' 
 PBMAN%FLOW_RESULT_DIR=TRIM(PREFVAL(1))//'\MODELS\'//TRIM(MODELNAME)//'\MT3D\'//TRIM(PBMAN%FLOW_RESULT_DIR) 
