...
CONTAINS
 ...
 ! frans , actie: toevoegen iMODWQ packages 
...
JLOOP: DO K=1,SIZE(TOPICS)
 ...
 INTEGER :: ID,IDY,IYR,IMH,I,J,IHR,IMT,ISC,ISTEP,ITRANSIENT,N
 LOGICAL :: LEX
...
!         CALL PMANAGER_INITSIM_FIELDS_TAB5()
 ...
 SELECT CASE (PBMAN%IWINDOW)
  ...
  CASE (2)
   ...
   CALL WDIALOGGETDOUBLE(IDF_REAL4,SUBMODEL(1)) !## xmin
   CALL WDIALOGGETDOUBLE(IDF_REAL5,SUBMODEL(2)) !## ymin
   CALL WDIALOGGETDOUBLE(IDF_REAL1,SUBMODEL(3)) !## xmax
   CALL WDIALOGGETDOUBLE(IDF_REAL2,SUBMODEL(4)) !## ymax
 ...
 DO I=1,SIZE(PCKLIST)
  ...
  ELSE
   ...
   ALLOCATE(PBMAN%ISAVE(PCKLIST(I)%JPLIST)%ILAY(N)) !PRJNLAY))
   N=0; DO J=1,PRJNLAY
 ...
 !## remove dialog
 CALL WDIALOGSELECT(ID_DSIMMANAGER); CALL WDIALOGUNLOAD(); CALL WDIALOGSELECT(ID)  
 DO I=1,SIZE(PCKLIST)
 ...
 CALL PMANAGER_INITSIM_FIELDS_TAB3()   ! frans, waarom hier!?
...
! CALL WDIALOGFIELDSTATE(ID_ZOOMEXTENT,IACT(2))
...
!  PBMAN%TCOMPLEX='SIMPLE'
 ...
 !## spatial setting
 CALL WDIALOGSELECT(ID_DSIMMANAGER_TAB3)
 CALL WDIALOGPUTIMAGE(ID_ZOOMEXTENT,ID_ICONZOOMFULL,1)
...
! TOPICS(TUZF)%SNAME(4) ='(RWC) Residual Water Content of Unsat. Zone (IDF)'
 ...
 TOPICS(TBTN)%SNAME(1) ='(BTN) Parameters BTN (-)'
