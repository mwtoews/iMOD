...
! IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)LANI=.FALSE.
 ...
 !
 !!## wel
 !TOPICS(TWEL)%DEFINED=.FALSE.; ITOPIC=TWEL; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TWEL)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TWEL)%DEFINED=.FALSE.
 !
 !!## drn
 !TOPICS(TDRN)%DEFINED=.FALSE.; ITOPIC=TDRN; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TDRN)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TDRN)%DEFINED=.FALSE.
 !
 !!## riv
 !TOPICS(TRIV)%DEFINED=.FALSE.; ITOPIC=TRIV; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TRIV)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TRIV)%DEFINED=.FALSE.
 !
 !!## evt
 !TOPICS(TEVT)%DEFINED=.FALSE.; ITOPIC=TEVT; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TEVT)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TEVT)%DEFINED=.FALSE.
 !
 !!## ghb
 ...
 !
 !!## rch
 !TOPICS(TRCH)%DEFINED=.FALSE.; ITOPIC=TRCH; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TRCH)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TRCH)%DEFINED=.FALSE.
 !
 !!## sof
 ...
 !
 !!## chd
 !TOPICS(TCHD)%DEFINED=.FALSE.; ITOPIC=TCHD; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TCHD)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TCHD)%DEFINED=.FALSE.
 !
 !!## isg
 ...
 !
 !!## pcg
 !TOPICS(TPCG)%DEFINED=.FALSE.; ITOPIC=TPCG; IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
 ! IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))TOPICS(TPCG)%DEFINED=.TRUE.; ENDIF 
 !IF(TOPICS(ITOPIC)%IACT_MODEL.EQ.0)TOPICS(TPCG)%DEFINED=.FALSE.
...
! CALL PMANAGER_INITSIM_GETISAVE()
 ...
 IF(IBATCH.EQ.0)THEN
  ...
  PBMAN%NSUBMODEL=1
  PBMAN%ISUBMODEL=1
  PBMAN%IPEST=0; IF(TOPICS(TPST)%DEFINED.AND.PBMAN%IPESTP.EQ.0)PBMAN%IPEST=1
  PBMAN%MC=0
  PBMAN%EIGV=99.9D0
