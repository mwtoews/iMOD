...
! CALL UTL_HIDESHOWDIALOG(ID_DMODEL,2)
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: ID,IOS,INICE,NCOL,NROW
 ...
 SELECT CASE (PBMAN%IWINDOW)
  !## full extent
  CASE (1)
   SUBMODEL(1)=PRJIDF%XMIN; SUBMODEL(2)=PRJIDF%YMIN
   SUBMODEL(3)=PRJIDF%XMAX; SUBMODEL(4)=PRJIDF%YMAX
   CALL WDIALOGGETDOUBLE(IDF_REAL10,SUBMODEL(5)) !## dimensions from first idf in prj file
  ...
  CASE (3)
   ...
   IF(IDFREAD(IDF,PBMAN%BNDFILE,0))THEN
    SUBMODEL(1)=IDF%XMIN; SUBMODEL(2)=IDF%YMIN
    SUBMODEL(3)=IDF%XMAX; SUBMODEL(4)=IDF%YMAX
    SUBMODEL(5)=IDF%DX
   ENDIF
  !## mf6 - gen files
  CASE (4)
