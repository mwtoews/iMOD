...
! TOPICS(TBTN)%SNAME(1) ='(BTN) Parameters Basic Transport package (-)'
 ...
 !## for mf2005
 ALLOCATE(MC(1)%T(33))
 MC(1)%T=[TBND,TTOP,TBOT,TKHV,TKVA,TKDW,TKVV,TVCW,TSHD,TSTO,TSPY,TANI,THFB,TIBS,TPWT, &
          TSFT,TCAP,TUZF,TRCH,TEVT,TDRN,TOLF,TRIV,TISG,TSFR,TLAK,TWEL,TMNW,TGHB,TCHD,TFHB,TPST,TPCG]
 !## for modflow6
 ALLOCATE(MC(2)%T(20))
 MC(2)%T=[TBND,TTOP,TBOT,TKHV,TKVA,TSHD,TSTO,TSPY,THFB,TUZF,TRCH,TEVT,TDRN,TRIV,TISG,TWEL,TMNW,TGHB,TCHD,TPCG]
 !## for seawat
 ALLOCATE(MC(3)%T(30))
 MC(3)%T=[TBND,TTOP,TBOT,TKHV,TKVA,TKDW,TKVV,TVCW,TSHD,TSTO,TSPY,TPOR,TANI,TRCH,TEVT, &
          TDRN,TRIV,TWEL,TGHB,TCHD,TOBS,TPCG,TGCG,TVDF,TFDE,TCBI,TSCO,TADV,TDSP,TTVC]
 !## for mt3d
 ALLOCATE(MC(4)%T(19))
 MC(4)%T=[TTOP,TBOT,TTHK,TPOR,TRCH,TEVT,TRIV,TWEL,TGHB,TCHD,TOBS,TGCG,TVDF,TFDE,TCBI,TSCO,TADV,TDSP,TTVC]
 !## for particle tracking
 ALLOCATE(MC(5)%T(4))
 MC(5)%T=[TBND,TTOP,TBOT,TPOR]
