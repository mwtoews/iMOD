...
! ENDDO
 ...
 N=0; DO KPER=1,PRJNPER ; DO ISPECIES=1,NSPECIES
  ...
  ! IF(PMANAGER_SAVERUNWQ_U2DREL(IU,'CMAL_T?_P?_L?',TTVC,KPER,0,1,ILAY,ISPECIES))N=N+1
...
! CALL PMANAGER_SAVERUNWQ_WRTIDF(IU,TWEL,(/'WEL'/))
 ...
 WRITE(IU,'(1X,A)') 'MGHBSYS = 1' !## nog in te vullen !!!
 ...
 WRITE(IU,'(1X,A)') 'MRIVSYS = 1' !## nog in te vullen !!!
 ...
 WRITE(IU,'(1X,A,I)') 'MDRNSYS = ',MDRNSYS !## To be set
...
! WRITE(IU,'(1X,A)') 'IRCH_P$ = '
 ...
 DO KPER=1,PRJNPER 
   IF(.NOT.PMANAGER_SAVERUNWQ_U2DREL(IU,'RECH_P?',TRCH,KPER,1,1,1,0))RETURN
 ENDDO
