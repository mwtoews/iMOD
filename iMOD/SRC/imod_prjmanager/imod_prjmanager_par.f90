...
MODULE MOD_PMANAGER_PAR
 ...
 INTEGER,PARAMETER :: TCAP= 1
 INTEGER,PARAMETER :: TTOP= 2
 INTEGER,PARAMETER :: TBOT= 3
 INTEGER,PARAMETER :: TBND= 4
 INTEGER,PARAMETER :: TSHD= 5
 INTEGER,PARAMETER :: TKDW= 6
 INTEGER,PARAMETER :: TKHV= 7
 INTEGER,PARAMETER :: TKVA= 8
 INTEGER,PARAMETER :: TVCW= 9
 INTEGER,PARAMETER :: TKVV=10
 INTEGER,PARAMETER :: TSTO=11
 INTEGER,PARAMETER :: TSPY=12
 INTEGER,PARAMETER :: TPWT=13
 ...
 INTEGER,PARAMETER :: TMNW=19
 INTEGER,PARAMETER :: TPST=20
 INTEGER,PARAMETER :: TWEL=21
 INTEGER,PARAMETER :: TDRN=22
 INTEGER,PARAMETER :: TRIV=23
 INTEGER,PARAMETER :: TEVT=24
 INTEGER,PARAMETER :: TGHB=25
 INTEGER,PARAMETER :: TRCH=26
 INTEGER,PARAMETER :: TOLF=27
 INTEGER,PARAMETER :: TCHD=28
 INTEGER,PARAMETER :: TISG=29
 INTEGER,PARAMETER :: TSFR=30
 INTEGER,PARAMETER :: TFHB=31
 INTEGER,PARAMETER :: TLAK=32
