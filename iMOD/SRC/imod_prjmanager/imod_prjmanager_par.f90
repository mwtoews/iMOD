...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  !## Seawat
  INTEGER :: NPRS,NPROBS,NPRMAS,MXSS,MIXELM,PERCEL
  REAL(KIND=DP_KIND) :: TIMPRS
  CHARACTER(LEN=256) :: FLOW_RESULT_DIR
  !## isave options
  ...
  CHARACTER(LEN=256) :: TIMFNAME,MODFLOW,BNDFILE,OUTPUT,GENFNAME,RUNFILE,PRJFILE
