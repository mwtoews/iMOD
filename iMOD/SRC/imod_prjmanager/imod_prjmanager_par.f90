...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,IPESTP,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL, &
             IPKS,ICHKCHD,IDOUBLE,ICONSISTENCY,IIES,IEXPORTMF2005,NLINESEARCH,IARMWP,SCR_IMETHOD,SCR_ICTPCS, &
             DWEL,DISG,DSFR,DMMFILE,NSUBMODEL,ISUBMODEL,NLAMBDASEARCH,NCPU,CMDHIDE,NSWAIT,IGENMF6
