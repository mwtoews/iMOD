...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,IPESTP,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL,IPKS,ICHKCHD,IDOUBLE,ICONSISTENCY, &
   DWEL,DISG,DSFR,DMMFILE,NSUBMODEL,ISUBMODEL,NLINESEARCH,NCPU,CMDHIDE,PTEST,NLOGLOC
 ...
 DATA PARAM/'KD','KH','KV','VC','SC','RC','RI','DC','IC','II','AF','AA','VA','HF','MS','MC','RE','EX','EP','QR','GC','SY'/
