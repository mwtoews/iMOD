...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,IPESTP,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL,IPKS,ICHKCHD,IDOUBLE,ICONSISTENCY, &
   DWEL,DISG,DSFR,DMMFILE,NSUBMODEL,ISUBMODEL,NLINESEARCH,NCPU,CMDHIDE,PTEST,NLOGLOC,NSWAIT,PDEBUG,PRESTART,MC
  ...
  INTEGER :: INTSHD,INTKHV,INTKDW,INTKVV,INTKVA,INTVCW,INTTOP,INTBOT,INTSF1,INTSF2,INTANF
  INTEGER,POINTER,DIMENSION(:) :: UNCONFINED
  INTEGER,POINTER,DIMENSION(:) :: ILAY
  INTEGER,POINTER,DIMENSION(:,:) :: ILOC=>NULL()
  CHARACTER(LEN=256) :: TIMFNAME,MODFLOW,BNDFILE,OUTPUT
  CHARACTER(LEN=52) :: TCOMPLEX
 END TYPE PMANBATCH
