...
MODULE MOD_PMANAGER_PAR
 ...
 INTEGER,PARAMETER :: MAXTOPICS=38
 ...
 INTEGER,PARAMETER :: TANI=12
 INTEGER,PARAMETER :: THFB=13
 INTEGER,PARAMETER :: TIBS=14
 INTEGER,PARAMETER :: TPWT=15
 INTEGER,PARAMETER :: TSFT=16
 INTEGER,PARAMETER :: TCAP=17
 INTEGER,PARAMETER :: TUZF=18
 INTEGER,PARAMETER :: TRCH=19
 INTEGER,PARAMETER :: TEVT=20
 INTEGER,PARAMETER :: TDRN=21
 INTEGER,PARAMETER :: TOLF=22
 INTEGER,PARAMETER :: TRIV=23
 INTEGER,PARAMETER :: TISG=24
 INTEGER,PARAMETER :: TSFR=25
 INTEGER,PARAMETER :: TLAK=26
 INTEGER,PARAMETER :: TWEL=27
 INTEGER,PARAMETER :: TMNW=28
 INTEGER,PARAMETER :: TGHB=29
 INTEGER,PARAMETER :: TCHD=30
 INTEGER,PARAMETER :: TFHB=31
 INTEGER,PARAMETER :: TPST=32
 INTEGER,PARAMETER :: TPCG=33
 INTEGER,PARAMETER :: TGCG=34 !## mt3d/seawat
 INTEGER,PARAMETER :: TRCT=35 !## mt3d/seawat
 INTEGER,PARAMETER :: TADV=36 !## mt3d/seawat
 INTEGER,PARAMETER :: TVDF=37 !## mt3d/seawat
 INTEGER,PARAMETER :: TBTN=38 !## mt3d/seawat
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,IPESTP,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL, &
   ...
   DWEL,DISG,DSFR,DMMFILE,NSUBMODEL,ISUBMODEL,NLINESEARCH,NCPU,CMDHIDE,PTEST,NSWAIT,PDEBUG,MC,IGENMF6  !,NLOGLOC
