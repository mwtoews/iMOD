...
MODULE MOD_PMANAGER_PAR
 ...
 INTEGER,PARAMETER :: MAXTOPICS=54
 ...
 INTEGER,PARAMETER :: TSCR=54 !## subcreep    - subsidence/subcreep
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,SSYSTEM,IPEST,IPESTP,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL, &
             IPKS,ICHKCHD,IDOUBLE,ICONSISTENCY,IIES,IEXPORTMF2005,NLINESEARCH,IARMWP,SCR_IMETHOD,SCR_ISTPCS, &
             DWEL,DISG,DSFR,DMMFILE,NSUBMODEL,ISUBMODEL,NLAMBDASEARCH,NCPU,CMDHIDE,NSWAIT,IGENMF6,SCR_ISCROC, &
             SPECIFICSTORAGE,IDEFLAYER
  ...
  REAL(KIND=DP_KIND),POINTER,DIMENSION(:) :: LINE_SEARCH=>NULL()
 ...
 TYPE PSTPARAMOBJ
  ...
  CHARACTER(LEN=14) :: SDATE
  CHARACTER(LEN=14) :: EDATE
 ...
 TYPE PSTOBJ
  ...
  REAL(KIND=DP_KIND) :: PE_STOP=0.1D0
  REAL(KIND=DP_KIND) :: PE_SENS=0.0D0
  REAL(KIND=DP_KIND) :: PE_PADJ=0.01D0
 ...
 INTEGER,DIMENSION(4) :: IFULL,IFULL_MF6
 ...
 INTEGER :: IHEDUN,IBCFCB,IRCHCB,IEVTCB,IDRNCB,IRIVCB,IGHBCB,ICHDCB,IWELCB,ISFRCB,IFHBCB,ISFRCB2,IFHBUN,ILAKCB,IUZFCB1,IWL2CB,ISCRCB
 ...
 !## arrays for subcreep
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: THK,ARR,BCR,CCA,VOI,SUB,PCS,PC0,OCR,TH0,GL0,SGM,SGS

 INTEGER,DIMENSION(:),ALLOCATABLE :: ULAKES,DULAKES,NP_IPER
 INTEGER :: NLAKES
 INTEGER :: NDFLOWFM  !## number of dflow-fm nodes for the coupling
