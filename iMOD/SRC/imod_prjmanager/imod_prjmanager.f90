  ...
  CASE (ID_DPMANAGER)
   SELECT CASE (ITYPE)
    CASE (TABCHANGED)
     ...
     IF(MESSAGE%VALUE2.EQ.ID_DPMANAGER_TAB1)CALL PMANAGER_UTL_UPDATE_TREEVIEW(0,0,0)
    CASE (PUSHBUTTON)
     SELECT CASE (MESSAGE%VALUE1)
      CASE (ID_CLEAN)
       ...
       IF(WINFODIALOG(4).EQ.1)THEN
        ...
        CALL PMANAGER_UTL_INIT(); CALL PMANAGER_UTL_UPDATE_TREEVIEW(0,0,0)
       ENDIF
      CASE (ID_DELETE)
...
!  ENDDO
 ...
 CALL WDIALOGPUTOPTION(IDF_MENU2,WQ%GCG%NCRS)
...
!     CALL UTL_GETHELP('7.8','TMO.ModSim.SolverSettings')
 ...
 IF(MESSAGE%VALUE1.EQ.IDOK)THEN
  ...
  CALL WDIALOGGETMENU(IDF_MENU2,WQ%GCG%NCRS)
 ENDIF
 ...
 CALL WDIALOGPUTOPTION(IDF_MENU1,WQ%RCT%ISOTHM)
 CALL WDIALOGPUTOPTION(IDF_MENU2,WQ%RCT%IREACT)
...
!     CALL UTL_GETHELP('7.8','TMO.ModSim.SolverSettings')
 ...
 !## read values
 IF(MESSAGE%VALUE1.EQ.IDOK)THEN
  CALL WDIALOGGETMENU(IDF_MENU1,WQ%RCT%ISOTHM)
  CALL WDIALOGGETMENU(IDF_MENU2,WQ%RCT%IREACT)
