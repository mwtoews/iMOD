   ...
   SELECT CASE (ITYPE)
    ...
    CASE (PUSHBUTTON)
     SELECT CASE (MESSAGE%VALUE1)
      ...
      !## open/save PRJ file
      CASE (ID_OPEN)  
       IF(UTL_PMANAGER_REFRESH(1))THEN; IF(PMANAGERPRJ(MESSAGE%VALUE1,'',0,1))CALL PMANAGER_UTL_UPDATE_TREEVIEW(0,0,0); ENDIF
      !##save PRJ file
      CASE (ID_SAVE)  
       IF(PMANAGERPRJ(MESSAGE%VALUE1,'',0,1))THEN; ENDIF
      !## open RUN file, start simulation manager
      CASE (ID_OPENRUN) 
       IF(UTL_PMANAGER_REFRESH(1))THEN; IF(PMANAGERRUN(MESSAGE%VALUE1,'',0))CALL PMANAGER_UTL_UPDATE_TREEVIEW(0,0,0); ENDIF
