...
! WRITE(IU,'(A)') ' ANGLE3 LAYERED'
 ...
 CHARACTER(LEN=*),INTENT(IN) :: DIR,DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER :: IU,ILAY,JLAY,IFBND,IROW,ICOL,NSYSTEM,ISCROC,NOBSSUB
 ...
 !## output control for printing arrays is selected print message
 ISCROC=0
 !## number of observations
 NOBSSUB=0
 
 WRITE(IU,'(6I10)') ISCRCB,ISCROC,NSYSTEM,NOBSSUB,PBMAN%SCR_IMETHOD,PBMAN%SCR_ICTPCS
