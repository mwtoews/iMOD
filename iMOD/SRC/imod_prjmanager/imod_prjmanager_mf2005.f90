...
IILOOP: DO I=1,NHFB(IHFB)
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB)
 !###======================================================================
 IMPLICIT NONE
 LOGICAL,INTENT(OUT) :: LNPF,LSTO,LDRN,LRIV,LGHB
 INTEGER :: I
 
 LNPF=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'KH'.OR.PEST%PARAM(I)%PPARAM.EQ.'VA')THEN; LNPF=.TRUE.; EXIT; ENDIF
 ENDDO
 LSTO=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'SC'.OR.PEST%PARAM(I)%PPARAM.EQ.'SY')THEN; LSTO=.TRUE.; EXIT; ENDIF
 ENDDO
 LDRN=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'DC')THEN; LDRN=.TRUE.; EXIT; ENDIF
 ENDDO
 LRIV=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'RC')THEN; LRIV=.TRUE.; EXIT; ENDIF
 ENDDO
 LGHB=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'GC')THEN; LGHB=.TRUE.; EXIT; ENDIF
 ENDDO
 ...
 CHARACTER(LEN=1) :: CT
 LOGICAL :: LNPF,LSTO,LDRN,LRIV,LGHB
 ...
 IF(PBMAN%IPESTP.EQ.1)CALL PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB)
...
! ENDIF
 ...
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER :: I,II,N,IU,JU,IOS,ILAY,N1,N2,ISUB,IPER
 LOGICAL :: LNPF,LSTO,LDRN,LRIV,LGHB
 ...
 CALL PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB)
   ...
   DO
    ...
    DO II=1,SIZE(PEST%PARAM)
     ...
     SELECT CASE (PEST%PARAM(II)%PPARAM)
      CASE ('KH')
       LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\K_L'//TRIM(ITOS(ILAY))//'.ARR'  ,TRIM(FTYPE)//'\K_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('VA')
       LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\K33_L'//TRIM(ITOS(ILAY))//'.ARR',TRIM(FTYPE)//'\K33_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('SC')
       LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\SS_L'//TRIM(ITOS(ILAY))//'.ARR' ,TRIM(FTYPE)//'\SS_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('SY')
       LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\SY_L'//TRIM(ITOS(ILAY))//'.ARR' ,TRIM(FTYPE)//'\SY_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
     END SELECT
    ENDDO
    WRITE(JU,'(A)') TRIM(LINE)
   ENDDO
   ...
   DO
    ...
    DO II=1,SIZE(PEST%PARAM)
     DO IPER=1,PRJNPER
      SELECT CASE (PEST%PARAM(II)%PPARAM)
       CASE ('DC')
        LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\DRN_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FTYPE)//'\DRN_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
       CASE ('RC')
        LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\RIV_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FTYPE)//'\RIV_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
       CASE ('GC')
        LINE=UTL_SUBST(LINE,TRIM(FTYPE)//'\GHB_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FTYPE)//'\GHB_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
      END SELECT
     ENDDO
    ENDDO
    WRITE(JU,'(A)') TRIM(LINE)
