  ...
  DO IROW=1,IDF%NROW; DO ICOL=1,IDF%NCOL
   ...
   IF(IPC(ICOL,IROW,1).EQ.INT(1,1))THEN
    IF(ICOL.LT.IDF%NCOL)THEN
     ...
     ELSE
      WRITE(IU,'(6(I10,1X),G15.7,1X,I10)') ILAY,IROW,ICOL,ILAY,IROW,ICOL+1,1.0D0/C2,ISYS !## y-direction
     ENDIF
     !## write line in genfile
   ...
   IF(IPC(ICOL,IROW,2).EQ.INT(1,1))THEN
    IF(IROW.LT.IDF%NROW)THEN
     ...
     ELSE
      WRITE(IU,'(6(I10,1X),G15.7,1X,I10)') ILAY,IROW,ICOL,ILAY,IROW+1,ICOL,1.0D0/C2,ISYS !## x-direction
     ENDIF
