...
! WRITE(IU,'(A)') ' ANGLE3 LAYERED'
 ...
 DO ISYS=1,NSYS
  ...
  IF(PBMAN%SCR_ICTPCS.EQ.0.OR.PBMAN%SCR_ICTPCS.EQ.3)THEN
   ILAY=FNAMES(7)%ILAY
  ...
  ELSEIF(PBMAN%SCR_ICTPCS.EQ.1.OR.PBMAN%SCR_ICTPCS.EQ.3)THEN
   ILAY=FNAMES(8)%ILAY
  ...
  ELSEIF(PBMAN%SCR_ICTPCS.EQ.2.OR.PBMAN%SCR_ICTPCS.EQ.3)THEN
   ILAY=FNAMES(9)%ILAY
 ...
 WRITE(IU,'(6I10)') ISCRCB,0,PRJNLAY,0,PBMAN%SCR_IMETHOD,PBMAN%SCR_ICTPCS
