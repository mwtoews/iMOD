...
IILOOP: DO I=1,NHFB(IHFB)
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB,LRCH)
 !###======================================================================
 IMPLICIT NONE
 LOGICAL,INTENT(OUT) :: LNPF,LSTO,LDRN,LRIV,LGHB,LRCH
 INTEGER :: I
 
 LNPF=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'KH'.OR.PEST%PARAM(I)%PPARAM.EQ.'VA'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LNPF=.TRUE.; EXIT; ENDIF
 ENDDO
 LSTO=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'SC'.OR.PEST%PARAM(I)%PPARAM.EQ.'SY'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LSTO=.TRUE.; EXIT; ENDIF
 ENDDO
 LDRN=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'DC'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LDRN=.TRUE.; EXIT; ENDIF
 ENDDO
 LRIV=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'RC'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LRIV=.TRUE.; EXIT; ENDIF
 ENDDO
 LGHB=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'GC'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LGHB=.TRUE.; EXIT; ENDIF
 ENDDO
 LRCH=.FALSE.; DO I=1,SIZE(PEST%PARAM)
  IF(PEST%PARAM(I)%PPARAM.EQ.'RE'.AND.PEST%PARAM(I)%PACT.NE.0)THEN; LRCH=.TRUE.; EXIT; ENDIF
 ENDDO
 ...
 CHARACTER(LEN=1) :: CT
 LOGICAL :: LNPF,LSTO,LDRN,LRIV,LGHB,LRCH
 ...
 IF(PBMAN%IPESTP.EQ.1)CALL PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB,LRCH)
...
! ENDIF
 ...
 CALL PMANAGER_SAVEMF2005_MF6_GETPARAM(LNPF,LSTO,LDRN,LRIV,LGHB,LRCH)
 LMOD(1)=LNPF; LMOD(2)=LSTO
 LPCK(1)=LDRN; LPCK(2)=LRIV; LPCK(3)=LGHB; LPCK(4)=LRCH
