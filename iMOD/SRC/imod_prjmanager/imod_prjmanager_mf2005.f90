...
! ENDIF
 ...
 INTEGER :: ILAY,IINV,SCL_D,SCL_U,ITOPIC,IROW,ICOL
 LOGICAL :: LEX
...
!NUZTOP=1 !## recharge specified to top cell
  CASE (18); NUZGAG=6; IRUNFLG=0; NUZTOP=1
   ...
   SELECT CASE (ITOPIC)
    ...
    CASE (18)
      IF(IPER.EQ.1)THEN
       ...
       ENDIF
       write(iu,'(a)') '74,75 ,90,3'
       write(iu,'(a)') '76,59 ,91,3'
       write(iu,'(a)') '98,67 ,92,3'
       write(iu,'(a)') '118,79,93,3'
       write(iu,'(a)') '143,43,94,3'
       write(iu,'(a)') '146,66,95,3'
      ENDIF
