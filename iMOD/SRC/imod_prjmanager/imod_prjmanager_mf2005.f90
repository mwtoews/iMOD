   ...
   DO
    ...
    DO II=1,SIZE(PEST%PARAM)
     ...
     SELECT CASE (PEST%PARAM(II)%PPARAM)
      CASE ('KH')
       LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\K_L'//TRIM(ITOS(ILAY))//'.ARR'  ,TRIM(FEXT)//'\K_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('VA')
       LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\K33_L'//TRIM(ITOS(ILAY))//'.ARR',TRIM(FEXT)//'\K33_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('SC')
       LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\SS_L'//TRIM(ITOS(ILAY))//'.ARR' ,TRIM(FEXT)//'\SS_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
      CASE ('SY')
       LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\SY_L'//TRIM(ITOS(ILAY))//'.ARR' ,TRIM(FEXT)//'\SY_L'//TRIM(ITOS(ILAY))//'_'//TRIM(FTYPE)//'.ARR')
     END SELECT
    ENDDO
    WRITE(JU,'(A)') TRIM(LINE)
   ENDDO
   ...
   DO
    ...
    DO II=1,SIZE(PEST%PARAM)
     DO IPER=1,PRJNPER
      SELECT CASE (PEST%PARAM(II)%PPARAM)
       CASE ('DC')
        LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\DRN_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FEXT)//'\DRN_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
       CASE ('RC')
        LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\RIV_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FEXT)//'\RIV_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
       CASE ('GC')
        LINE=UTL_SUBST(LINE,TRIM(FEXT)//'\GHB_T'//TRIM(ITOS(IPER))//'.ARR',TRIM(FEXT)//'\GHB_T'//TRIM(ITOS(IPER))//'_'//TRIM(FTYPE)//'.ARR')
      END SELECT
     ENDDO
    ENDDO
    WRITE(JU,'(A)') TRIM(LINE)
