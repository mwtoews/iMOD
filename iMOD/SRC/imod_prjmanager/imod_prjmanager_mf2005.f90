...
CONTAINS
 ...
 CALL PMANAGER_GENERATEMFNETWORKS_DIMIDF(IDF,ISORT)
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_GENERATEMFNETWORKS_DIMIDF(IDF,ISORT)
 !###======================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(INOUT),DIMENSION(:) :: IDF
 ...
 DO J=1,SHP%NPOL
  ...
  IF(J.EQ.1)THEN
   IDF(I)%XMIN=IDF(I)%XMIN-IDF(I)%DX
   IDF(I)%XMAX=IDF(I)%XMAX+IDF(I)%DX
   IDF(I)%YMIN=IDF(I)%YMIN-IDF(I)%DY
   IDF(I)%YMAX=IDF(I)%YMAX+IDF(I)%DY
  ENDIF
 ...
 DO I=1,2
  ...
  DO ILAY=1,MNLAY(IMDL1)
   ...
   IF(LSUBMODEL)THEN
    ...
    !IROW=1
    DO IROW=1,BND(IMDL1,ILAY)%NCOL; DO ICOL=1,BND(IMDL1,ILAY)%NCOL
     !## skip inactive cells
