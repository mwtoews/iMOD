...
!  ENDIF
 ...
 IF(PBMAN%IFORMAT.EQ.3)THEN
  !## save obs package
  IF(.NOT.PMANAGER_SAVEMF2005_OBS(MAINDIR,DIRMNAME,IBATCH,TOPICS(TOBS)%IACT_MODEL,TOBS,'OBS'))RETURN
 ENDIF
...
!     IF(SUM(TLP).GT.0.0D0)TLP=(1.0D0/SUM(TLP))*TLP
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_OBS(MAINDIR,DIRMNAME,IBATCH,IACT,ITOPIC,CPCK)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IBATCH,ITOPIC,IACT
