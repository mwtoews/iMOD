...
!   if(icol.eq.63.and.irow.eq.1)then
!    write(*,*)
!   endif
 ...
 ELSE 
  ...
  DO I=N1,N2
   ...
   ELSE
    ...
    ELSE
     NAME=FNAME(:INDEX(FNAME,'.',.TRUE.)-1)//'_L#'//TRIM(ITOS(I))//'.NAM'
    ENDIF
   ...
   ELSE
    ...
    ELSE
     WRITE(IU,'(A)') 'LIST 10 '//CHAR(39)//'.\'//TRIM(MNAME)//'_L#'//TRIM(ITOS(I))//'.LIST'//CHAR(39)
     WRITE(IU,'(A)') 'MET 11  '//CHAR(39)//TRIM(DIRMNAME)//'_L#'//TRIM(ITOS(I))//'.MET7'//CHAR(39)
    ENDIF
   ENDIF
...
! ENDIF
 ...
 DO I=N1,N2
  ...
  ELSE
   ...
   ELSE
    CALL OSD_OPEN(IU,FILE=TRIM(DIRMNAME)//'_L#'//TRIM(ITOS(I))//'.PST1',STATUS='UNKNOWN',ACTION='WRITE',FORM='FORMATTED')
   ENDIF   
  ENDIF
  IF(IU.EQ.0)RETURN
...
!  ITMP1=1; IF(KPER.EQ.0)ITMP1=0; IF(KPER.LT.0)ITMP1=-1
 ...
 DO I=N1,N2
  ...
  ELSE
   ...
   ELSE
    CALL OSD_OPEN(IU,FILE=TRIM(DIRMNAME)//'_L#'//TRIM(ITOS(I))//'.MET7',STATUS='UNKNOWN',ACTION='WRITE',FORM='FORMATTED')
   ENDIF
  ENDIF
  IF(IU.EQ.0)RETURN
  ...
  ELSE
   ...
   ELSE
    LINE='RESULTDIR "'//TRIM(DIR(:INDEX(DIR,'\',.TRUE.)-1))//'\IPEST_L#'//TRIM(ITOS(I))//'"'; WRITE(IU,'(A)') TRIM(LINE)
   ENDIF
  ENDIF
...
!     WRITE(*,'(A3,I4,A15,2E15.7)') CMOD(ITOPIC),JLAY,'  NoActiveLayer',IDF%X(ICOL,IROW),IDF%NODATA
     PAUSE; STOP
    ENDIF  
   ENDIF
