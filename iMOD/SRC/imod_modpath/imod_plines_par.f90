...
INTEGER,POINTER,DIMENSION(:) :: SLAY   ,MAXILAY
INTEGER,POINTER,DIMENSION(:) :: SLAY_BU,MAXILAY_BU
REAL,POINTER,DIMENSION(:,:) :: XLC   ,YLC   ,ZLC   ,ZLL   ,TOT
REAL,POINTER,DIMENSION(:,:) :: XLC_BU,YLC_BU,ZLC_BU,ZLL_BU,TOT_BU
INTEGER,POINTER,DIMENSION(:,:) :: KLC   ,JLC   ,ILC
INTEGER,POINTER,DIMENSION(:,:) :: KLC_BU,JLC_BU,ILC_BU

TYPE PLOBJ
 REAL :: TDEL,TINC,TCUR,TMAX
 INTEGER :: IREV,NPART,IPLOTSP,SPCOLOR
 INTEGER :: NPER
 INTEGER(KIND=GLSIZEI) :: LISTINDEX
END TYPE PLOBJ
TYPE(PLOBJ) :: PL
