...
! END DO
 ...
 !##potential discharge on edge (geen effect op rand!), knipmodellen altijd!
 !   IF(ICOL.EQ.1.OR.ICOL.EQ.NCOL.AND.IBOUND(ICOL,IROW,ILAY).NE.0)IBOUND(ICOL,IROW,ILAY)=0
 !   IF(IROW.EQ.1.OR.IROW.EQ.NROW.AND.IBOUND(ICOL,IROW,ILAY).NE.0)IBOUND(ICOL,IROW,ILAY)=0
