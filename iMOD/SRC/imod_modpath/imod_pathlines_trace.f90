...
CONTAINS
 ...
 IF(ID.EQ.ID_OPEN)THEN
  ...
  DO I=1,MIN(SIZE(SP),NSPG)
   ...
   CALL TRACE_3D_STARTPOINTS_ASSIGN(I,1,SP(I)%NPART)
 ...
 SELECT CASE (ISP)
  !## spatial distributed
  CASE (1)
   CALL TRACE_3D_STARTPOINTS_LOCATION(NSGRP)
...
! write(*,*) nspg
 ...
 !###======================================================================
 SUBROUTINE TRACE_3D_STARTPOINTS_LOCATION(NSGRP)
 !###======================================================================
 IMPLICIT NONE
