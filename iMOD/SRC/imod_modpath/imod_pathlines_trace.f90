...
! IF(ALLOCATED(LVISIT))DEALLOCATE(LVISIT)
 ...
 !###======================================================================
 SUBROUTINE TRACEPOSTPROCESSING(IFFFLOW,IPFFLOW,IDFFLOW,IPFFNAME,IPFICOL,ICONVERTGEN,TOPFNAME,BOTFNAME,IEXPORT) 
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: IFFFLOW,IPFFLOW,IDFFLOW,IPFFNAME,TOPFNAME,BOTFNAME
 INTEGER,INTENT(IN),DIMENSION(4) :: IPFICOL
 INTEGER,INTENT(IN) :: ICONVERTGEN,IEXPORT
 ...
 ELSE
  ...
  NUNQ=1; ALLOCATE(IPF(NUNQ)); IPF(1)%UNQLABEL='3D_iexport'//TRIM(ITOS(IEXPORT)); IPF(1)%INQ=1
 ENDIF 
