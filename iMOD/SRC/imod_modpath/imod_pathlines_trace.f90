...
USE MOD_DEMO_PAR
USE MOD_3D_PAR, ONLY : PLLISTINDEX,PLLISTCLR,PLLISTAGE,STPLISTINDEX,MIDPOS,TOP,BOT,XYZAXES,IDFPLOT,NSPG,SPGCLR,SPGPOS,MAXNSPG
...
!                  RUNFILE,'Select iMODPATH runfile (*.run)'))RETURN
 ...
 CALL WDIALOGGETINTEGER(IDF_INTEGER9,NSPG)

 !## drawinglist index
 ALLOCATE(PLLISTINDEX(N,NSPG)); PLLISTINDEX=0
 !## colour fraction
