...
CONTAINS
 ...
 IF(ID.EQ.ID_OPEN)THEN
  ...
  IF(PL%NPART.GT.0)THEN
   CALL WMESSAGEBOX(YESNO,QUESTIONICON,COMMONCANCEL,'Do you want to remove existing particels first?','Question')
  ...
  DO I=1,MIN(SIZE(SP),NSPG)
   ...
   DO J=1,SP(I)%NPART; READ(IU,'(3(F10.2,1X))') XSP(J),YSP(J),ZSP(J); ENDDO
...
! write(*,*) nspg
 ...
 LOGICAL :: LIDF,LIPF
 LOGICAL,DIMENSION(2) :: LEX
 INTEGER :: I,J,II,IROW,ICOL,IIDF,INCLD,NX,ILAY,IRANDOM,N
 REAL :: DZ,X
 TYPE(IDFOBJ) :: PIDF
