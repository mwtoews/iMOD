...
USE MOD_DEMO_PAR
USE MOD_3D_PAR, ONLY : PLLISTINDEX,PLLISTCLR,PLLISTAGE,MIDPOS,TOP,BOT,XYZAXES
...
!                  RUNFILE,'Select iMODPATH runfile (*.run)'))RETURN
 ...
 CALL WDIALOGRANGETRACKBAR(IDF_TRACKBAR1,0,N,1); CALL WDIALOGPUTTRACKBAR(IDF_TRACKBAR1,0)
...
! CALL WDIALOGGETINTEGER(IDF_INTEGER1,PL_NPER)
 ...
 PL%TCUR=TTMAX/DYEAR; CALL WDIALOGPUTREAL(IDF_REAL7,PL%TCUR) !; CALL WDIALOGPUTINTEGER(IDF_INTEGER1,PL%NPER)
