...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: I,N,ISP,NP,NG,IG,IG1,IG2
...
!      IF(SPR(IG)%KLC(I).EQ.0)EXIT
 ...
 INTEGER :: IU,I,J,N,IOS,IDSCH,IROW1,IROW2,ICOL1,ICOL2,NROW,NCOL
 REAL :: T,D,EPS,DX,DY
...
IPFLOOP: DO I=1,SIZE(IPF)
 ...
 I=INDEX(IFFFNAME(ISPFNAME),'.',.TRUE.)
