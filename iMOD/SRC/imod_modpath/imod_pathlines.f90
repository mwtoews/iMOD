...
! CALL WDIALOGFIELDSTATE(IDF_RADIO4,K)
 ...
 CALL WDIALOGSELECT(ID_DPATHTAB1)
 CALL WDIALOGPUTSTRING(IDF_CHECK2,'Flow Right Face [x] ('//TRIM(ITOS(NL(1)))//' layers)')
 CALL WDIALOGFIELDSTATE(IDF_CHECK2,MIN(1,NL(1)))
 CALL WDIALOGPUTCHECKBOX(IDF_CHECK2,MIN(1,NL(1)))
 CALL WDIALOGPUTSTRING(IDF_CHECK3,'Flow Front Face [y] ('//TRIM(ITOS(NL(2)))//' layers)')
 CALL WDIALOGFIELDSTATE(IDF_CHECK3,MIN(1,NL(2)))
 CALL WDIALOGPUTCHECKBOX(IDF_CHECK3,MIN(1,NL(2)))
 CALL WDIALOGPUTSTRING(IDF_CHECK4,'Flow Lower Face [z] ('//TRIM(ITOS(NL(3)))//' layers)')
