...
CONTAINS
 ...
 !###====================================================================
 SUBROUTINE TRACEREADBLOCK_R(X,NROW,NCOL,FNAME,IU,SCLTYPE,DELC,DELR,ISMOOTH,BUFF)
 !###====================================================================
 IMPLICIT NONE
 ...
 INTEGER,ALLOCATABLE,DIMENSION(:,:) :: PDELR
 INTEGER,ALLOCATABLE,DIMENSION(:,:) :: PDELC
 REAL :: XMIN,YMIN,XMAX,YMAX,CS,IDFVAL,DX,NODATA
 INTEGER :: IROW,ICOL,DNROW,DNCOL,IR1,IR2,IC1,IC2,IEQ
 ...
 IF(IU.GT.0)THEN
  ...
  IF(ISMOOTH.EQ.1)THEN
   ...
   IF(DX.LT.CS)CALL TRACEREADBLOCKSMOOTH(X,NROW,NCOL,PDELR,PDELC,CS,DX,DELR(0),DELC(0),DNROW,DNCOL,BUFF,NODATA)
  ENDIF
 ENDIF
