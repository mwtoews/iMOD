...
REAL,PARAMETER :: ACCURACY=EPSILON(1.0)
...
CONTAINS
 ...
 SUBROUTINE FLOLIN(IPART,MODE,TIME,TMAX,IDSCH,JP,IP,KP, &
  ...
  POR,NCON,NCOL,NROW,NLAY,NLPOR,NZDIM,NCP1,        &
  NRP1,NLP1,ISNK,IREV,FRAC,I2,ISS,MAXVELOCITY,DELX,DELY,MAXILAY)
 !###====================================================================
 ...
 !###====================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN)                :: NROW,NCOL,NLAY,NZDIM,NCP1,&
                                      NLP1,NRP1,NLPOR,IREV,ISS, &
                                      ISNK,MODE,IPART,I2
 INTEGER,INTENT(IN OUT)            :: JP,IP,KP,MAXILAY
 REAL,INTENT(IN)                   :: TMAX,FRAC
 REAL,INTENT(IN OUT)               :: TIME,ZLOC,XP,YP,ZP,MAXVELOCITY
 INTEGER,INTENT(OUT)               :: IDSCH
 INTEGER,DIMENSION(NCOL,NROW,NLAY) :: IBOUND
 INTEGER,DIMENSION(NLAY)           :: NCON
 REAL,DIMENSION(NZDIM)             :: ZTOP,ZBOT
 REAL,DIMENSION(NCOL,NROW,NLAY)    :: QSS !,HEAD
 REAL,DIMENSION(NCOL,NRP1,NLAY)    :: QY
 REAL,DIMENSION(NCP1,NROW,NLAY)    :: QX
 REAL,DIMENSION(NCOL,NROW,NLP1)    :: QZ
 REAL,DIMENSION(NCOL,NROW,NLPOR)   :: POR
 REAL,DIMENSION(NCOL)              :: XMAX,DELX
 REAL,DIMENSION(NROW)              :: YMAX,DELY
