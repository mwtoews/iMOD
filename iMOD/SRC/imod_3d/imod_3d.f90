...
! ZLEFT=-XYZAXES(1)*1.5_GLFLOAT; ZRIGHT=XYZAXES(1)*1.5_GLFLOAT; ZTOP=XYZAXES(1)*1.5_GLFLOAT; ZBOTTOM=-XYZAXES(1)*1.5_GLFLOAT
 ...
 DXY=TOP%X-BOT%X
 ZLEFT  =BOT%X-0.5_GLFLOAT*DXY
 ZRIGHT =TOP%X+0.5_GLFLOAT*DXY
 DXY=TOP%Y-BOT%Y
 ZBOTTOM=BOT%Y-0.5_GLFLOAT*DXY
 ZTOP   =TOP%Y+0.5_GLFLOAT*DXY
...
! CALL glViewPort(0_glsizei,0_glsizei,IWINWIDTH,IWINHEIGHT) 
 ...
 J=2; DO I=1,SIZE(IDZR)
  ZR(I)=SXVALUE(J)
  CALL WMENUSETSTRING(IDZR(I),'Scale 1:'//TRIM(ITOS(INT(ZR(I)))))
  J=J+1  
 ENDDO
