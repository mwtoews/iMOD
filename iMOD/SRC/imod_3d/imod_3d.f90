...
USE MOD_3D_DISPLAY, ONLY : IMOD3D_DISPLAY,IMOD3D_DISPLAY_IPF,IMOD3D_RESET_TO_INIT,IMOD3D_LIGHT,IMOD3D_DISPLAY_SAVE
...
USE MOD_3D_PROCESS
USE MOD_IDF, ONLY : IDFIROWICOL,IDFGETLOC
...
! CALL WGLSELECT(0)
 ...
 CALL UTL_MESSAGEHANDLE3D(0)
 
 CALL IMOD3D_GET_HEADING_TILE()
 WALK_MODE=0
 ...
 SELECT CASE (ID)
  ...
  CASE (ID_ZRATIO1,ID_ZRATIO2,ID_ZRATIO3,ID_ZRATIO4,ID_ZRATIO5)
   DO I=1,SIZE(IDZR); IF(ID.EQ.IDZR(I))EXIT; ENDDO
   CALL IMOD3D_SETUPDISPLAY_MISC(.TRUE.,IZR=I)
   CALL IMOD3D_DISPLAY(1)
...
!   CALL IMOD3D_DISPLAY(1)
 ...
 !###======================================================================
 SUBROUTINE IMOD3D_INIT(IACTSOLID)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IACTSOLID
 INTEGER :: IFLAGS,IW,I
 ...
 CALL WINDOWOPENCHILD(IWIN,FLAGS=IFLAGS,MENUID=ID_MENU9,     &
                      ...
                      TITLE=TITLE)!'3D Tool: Project not saved')
...
! ZLEFT=-REAL(IWINWIDTH)/2.0; ZRIGHT=REAL(IWINWIDTH)/2.0; ZTOP=REAL(IWINHEIGHT)/2.0; ZBOTTOM=-REAL(IWINHEIGHT)/2.0
 ...
 CALL WDIALOGPUTREAL(IDF_REAL3,REAL(BOT%X),'(F10.2)')
 CALL WDIALOGPUTREAL(IDF_REAL4,REAL(BOT%Y),'(F10.2)')
 CALL WDIALOGPUTREAL(IDF_REAL5,REAL(TOP%X),'(F10.2)')
 CALL WDIALOGPUTREAL(IDF_REAL6,REAL(TOP%Y),'(F10.2)')
