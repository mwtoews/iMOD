...
CONTAINS
 ...
 IF(MESSAGE%WIN.EQ.ID_D3DSETTINGS     .OR.MESSAGE%WIN.EQ.ID_D3DSETTINGS_TAB1.OR.MESSAGE%WIN.EQ.ID_D3DSETTINGS_TAB2.OR. &
    ...
    MESSAGE%WIN.EQ.ID_D3DSETTINGS_TAB6.OR.MESSAGE%WIN.EQ.ID_D3DSETTINGS_TAB7.OR.MESSAGE%WIN.EQ.ID_D3DSETTINGS_TAB8)THEN
...
! IWINWIDTH =IWINWIDTH-IW
 ...
 IFLAGS=SysMenuOn+MinButton+Maxbutton+StatusBar+OwnedByParent   !SYSMENUON+MINBUTTON+MAXBUTTON+STATUSBAR+OWNEDBYPARENT+MAXWINDOW !INSIDEPARENT!  !!
 TITLE='3D Tool'
...
!  INTEGER(kind=GLsizei) :: width
!  INTEGER(kind=GLsizei) :: height
!)
!
!x, y
!
...
!width, height
!
!The width and height, respectively, of the viewport. When an OpenGL context is first attached to a window, 
...
! I=WINFOERROR(1)
! CALL WINDOWDIALOG(ID_D3DSETTINGS,ID_D3DSETTINGS)
 I=WINFOERROR(1)
