...
USE MOD_PLINES_TRACE, ONLY : TRACEIREV,TRACE_3D_COMPUTE
USE MOD_PLINES_PAR, ONLY : IREV,TMAX,TDEL,TINC
...
!  CALL WDIALOGPUTREAL(IDF_REAL3,Z)
  CALL WDIALOGPUTREAL(IDF_REAL4,TMAX)
  CALL WDIALOGPUTREAL(IDF_REAL5,TDEL)
  CALL WDIALOGPUTREAL(IDF_REAL6,TINC)
    ...
    CASE (FIELDCHANGED)
     SELECT CASE (MESSAGE%VALUE1)
      CASE (IDF_RADIO1,IDF_RADIO2)
       IF(MESSAGE%VALUE1.NE.MESSAGE%VALUE2)THEN
        !## switch
        IREV=ABS(IREV-1); CALL TRACEIREV()
!        CALL IMOD3D_SETTINGSPUT(ID_D3DSETTINGS_TAB4)
!        CALL IMOD3D_SETTINGSFIELDS(ID_D3DSETTINGS_TAB4)
!        CALL IMOD3D_DISPLAY(1)
       ENDIF
