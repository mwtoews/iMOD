...
!       CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB7)
 ...
 DO I=1,M; DO J=1,N
  ...
  GRAPH(I,J)%RX=0.0D0; GRAPH(I,J)%RY=0.0D0; GRAPH(I,J)%NP=NXG; GRAPH(I,J)%CTYPE=''; GRAPH(I,J)%ICLR=0; GRAPH(I,J)%GTYPE=4; GRAPH(I,J)%IGRAPH=1
 ENDDO; ENDDO
...
!  IF(I.EQ.1)THEN
!   BOT%Z= 1.0E10_GLDOUBLE; TOP%Z=-1.0E10_GLDOUBLE
