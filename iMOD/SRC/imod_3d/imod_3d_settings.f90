...
USE MOD_3D_PROCESS
USE MOD_IPF_PAR, ONLY : NIPF,NLITHO,BH
...
!       CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB7)
 ...
 DO I=1,M
  ...
  ELSEIF(ASSF(ISELECTED)%ITOPIC.EQ.4)THEN
   GRAPH(I,1)%RY(1)=ASSF(ISELECTED)%Z(I)
!   CALL WGRIDPUTCELLDOUBLE(IDF_GRID1,1,I,ASSF(ISELECTED)%DX(I),'(F10.2)')
!   CALL WGRIDPUTCELLDOUBLE(IDF_GRID1,2,I,ASSF(ISELECTED)%DY(I),'(F10.2)')
!   CALL WGRIDPUTCELLDOUBLE(IDF_GRID1,3,I,ASSF(ISELECTED)%Z(I) ,'(F10.2)')
  ENDIF
 ...
 IF(NSOLLIST.GT.0.AND.ID.EQ.ID_D3DSETTINGS_TAB6)THEN
  CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB6)
  SOLPLOT%ISEL=0; CALL WDIALOGGETMENU(IDF_MENU1,SOLPLOT%ISEL)
