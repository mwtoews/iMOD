...
!       CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB7)
 ...
 SELECT CASE (MESSAGE%VALUE2)
  ...
  CASE (IDF_RADIO5)  !# Area
   J=1; CALL IMOD3D_SETTINGSMAIN_FIELDSPL_GRAY(J,K,L,M,N)
  CASE (IDF_RADIO6)  !# IDF
   K=1; CALL IMOD3D_SETTINGSMAIN_FIELDSPL_GRAY(J,K,L,M,N)
  CASE (IDF_RADIO7)  !# Sink
   L=1; CALL IMOD3D_SETTINGSMAIN_FIELDSPL_GRAY(J,K,L,M,N)
  CASE (IDF_RADIO8)  !# File
   M=1; CALL IMOD3D_SETTINGSMAIN_FIELDSPL_GRAY(J,K,L,M,N)
  CASE (IDF_RADIO11) !# Layer
   N=1; CALL IMOD3D_SETTINGSMAIN_FIELDSPL_GRAY(J,K,L,M,N)
 END SELECT
