     ...
     SELECT CASE (MESSAGE%VALUE1)
      CASE (IDF_MENU1)
       IF(MESSAGE%VALUE1.EQ.MESSAGE%VALUE2)THEN
        ...
        CALL IMOD3D_DISPLAY(1)
       ENDIF
      CASE (IDF_CHECK3,IDF_CHECK2,IDF_CHECK4,IDF_CHECK5) !IDF_TRACKBAR1)   !## shading/plotlegend/transparancy
       IF(MESSAGE%VALUE1.EQ.MESSAGE%VALUE2)THEN
...
!       CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB7)
 ...
 DO I=1,M; DO J=1,N
  ...
  GRAPH(I,J)%RX=0.0D0; GRAPH(I,J)%RY=0.0D0; GRAPH(I,J)%NP=NXG; GRAPH(I,J)%CTYPE=''; GRAPH(I,J)%ICLR=0; GRAPH(I,J)%GTYPE=3
 ENDDO; ENDDO
...
!   CALL WGRIDPUTCELLDOUBLE(IDF_GRID1,3,I,ASSF(ISELECTED)%Z(I) ,'(F10.2)')
  ...
  GRAPH(I,1)%ICLR=ICLR 
  GRAPH(I,1)%LEGTXT=ASSF(ISELECTED)%L(J-1,I)
 END DO
