...
USE MOD_PLINES_TRACE, ONLY : TRACEIREV,TRACE_3D_STARTPOINTS,TRACE_3D_STARTPOINTS_SHOW, &!,TRACE_3D_COMPUTE
...
CONTAINS
 ...
 INTEGER :: IIPF,IROW,ICOL,IRGB,I,J,ILEG,PL_ITYPE,IRUN
      ...
      CASE (ID_START)
       IF(PL%IRUN.EQ.0)THEN
        IF(TRACE_3D_RESET(1))THEN
         ...
         CALL WDIALOGFIELDSTATE(ID_STOP,1) !; CALL WDIALOGPUTSTRING(ID_START,'Pause'); PL%IRUN=1
...
!          CASE (MENUSELECT)
!           CALL IMOD3D_MENUSELECT(PL_MESSAGE%VALUE1)
!           CALL IMOD3D_MENUSELECT(ISTOP,PL_MESSAGE%VALUE1)
!          CASE (PUSHBUTTON)
!           SELECT CASE (PL_MESSAGE%VALUE1)
!            CASE (ID_START)
!             IF(PL%IRUN.EQ.0)THEN; CALL WDIALOGPUTSTRING(ID_START,'Pause'); PL%IRUN=1
!             ELSEIF(PL%IRUN.EQ.1)THEN; CALL WDIALOGPUTSTRING(ID_START,'Continue'); PL%IRUN=0; ENDIF
!            CASE (ID_STOP)
!             EXIT
!           END SELECT
!         END SELECT
...
!       ENDIF      
 ...
 !###======================================================================
 SUBROUTINE IMOD3D_SETTINGSMAIN_STOP()
 !###======================================================================
 IMPLICIT NONE
 
 CALL WDIALOGPUTSTRING(ID_START,'Start'); CALL WDIALOGFIELDSTATE(ID_STOP,0)
 CALL WDIALOGFIELDSTATE(IDF_RADIO1,1); CALL WDIALOGFIELDSTATE(IDF_RADIO2,1)
 CALL TRACE_DEAL_SPR(); PL%IRUN=0; CALL IMOD3D_DISPLAY(1)

 END SUBROUTINE IMOD3D_SETTINGSMAIN_STOP
