...
CONTAINS
 ...
 !## show bitmap slightly above the bottom initially
 ...
 INTEGER :: IIPF,IROW,ICOL,IRGB,I,J,ILEG,PL_ITYPE,IRUN,DID
 ...
 SELECT CASE (MESSAGE%VALUE2)
  ...
  CASE (IDF_RADIO1,IDF_RADIO2)
   ...
   IF(MESSAGE%VALUE1.NE.MESSAGE%VALUE2)THEN
    ...
    CALL TRACEIREV()
   ENDIF
  CASE (IDF_RADIO5,IDF_RADIO6,IDF_RADIO7,IDF_RADIO8)
   CALL WDIALOGGETRADIOBUTTON(MESSAGE%VALUE2,I)
!   IF(I.EQ.1)THEN !# I=1; area (IDF_RADIO5)
!    !# uitgrijzen bijbehorende velden bij andere radio buttons
!    CALL WDIALOGFIELDSTATE(IDF_RADIO6,0)
!   ELSEIF(I.EQ.2)THEN !# I=2; area (IDF_RADIO6)
!    
!   ELSEIF(I.EQ.3)THEN !# I=3; area (IDF_RADIO7)
!    
!   ELSEIF(I.EQ.4)THEN !# I=4; area (IDF_RADIO8)
!    
!   ENDIF
 END SELECT
...
! CALL WDIALOGPUTMENU(IDF_MENU1,CLPPLOT%FNAME,NCLPLIST,CLPPLOT%ISEL)
 ...
 !## dividing for opengl coordinate system
 ...
 IF(NSOLLIST.GT.0.AND.ID.EQ.ID_D3DSETTINGS_TAB6)THEN
  ...
  IF(SUM(SOLPLOT(1:NSOLLIST)%ISEL).GT.0)THEN
   DO I=1,NSOLLIST; IF(SOLPLOT(I)%ISEL.EQ.1)THEN
    IF(JD.EQ.IDF_TRACKBAR1)CALL WDIALOGGETTRACKBAR(IDF_TRACKBAR1,SOLPLOT(I)%IBLEND)
...
!  ENDIF
 ...
 IF(NIDFLIST.GT.0.AND.ID.EQ.ID_D3DSETTINGS_TAB1)THEN
  ...
  CALL WDIALOGFIELDSTATE(IDF_RADIO5,J); CALL WDIALOGFIELDSTATE(IDF_TRACKBAR6,J)
  CALL WDIALOGFIELDSTATE(IDF_LABEL5,J); CALL WDIALOGFIELDSTATE(IDF_LABEL9,J)
