...
CONTAINS
 ...
 CALL WDIALOGRANGETRACKBAR(IDF_TRACKBAR1,1,180,30)
...
! CALL WDIALOGPUTMENU(IDF_MENU1,CLPPLOT%FNAME,NCLPLIST,CLPPLOT%ISEL)
 ...
 IF(ID.EQ.ID_D3DSETTINGS_TAB9)THEN
  !## disable tab
  IF(NIDFLIST.EQ.0.AND.NIPFLIST.EQ.0)THEN
   CALL WDIALOGSELECT(ID_D3DSETTINGS)
  ...
  ELSE
   ...
   IF(NIDFLIST.GT.0)THEN
    CALL WDIALOGSETTAB(IDF_TAB1,ID_D3DSETTINGS_TAB9_TAB1)
   ...
   ELSE
    CALL WDIALOGTABSTATE(IDF_TAB1,ID_D3DSETTINGS_TAB9_TAB1,0)
    CALL WDIALOGSETTAB(IDF_TAB1,ID_D3DSETTINGS_TAB9_TAB2)
   ENDIF
   IF(NIPFLIST.GT.0)THEN
    CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB9_TAB2)
   ELSE
    CALL WDIALOGTABSTATE(IDF_TAB1,ID_D3DSETTINGS_TAB9_TAB2,0)
   ENDIF
  ENDIF
 ENDIF
...
!  ENDIF
 ...
 IF(NIDFLIST.GT.0)THEN
  ...
  DO I=1,NIDFLIST
   ...
   IF(IDFPLOT(I)%IPLOTLEGEND.EQ.1)ILG=ILG+1
  ENDDO
  CALL WMENUSETSTATE(ID_3DVIEW_SHADES,ITEMENABLED,MIN(1,ION))
  CALL WMENUSETSTATE(ID_3DVIEW_LEGEND,ITEMCHECKED,MIN(1,ILG))
 ENDIF
