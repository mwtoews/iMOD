...
! IF(NCLPLIST.LE.0)CALL WDIALOGFIELDSTATE(ID_DELETE,0)
 ...
 INTEGER :: IIPF,IROW,ICOL,IRGB,I,ILEG
 REAL :: ANGLE,X,Y,Z,D
...
! CALL WDIALOGPUTMENU(IDF_MENU1,CLPPLOT%FNAME,NCLPLIST,CLPPLOT%ISEL)
 ...
 !###======================================================================
 SUBROUTINE IMOD3D_UPDATEWINDOW(WXMIN,WYMIN,WXMAX,WYMAX)
 !###======================================================================
 IMPLICIT NONE
 REAL,INTENT(IN) :: WXMIN,WXMAX,WYMIN,WYMAX
 
 XYZAXES(1)=4.0_GLFLOAT
 XYZAXES(2)=4.0_GLFLOAT
 XYZAXES(3)=2.0_GLFLOAT
 
 CALL WDIALOGLOAD(ID_D3DSETTINGS)
 CALL WDIALOGSELECT(ID_D3DSETTINGS_TAB5)
 
 CALL WDIALOGPUTREAL(IDF_REAL3,WXMIN)
 CALL WDIALOGPUTREAL(IDF_REAL4,WYMIN)
 CALL WDIALOGPUTREAL(IDF_REAL5,WXMAX)
 CALL WDIALOGPUTREAL(IDF_REAL6,WYMAX)
  
 CALL IMOD3D_HORIZONTALAXES()
 CALL IMOD3D_DISPLAY(1) 

 END SUBROUTINE IMOD3D_UPDATEWINDOW
