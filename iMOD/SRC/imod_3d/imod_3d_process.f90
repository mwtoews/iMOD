...
CONTAINS
 ...
 REAL(KIND=GLDOUBLE) :: FPAN       =0.005_GLDOUBLE
 REAL(KIND=GLDOUBLE) :: FROTATE    =2.00_GLDOUBLE
! REAL(KIND=GLDOUBLE) :: FSCALE_ZOOM=0.02_GLDOUBLE
! REAL(KIND=GLDOUBLE) :: FPAN       =0.05_GLDOUBLE
! REAL(KIND=GLDOUBLE) :: FROTATE    =0.50_GLDOUBLE
