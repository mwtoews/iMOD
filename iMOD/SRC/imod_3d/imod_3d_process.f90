...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 REAL :: A,X1,X2,Y1,Y2,DX,DY,X,Y,DXY,XM,YM,ZM,XP,YP,ZP,XX1,XX2,YY1,YY2, &
   XINTER,YINTER
 ...
 IF(A.NE.0.0)THEN
  ...
  DO K=1,SIZE(NXYZCROSS)
   DO KK=1,NXYZCROSS(K)
    ...
    CALL UTL_ROTATE_XYZ(XP,YP,ZP,0.0,0.0,A)
  ...
  DO K=1,SIZE(NXYZCROSS)
   ...
   CALL IGRINTERSECTLINE(X1,Y1,X2,Y2,XX1,YY1,XX2,YY2,XINTER,YINTER,ISTATUS)
