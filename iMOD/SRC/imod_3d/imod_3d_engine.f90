...
USE IMODVAR, ONLY : DP_KIND,SP_KIND,IBACKSLASH,ILABELNAME,PI,SCLNAMES_DOWN
USE MOD_IDF
...
!  IF(IPFPLOT(IIPF)%ISEL.EQ.1)NSEL(IIPF)=NSEL(IIPF)+IPFDLIST(1,I)
 ...
 IF(IOPTION.EQ.0)THEN
  ...
  IDFDATA(3)=10; CALL WDIALOGPUTMENU(IDF_MENU2,SCLNAMES_DOWN,SIZE(SCLNAMES_DOWN),IDFDATA(3))
