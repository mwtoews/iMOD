...
! VIEWDX=(TOP%X-BOT%X)/2.0_GLFLOAT/XYZAXES(1); VIEWDY=(TOP%Y-BOT%Y)/2.0_GLFLOAT/XYZAXES(2)
...
! VIEWDY=(TOP%Y-BOT%Y)/2.0_GLFLOAT/XYZAXES(2)
 ...
 DO IPLOT=1,MXMPLOT
  IF(MP(IPLOT)%ISEL.AND.MP(IPLOT)%IPLOT.EQ.3)THEN
   ...
   CALL IMOD3D_DRAWIFF(VIEWDX,VIEWDY,IPLOT,NINIFF)!MP(IPLOT)%IDFNAME)
  ENDIF
 ENDDO
...
! VIEWDY=(TOP%Y-BOT%Y)/2.0_GLFLOAT/XYZAXES(2)
 ...
 !###======================================================================
 IMPLICIT NONE
 REAL(KIND=GLFLOAT) :: DXX,DYY,GX,GY,GZ,DXY  !DX,DY,
