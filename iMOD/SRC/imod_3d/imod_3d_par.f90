...
INTEGER(KIND=GLUINT),ALLOCATABLE,DIMENSION(:) :: GENLISTINDEX,IFFLISTINDEX,SOLLISTINDEX,BMPLISTINDEX,IDFLISTINDEX,CLPLISTINDEX
INTEGER(KIND=GLUINT),ALLOCATABLE,DIMENSION(:,:) :: IPFLISTINDEX
