...
!INTEGER(KIND=GLSIZEI),SAVE :: NIPFLIST,NIDFLIST,DISP_NIDFLIST,NIFFLIST,NGENLIST,NSOLLIST,NCLPLIST,NASSLIST
...
REAL(KIND=GLDOUBLE),SAVE :: FOVY
REAL(KIND=GLDOUBLE),SAVE :: ZFAR
REAL(KIND=GLDOUBLE),SAVE :: ZNEAR
