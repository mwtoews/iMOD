...
CONTAINS
 ...
 IF(X1.LT.IDFM%XMIN)IDFM%XMIN=X2 !IC1=IC1+1 
 IF(Y2.GT.IDFM%YMAX)IDFM%YMAX=Y1 !IR1=IR1-1 
 CALL IDFGETEDGE(IDFC,IR2,IC2,X1,Y1,X2,Y2)
 IF(X2.GT.IDFM%XMAX)IDFM%XMAX=X1 !IC2=IC2-1 
 IF(Y1.LT.IDFM%YMIN)IDFM%YMIN=Y2 !IR2=IR2+1 

 !## return, don't use mother idf
 IF(IR1.EQ.0.OR.IR2.EQ.0.OR.IC1.EQ.0.OR.IC2.EQ.0)RETURN
 
 NROW=IR2-IR1+1; NCOL=IC2-IC1+1
! NCOL=MIN(NCOL,IDFDATA(1)); NROW=MIN(NROW,IDFDATA(2))
