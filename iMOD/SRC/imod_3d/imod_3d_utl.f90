...
USE MOD_UTL, ONLY : UTL_MESSAGEHANDLE3D,UTL_MESSAGEHANDLE,IDFPLOT2BITMAP,RTOS,UTL_IDFSNAPTOGRID
...
! CALL WBITMAPPUTDATA(MPW%IBITMAP,IBMPDATA)
 CALL IGRLOADIMAGEDATA(TRIM(PREFVAL(1))//'\TMP\TMP.BMP',IBMPDATA) !,IPAL)
