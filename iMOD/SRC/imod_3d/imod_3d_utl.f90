 ...
 IF(NIDFLIST.GT.0)THEN
  DO I=1,SIZE(IDFLISTINDEX)
   IF(IDFLISTINDEX(I).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for IDF '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO
 ENDIF
 IF(NIFFLIST.GT.0)THEN
  DO I=1,SIZE(IFFLISTINDEX)
   IF(IFFLISTINDEX(I).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for IFF '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO
 ENDIF
 IF(NIPFLIST.GT.0)THEN
  DO I=1,SIZE(IPFLISTINDEX,1); DO J=1,SIZE(IPFLISTINDEX,2)
   IF(IPFLISTINDEX(I,J).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for IPF '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO; ENDDO
 ENDIF
 IF(NGENLIST.GT.0)THEN
  DO I=1,SIZE(GENLISTINDEX)
   IF(GENLISTINDEX(I).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for GEN '//TRIM(ITOS(I))//'...')  
   ENDIF
  ENDDO
 ENDIF
 IF(NSOLLIST.GT.0)THEN
  DO I=1,SIZE(SOLLISTINDEX,1); DO J=1,SIZE(SOLLISTINDEX,2)
   IF(SOLLISTINDEX(I,J).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for SOL '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO; ENDDO
 ENDIF
 IF(NCLPLIST.GT.0)THEN
  DO I=1,SIZE(CLPLISTINDEX)
   IF(CLPLISTINDEX(I).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for CLP '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO
 ENDIF
 IF(ALLOCATED(BMPLISTINDEX))THEN
  DO I=1,SIZE(BMPLISTINDEX)
   IF(BMPLISTINDEX(I).NE.0)THEN
    ...
    CALL WINDOWOUTSTATUSBAR(4,'Clearing memory for BMP '//TRIM(ITOS(I))//'...')
   ENDIF
  ENDDO
 ENDIF
