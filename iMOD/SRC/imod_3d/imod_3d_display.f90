...
USE MOD_UTL, ONLY : UTL_MESSAGEHANDLE3D,UTL_MESSAGEHANDLE,RTOS,UTL_WSELECTFILE,UTL_CAP
...
! ENDIF
 ...
 IF(PL%IPLOTSP.EQ.1)THEN
  IF(PL%LISTINDEX.NE.0)THEN
   CALL IMOD3D_SETCOLOR(PL%SPCOLOR)
   CALL GLCALLLIST(PL%LISTINDEX)
  ENDIF
 ENDIF
