...
!     CALL GLMATERIALFV(GL_FRONT_AND_BACK,GL_AMBIENT_AND_DIFFUSE,AMBIENT)
 ...
 DO I=1,NSOLLIST
  IF(SOLPLOT(I)%ISEL.NE.1.OR.SOLPLOT(I)%IBITMAP.EQ.1.OR.SOLLISTINDEX(I,1).EQ.0)CYCLE
...
! ENDIF
 ...
 DO I=1,NSOLLIST
  IF(SOLPLOT(I)%ISEL.NE.1.OR.SOLPLOT(I)%IBITMAP.EQ.0.OR.SOLLISTINDEX(I,2).EQ.0)CYCLE
