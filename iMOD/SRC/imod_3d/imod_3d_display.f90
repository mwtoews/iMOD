...
!  CALL GLCLEARCOLOR(0.0_GLFLOAT,0.0_GLFLOAT,0.0_GLFLOAT,0.0_GLFLOAT)
  ...
  IF(NIDFLIST.GT.0)CALL IMOD3D_DISPLAY_TIME_IDF() !IMODE,0)
...
!   !## check laatste
!   IDFPLOT(I)%D4ITIME=IDFPLOT(I)%D4ITIME+1; IF(IDFPLOT(I)%D4ITIME.GT.NF)IDFPLOT(I)%D4ITIME=1
   ...
   DO II=1,NF 
    ...
    DO J=1,NC 
     ...
     IF(ICLR(J).NE.WRGB(255,255,255))THEN
