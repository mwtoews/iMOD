...
CONTAINS
 ...
 !###======================================================================
 SUBROUTINE UTL_LISTOFFILES(FNAME)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,PARAMETER :: STRLEN=256
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 CHARACTER(LEN=*),POINTER,DIMENSION(:),INTENT(INOUT) :: FNAME
 CHARACTER(LEN=:),ALLOCATABLE :: EFNAME
 INTEGER :: N,DID

 DID=WINFODIALOG(CURRENTDIALOG)
     
 ALLOCATE(CHARACTER(LEN=STRLEN) :: EFNAME)
