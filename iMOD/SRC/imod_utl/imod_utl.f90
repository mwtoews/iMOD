...
CHARACTER(LEN=MAXLEN),POINTER,DIMENSION(:,:) :: VAR_TMP,DVAR
...
!###=========================================================================
 ...
 CALL UTL_GENLABELSREAD(FNAME,VAR)
 IF(NV.LE.0)THEN
 ...
 !###======================================================================
 SUBROUTINE UTL_GENLABELSDEALLOCATE(VAR)
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),POINTER,DIMENSION(:,:),INTENT(INOUT),OPTIONAL :: VAR
