...
USE IMODVAR, ONLY : MXTP,TP,IDPROC,BVERSION,RVERSION,LBETA,LEXPDATE,EXPDATE,OPENDIR,SAVEDIR
...
!###=========================================================================
 ...
 DO
  DIR=FILEDIR; IF(SCAN(TRIM(FILEDIR),'\').EQ.0)DIR=SAVEDIR
  FILEDIR=DIR
 ...
 K=INDEXNOCASE(FILEDIR,'\',.TRUE.) 
 IF(INDEX(TRIM(DIR),'*.').EQ.0)SAVEDIR=FILEDIR(:K) !#Removes filename from directory name before saving
