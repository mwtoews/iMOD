...
!   IF(IGRINSIDEPOLYGON(REAL(POL%X,4),REAL(POL%Y,4),POL%N,REAL(X,4),REAL(Y,4)))DBL_IGRINSIDESHAPE=1
  CASE (ID_RECTANGLE)
...
! IF(IGRINSIDECIRCLE(REAL(XD(1),4),REAL(YD(1),4),REAL(RADIUS,4),REAL(PX,4),REAL(PY,4)))DBL_IGRINSIDECIRCLE=1
