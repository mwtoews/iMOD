...
USE RESOURCE
USE MOD_POLYGON_PAR
USE MOD_UTL, ONLY : INVERSECOLOUR,IDFPLOT1BITMAP,IDFPLOT2BITMAP
...
!WRITE(*,*) 'ieq=',selidf(1)%ieq,SELIDF(1)%XMIN,SELIDF(1)%XMax,SELIDF(1)%yMIN,SELIDF(1)%yMax, &
! SELIDF(1)%DX,SELIDF(1)%dy
