...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 REAL :: DX,X1,X2,Y1,Y2,X,Y,WX1,WX2,WY1,WY2,RAT,THEIGHT,TWIDTH
 INTEGER :: I
...
! CALL WGRTEXTFONT(FFHELVETICA,WIDTH=TWIDTH,HEIGHT=THEIGHT,ISTYLE=FSBOLD)
 CALL WGRTEXTFONT(FFSOFTWARE,WIDTH=TWIDTH,HEIGHT=THEIGHT,ISTYLE=FSBOLD) !,ISTYLE=FSBOLD,WIDTH=0.5*0.013,HEIGHT=0.5*0.033)
