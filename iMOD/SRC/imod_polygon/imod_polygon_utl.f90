...
CONTAINS
 ...
 INTEGER :: IOS,IU,JU,N,M,I,J,K,MAXCOL,MAXPOL,IFORMAT,IERROR
...
ILOOP: DO I=1,2
  ...
  DO
   ...
   IF(I.EQ.2.AND.N.GT.0)THEN
    ...
    ENDDO
    IF(K.GT.MAXPOL)THEN
     CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'There is an entry in the DAT file that cannot be related to an entry in the GEN file','Error')
     IERROR=1; EXIT ILOOP
     !## no label found
    ENDIF
