...
!   CALL WCURSORSHAPE(ID_CURSORLINE)
 ...
 !###======================================================================
 SUBROUTINE POLYGON1SAVELOADSHAPE(CODE,GENFNAME,ISAVESEL)
 !###======================================================================
 IMPLICIT NONE
 ...
 ELSEIF(CODE.EQ.ID_SAVESHAPE)THEN 
  ...
  FTYPE=1
  IF(GENFNAME.EQ.'')THEN
   IF(.NOT.UTL_WSELECTFILE('iMOD GEN Files (*.gen)|*.gen|ESRI GEN file (*.gen)|*.gen|IPF Files (*.ipf)|',     &
        SAVEDIALOG+PROMPTON+DIRCHANGE+APPENDEXT,FNAME,'Save GEN/IPF File',FTYPE=FTYPE))RETURN
  ELSE
   FNAME=GENFNAME
