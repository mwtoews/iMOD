...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: N,IPLOT,I,J,K,NPER,NF,NP,NS,I1,I2,ISEC,IEXT,IW,IH,IFRAME
 ...
 IF(.NOT.IDFTIMESERIE_DATES(2,DIR=DIR,ISEC=ISEC,IEXT=IEXT,IFRAME=IFRAME))THEN
  CALL MOVIE_CREATE_CLOSE(); RETURN
 ENDIF
...
!  IF(K.NE.NPER)CALL MANAGERDELETE(0)
 ...
 !## create the mpeg
 IF(L3)THEN; IF(.NOT.MOVIE_CREATE_MPEG(BMPOUTNAME,DIR,ISEC,IFRAME,EXT(IEXT)))K=0; ENDIF
 ...
 !###======================================================================
 LOGICAL FUNCTION MOVIE_CREATE_MPEG(BMPOUTNAME,DIR,ISEC,IFRAME,EXT)
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,EXT
 INTEGER,INTENT(IN) :: ISEC,IFRAME
