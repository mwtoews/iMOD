...
!USE MOD_QKSORT, ONLY : UTL_QKSORT
!USE MOD_IDF, ONLY  : 
USE IMODVAR, ONLY : IDIAGERROR
USE MOD_IDFTIMESERIE_UTL, ONLY : IDFTIMESERIE_DATES
USE MOD_IDFTIMESERIE_PAR, ONLY : NFILES,LISTFILES,MINDATE,MAXDATE !,IDFNAMES
USE MOD_MOVIE_PAR
...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: N,IPLOT,I,J,K,NPER,NF,NP,NS,I1,I2
 LOGICAL :: L1,L2
 ...
 IF(.NOT.IDFTIMESERIE_DATES(2,DIR))THEN
