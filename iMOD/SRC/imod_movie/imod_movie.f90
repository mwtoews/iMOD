...
USE MOD_UTL, ONLY : ITOS,UTL_IDFGETDATE,UTL_IDATETOJDATE,UTL_CREATEDIR,UTL_IMODFILLMENU,JDATETOGDATE,UTL_DEL1TREE, &
      UTL_DEBUGLEVEL,UTL_GETUNIT,UTL_GETUNIQUE_INT,UTL_CLOSEUNITS
...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: N,IPLOT,I,J,K,NPER,NF,NP,NS,ISEC,IEXT,IW,IH,IFRAME,NU
 ...
 CALL UTL_GETUNIQUE_INT(LDATES,NPER,NU,0); NPER=NU
