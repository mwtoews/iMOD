...
USE MOD_UTL, ONLY : ITOS,UTL_IDFGETDATE,UTL_IDATETOJDATE,UTL_CREATEDIR,UTL_IMODFILLMENU,JDATETOGDATE,UTL_DEL1TREE, &
      UTL_DEBUGLEVEL,UTL_GETUNIT,UTL_GETUNIQUE_INT,UTL_CLOSEUNITS,RTOS
...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: N,IPLOT,I,J,K,NPER,NF,NP,NS,ISEC,IEXT,IW,IH,NU
...
!  DO I=NF,1,-1; IF(PLOTNAMES(I).NE.'')THEN; I2=I; EXIT; ENDIF; ENDDO
 ...
 IF(RFRAME.EQ.0.0)THEN
  RFRAMERATE=REAL(SIZE(BMPOUTNAME)/ISEC)
