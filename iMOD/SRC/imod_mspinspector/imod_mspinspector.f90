...
CONTAINS
 ...
 DO I=1,SIZE(FACTSVAT%IACT)
  ...
  DO J=1,N
   ...
   IF(II.GT.I2)THEN
    IF(LDATE)THEN
     JDATE=INT(GRAPH(M,1)%RX(1))
     II=I1+UTL_GETDAYNUMBERFROMJD(JDATE) !METEGRID%INFO(1)%JD)
    ELSE
     II=I1
    ENDIF
   ENDIF
 ...
 DO ILAY=1,NLAY
   ...
   CALL WDIALOGPUTSTRING(IDF_LABEL1,'create '//TRIM(FNAME))
   IPRGS=0
   LEX=.FALSE. 
...
! INTEGER :: YEAR,MONTH,DAY
 ...
 !## disable tab and botton while hoovering
 CALL WDIALOGSELECT(ID_DMSPANALYSER)
 CALL WDIALOGTABSTATE(IDF_TAB1,ID_DMSPANALYSER_TAB5,0)
 CALL WDIALOGFIELDSTATE(IDOK,0)

 CALL WDIALOGSELECT(ID_DMSPANALYSER_TAB3)
 CALL WDIALOGFIELDSTATE(ID_CREATEIDF,0)
 CALL WDIALOGFIELDSTATE(ID_GRAPH,0)
 ...
 !## enable tab and botton after hoovering
 CALL WDIALOGSELECT(ID_DMSPANALYSER)
 CALL WDIALOGTABSTATE(IDF_TAB1,ID_DMSPANALYSER_TAB5,1)
 CALL WDIALOGFIELDSTATE(IDOK,1)

 CALL WDIALOGSELECT(ID_DMSPANALYSER_TAB3)
 CALL WDIALOGFIELDSTATE(ID_CREATEIDF,1)
 CALL WDIALOGFIELDSTATE(ID_GRAPH,1)
