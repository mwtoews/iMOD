...
CONTAINS
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: II,I,J,K,M,N,NXG,WID,FTYPE,STYPE,ICOL,IROW,IERROR,NG,IVEGTYPE,I1,I2
...
!   CALL WGRIDGETCELLINTEGER(IDF_GRID5,3,1,ICOL)
 ...
 !## get current landuse
 READ(LUSESVAT%INSPVAL(3),*) IVEGTYPE
...
END FUNCTION MSPINSPECTOR_OPENFILES_AREASVAT
 ...
 IF(AREASVAT%INFO(N)%NUND.NE.N)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'Expected SVAT='//TRIM(ITOS(N))//' on element '//TRIM(ITOS(N))//' of file AREA_SVAT.INP','Error'); RETURN
 ENDIF
