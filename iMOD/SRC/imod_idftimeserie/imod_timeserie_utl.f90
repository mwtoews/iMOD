...
CONTAINS
 ...
 !###======================================================================
 LOGICAL FUNCTION IDFTIMESERIE_DATES(IOPTION,DIR,ISEC,IEXT,IFRAME)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IOPTION
 CHARACTER(LEN=*),INTENT(OUT),OPTIONAL :: DIR
 INTEGER,INTENT(OUT),OPTIONAL :: ISEC,IEXT,IFRAME
 ...
 SELECT CASE (IOPTION)
  CASE (1)
   ...
   CALL WDIALOGFIELDSTATE(IDF_INTEGER7,3)
  ...
  CASE (2)
   ...
   CALL WDIALOGPUTINTEGER(IDF_INTEGER7,24)
 END SELECT
     ...
     CASE (IDOK)
      ...
      IF(IOPTION.EQ.2)THEN
       ...
       ELSE
        ...
        CALL WDIALOGGETINTEGER(IDF_INTEGER7,IFRAME)
        CALL WDIALOGGETMENU(IDF_MENU4,IEXT)
        CALL WDIALOGGETRADIOBUTTON(IDF_RADIO3,I)
        IF(I.EQ.1)ISEC=0; IF(I.EQ.2)IFRAME=0
       ENDIF
      ELSE
       EXIT
      ENDIF
