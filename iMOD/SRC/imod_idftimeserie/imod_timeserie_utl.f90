...
USE MOD_UTL, ONLY : JD,UTL_JDATETOIDATE,UTL_FILLDATES,IDATETOGDATE,FTIMETOCTIME,CTIMETOFTIME,ITOS,UTL_IDATETOJDATE, &
    UTL_DIRINFO_POINTER,UTL_IDFGETDATES,UTL_MESSAGEHANDLE,UTL_IDFGETDATE,UTL_IMODFILLMENU,UTL_CREATEDIR
USE MOD_IDFTIMESERIE_PAR

CONTAINS

 !###======================================================================
 LOGICAL FUNCTION IDFTIMESERIE_DATES(IOPTION,DIR,ISEC)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IOPTION
 CHARACTER(LEN=*),INTENT(OUT),OPTIONAL :: DIR
 INTEGER,INTENT(OUT),OPTIONAL :: ISEC
 ...
 SELECT CASE (IOPTION)
  ...
  CASE (2)
   ...
   CALL UTL_IMODFILLMENU(IDF_MENU3,TRIM(PREFVAL(1))//'\MOVIES','*','D',N,0,0) !,SETNAME)
...
!      MAXDATE=UTL_IDATETOJDATE(MAXDATE)
 ...
 M=MAXVAL(NFILES); ALLOCATE(LISTFILES(M,N)); LISTFILES=''
 NFILES=0
