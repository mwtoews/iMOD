...
USE WINTERACTER
USE RESOURCE
USE MOD_UTL, ONLY : JD,JDATETOIDATE,UTL_FILLDATES,IDATETOGDATE,FTIMETOCTIME,CTIMETOFTIME
...
CONTAINS
 ...
 IF(IDURATION.EQ.0)THEN !## put axes information on dialog
  ...
  IDATE=JDATETOIDATE(INT(XMIN)+MINDATE)
  ...
  IDATE=JDATETOIDATE(INT(XMAX)+MINDATE)
  CALL IDATETOGDATE(IDATE,IY,IM,ID)
