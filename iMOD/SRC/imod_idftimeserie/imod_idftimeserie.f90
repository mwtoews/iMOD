...
! IPFPLUS(NPLUS)%ID=NPLUS
 ...
 CALL IDFTIMESERIE_PUTMINMAXX(SXVALUE(1),SXVALUE(NSX),SXVALUE(2)-SXVALUE(1),IDURATION) !XMIN,XMAX,AXES%XINT,IDURATION)
 CALL WDIALOGPUTCHECKBOX(IDF_CHECK1,1)

 I=5; AXES%YINT=(YMAX-YMIN)/REAL(I)
 CALL IDFTIMESERIE_PUTMINMAXY(SYVALUE(1),SYVALUE(NSY),SYVALUE(2)-SYVALUE(1)) !YMIN,YMAX,AXES%YINT)
 CALL WDIALOGPUTCHECKBOX(IDF_CHECK2,1)
