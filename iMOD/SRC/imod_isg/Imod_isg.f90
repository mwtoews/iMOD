...
USE MOD_ISG_PLOT, ONLY : ISGPLOTSHAPE,ISGPLOT_FDIRECTION,ISGPLOT_FCONNECTION
USE MOD_ISG_UTL
...
REAL,PARAMETER,PRIVATE :: RNODATA=HUGE(1.0) !-99999.99
     ...
     CASE(1,3)
      ...
      DO I=1,NCLC
       ...
       DO J=1,N
        IREF=IREF+1 
        !## upstream connection
        IF(MESSAGE%VALUE1.EQ.1)DATISD(IREF)%UPSG=IISG
        !## downstream connection
        IF(MESSAGE%VALUE1.EQ.3)DATISD(IREF)%DWNS=IISG
       ENDDO
      ENDDO
...
!   DX=DX+DY; IF(DX.NE.0.0)DX=SQRT(DX)
 ...
 CALL WDIALOGPUTIMAGE(ID_CONNECT,ID_ICONEDITNODES,1)
 ...
 J=I; IF(ISFR.EQ.0)J=0; CALL WDIALOGFIELDSTATE(ID_CONNECT,J)
