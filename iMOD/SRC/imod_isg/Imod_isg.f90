...
USE MOD_UTL, ONLY : ITOS,INVERSECOLOUR,UTL_MESSAGEHANDLE,UTL_CAP,EQUALNAMES,UTL_FILLDATES,RTOS,UTL_IDFSNAPTOGRID,UTL_GETUNIT,         &
             ...
             UTL_IDFGETCLASS,UTL_IDFCRDCOR,UTL_GETCURRENTDATE,UTL_GETCURRENTTIME,UTL_WRITENUMBER,VAR,ICOL_VAR,IACT_VAR,CCNST,IVAR,    &
             JDATETOFDATE,UTL_DIST,UTL_DEBUGLEVEL,UTL_MEASURE,UTL_INSIDEPOLYGON,MAXLEN
