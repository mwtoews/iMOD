...
! CALL WDIALOGGETMENU(IDF_MENU1,IISG)
 ...
 CALL ISGATTRIBUTESPLOT_AXES(XMIN,YMIN,XMAX,YMAX,.FALSE.,'x coordinate','z coordinate')
 RETURN
...
!  DATISQ2(ISEL,1:J-I+1)=DATISQ(I:J)
 ...
 CALL WMENUSETSTATE(ID_ISGISPSTART,I)
 CALL WMENUSETSTATE(ID_ISGISPRESET,I)
 CALL WMENUSETSTATE(ID_ISGISPSAVE,I)
 CALL WMENUSETSTATE(ID_ISGISPSTOP,I)
