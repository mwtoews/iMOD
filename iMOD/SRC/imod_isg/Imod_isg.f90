...
! CALL WDIALOGFIELDSTATE(IDF_CHECK8,I)
 ...
 ENDDO
 I=ISG(JJSG)%ICLC; CALL ISGSORTSEGMENTENTRIES(ISD(I:)%DIST,ISD(I:)%IREF,ISG(JJSG)%NCLC)
 ...
 ENDDO
 I=ISG(JJSG)%ISTW; CALL ISGSORTSEGMENTENTRIES(IST(I:)%DIST,IST(I:)%IREF,ISG(JJSG)%NSTW)
 ...
 ENDDO
 I=ISG(JJSG)%ICRS; CALL ISGSORTSEGMENTENTRIES(ISC(I:)%DIST,ISC(I:)%IREF,ISG(JJSG)%NCRS)
 ...
 ENDDO
 I=ISG(JJSG)%IQHR; CALL ISGSORTSEGMENTENTRIES(ISQ(I:)%DIST,ISQ(I:)%IREF,ISG(JJSG)%NQHR)
