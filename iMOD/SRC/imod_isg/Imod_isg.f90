...
! READ(CDATES(IDATE),'(I8)') IDATE
 ...
 IF(ID.EQ.ID_SAVEAS)THEN
  ...
  DO I=1,TISD(J)
   ...
   ELSE
    LINE=TRIM(ITOS(DATISD2(J,I)%IDATE))//','//TRIM(ITOS(DATISD2(J,I)%ITIME))      //','//TRIM(RTOS(DATISD2(J,I)%WLVL,'F',3))//  &
  ...
  DO I=1,MIN(ISDMAXROW,TISD(J))
   ...
   DO K=1,NK
    IF(IACT_VAR(K).EQ.1)THEN
     ...
     ELSEIF(ISFR.EQ.1)THEN
      IF(K.EQ.1) READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%IDATE
      IF(K.EQ.2) READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%ITIME
      ...
      IF(K.EQ.10)READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%UPSG
      IF(K.EQ.11)READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%ICLC
      IF(K.EQ.12)READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%IPRI
      IF(K.EQ.13)READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%QFLW
      IF(K.EQ.14)READ(LINE,*,IOSTAT=IOS) DATISD2(J,I)%QROF
     ENDIF
     IF(IOS.NE.0)THEN
      TISD(J)=I-1
  ...
  DO I=1,TISC(J)
   IF(I.GE.2)THEN
    LINE=TRIM(RTOS(DATISC2(J,I)%DISTANCE,'F',3)) //','//TRIM(RTOS(DATISC2(J,I)%BOTTOM,'F',3))// &
         ','//TRIM(RTOS(DATISC2(J,I)%KM,'F',2))//','//TRIM(RTOS(DATISC2(J,I)%ZP,'F',1))
   ELSE
    LINE=TRIM(RTOS(DATISC2(J,I)%DISTANCE,'F',3)) //','//TRIM(RTOS(DATISC2(J,I)%BOTTOM,'F',3))// &
 ...
 ELSEIF(ISFR.EQ.1)THEN
  DO K=1,TISD(J)-1
   ...
   SELECT CASE (I)
    ...
    CASE (6)
     Y1=DATISD2(J,K)%DEPTH
     Y2=DATISD2(J,K+1)%DEPTH
    CASE (7)
     Y1=DATISD2(J,K)%DWNS
...
!###====================================================================
 ...
 ELSEIF(ISFR.EQ.1)THEN
  SELECT CASE (I)
   ...
   CASE (5)
    YMIN=MINVAL(DATISD2(J,1:TISD(J))%DEPTH)
    YMAX=MAXVAL(DATISD2(J,1:TISD(J))%DEPTH)
   CASE (6)
 ...
 IF(ISCN(J).EQ.1)THEN
  ...
  CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN),YMIN,REAL(XMAX),YMAX,.FALSE.,'length','depth')
...
! CALL IGRUNITS(X1,Y1,X2,Y2)
 ...
 IF(I.EQ.1)THEN
  CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN),YMIN,REAL(XMAX),YMAX,.TRUE.,'date','upstream')
 ELSE
  CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN),YMIN,REAL(XMAX),YMAX,.TRUE.,'date','downstream')
 ENDIF
 ...
 CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN)-DX,YMIN-DY,REAL(XMAX)+DX,YMAX+DX,.FALSE.,'q','h')
 ...
 CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN),YMIN,REAL(XMAX),YMAX,.FALSE.,'x coordinate','y coordinate')
 ...
 CALL ISGPLOT_FDIRECTION(ISP2%X,ISP2%Y,TISP,XMIN,XMAX,YMIN,YMAX,2.0)
 ...
 ELSEIF(ISFR.EQ.1)THEN
  CALL WGRIDPUTINTEGER(IDF_GRID1,1,DATISD2(J,:)%IDATE,TISD(J))
  CALL WGRIDPUTINTEGER(IDF_GRID1,2,DATISD2(J,:)%ITIME,TISD(J))
  ...
  CALL WGRIDPUTREAL(IDF_GRID1,7,DATISD2(J,:)%WIDTH,TISD(J),'(F10.2)')
  CALL WGRIDPUTREAL(IDF_GRID1,8,DATISD2(J,:)%DEPTH,TISD(J),'(F10.2)')
  CALL WGRIDPUTINTEGER(IDF_GRID1,9,DATISD2(J,:)%DWNS,TISD(J))
  CALL WGRIDPUTINTEGER(IDF_GRID1,10,DATISD2(J,:)%UPSG,TISD(J))
  CALL WGRIDPUTOPTION(IDF_GRID1,11,DATISD2(J,:)%ICLC,TISD(J))
  CALL WGRIDPUTOPTION(IDF_GRID1,12,DATISD2(J,:)%IPRI,TISD(J))
  CALL WGRIDPUTREAL(IDF_GRID1,13,DATISD2(J,:)%QFLW,TISD(J),'(F10.2)')
  CALL WGRIDPUTREAL(IDF_GRID1,14,DATISD2(J,:)%QROF,TISD(J),'(F10.2)')
 ENDIF
...
! ISQ(I)%DIST 
 ...
 ELSEIF(ISFR.EQ.1)THEN
  CALL WGRIDGETINTEGER(IDF_GRID1,1,DATISD2(J,:)%IDATE,ISDMAXROW)
  CALL WGRIDGETINTEGER(IDF_GRID1,2,DATISD2(J,:)%ITIME,ISDMAXROW)
  ...
  CALL WGRIDGETREAL(IDF_GRID1,7,DATISD2(J,:)%WIDTH,ISDMAXROW)
  CALL WGRIDGETREAL(IDF_GRID1,8,DATISD2(J,:)%DEPTH,ISDMAXROW)
  CALL WGRIDGETINTEGER(IDF_GRID1,9,DATISD2(J,:)%DWNS,ISDMAXROW)
  CALL WGRIDGETINTEGER(IDF_GRID1,10,DATISD2(J,:)%UPSG,ISDMAXROW)
  CALL WGRIDGETMENU(IDF_GRID1,11,DATISD2(J,:)%ICLC,ISDMAXROW)
  CALL WGRIDGETMENU(IDF_GRID1,12,DATISD2(J,:)%IPRI,ISDMAXROW)
  CALL WGRIDGETREAL(IDF_GRID1,13,DATISD2(J,:)%QFLW,ISDMAXROW)
  CALL WGRIDGETREAL(IDF_GRID1,14,DATISD2(J,:)%QROF,ISDMAXROW)
 ENDIF
 ...
 DO I=1,ISDMAXROW
  ...
  ELSEIF(ISFR.EQ.1)THEN
   IF(DATISD2(J,I)%IDATE.EQ.INODATA)EXIT
   IF(DATISD2(J,I)%ITIME.EQ.INODATA)EXIT
   IF(DATISD2(J,I)%WLVL .EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%BTML .EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%THCK .EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%HCND .EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%WIDTH.EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%DEPTH.EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%DWNS .EQ.RNODATA)EXIT
   IF(DATISD2(J,I)%UPSG .EQ.RNODATA)EXIT
 ...
 ELSEIF(ISFR.EQ.1)THEN
  ...
  DO I=1,TISD(J); WRITE(CLIST(I),'(I8.8,I6.6)') DATISD2(J,I)%IDATE,DATISD2(J,I)%ITIME; ENDDO
  CALL WSORT(CLIST,1,TISD(J),0,IORDER)
  DO I=1,TISD(J)
   IROW=IORDER(I)
   CALL WGRIDGETCELLINTEGER(IDF_GRID1,1,IROW,DATISD2(J,I)%IDATE)
   CALL WGRIDGETCELLINTEGER(IDF_GRID1,2,IROW,DATISD2(J,I)%ITIME)
   ...
   CALL WGRIDGETCELLREAL(IDF_GRID1,7,IROW,DATISD2(J,I)%WIDTH)
   CALL WGRIDGETCELLREAL(IDF_GRID1,8,IROW,DATISD2(J,I)%DEPTH)
   CALL WGRIDGETCELLINTEGER(IDF_GRID1,9,IROW,DATISD2(J,I)%DWNS)
   CALL WGRIDGETCELLINTEGER(IDF_GRID1,10,IROW,DATISD2(J,I)%UPSG)
   CALL WGRIDGETCELLMENU(IDF_GRID1,11,IROW,DATISD2(J,I)%ICLC)
   CALL WGRIDGETCELLMENU(IDF_GRID1,12,IROW,DATISD2(J,I)%IPRI)
   CALL WGRIDGETCELLREAL(IDF_GRID1,13,IROW,DATISD2(J,I)%QFLW)
   CALL WGRIDGETCELLREAL(IDF_GRID1,14,IROW,DATISD2(J,I)%QROF)
  ENDDO
 ...
 IF(ISCN(J).EQ.1)THEN
  CALL SORTEM(1,TISC(J),DATISC2(J,:)%DISTANCE,2,DATISC2(J,:)%BOTTOM,DATISC2(J,:)%KM,DATISC2(J,:)%ZP,(/0.0/),(/0.0/),(/0.0/),(/0.0/))
 ENDIF
...
! INTEGER,PARAMETER :: INODATA=0
 ...
 CALL SORTEM(1,TISQ(J),DATISQ2(J,:)%QZ,3,DATISQ2(J,:)%HZ,DATISQ2(J,:)%QW,DATISQ2(J,:)%HW,DATISQ2(J,:)%HW &
                                        ,(/0.0/),(/0.0/),(/0.0/)) !DATISQ2(J,:)%HW,DATISQ2(J,:)%HW,DATISQ2(J,:)%HW)
 ...
 ELSEIF(ISFR.EQ.1)THEN
  ...
  CALL WGRIDPUTMENU(IDF_GRID1,11,(/'0','1','2','3','4'/),5,IOPTIONS,ISDMAXROW)
  CALL WGRIDPUTMENU(IDF_GRID1,12,(/'0','1','2','3','4'/),5,IOPTIONS,ISDMAXROW)
  DEALLOCATE(IOPTIONS)
  !## fill menu fields
 ENDIF
