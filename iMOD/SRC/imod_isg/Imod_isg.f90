...
! END SUBROUTINE ISGPROFILENAMES
 ...
 DX=(PROFXMAX-PROFXMIN)/200.0
 DY=(PROFYMAX-PROFYMIN)/50.0
! R =(PROFXMAX-PROFXMIN)/(PROFYMAX-PROFYMIN)
! DY= DY/R
 ...
 CALL IGRJOIN(PROFXMIN,YMIN,PROFXMAX,YMIN)
 
 CALL IGRCOLOURN(ICLR)
 
 DO I=1,SIZE(X)
  
  CALL ISGPLOTSHAPE(ISHAPE,X(I),YMIN,DX,DY)
...
!  IF(IISG.EQ.JJSG)EXIT
 ...
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: ITYPE,I,J,ID1,ID2,IM1,IM2,IY1,IY2,IAT,IOP,IDBG
 REAL :: X,Y
...
!  CALL WDIALOGPUTMENU(IDF_MENU4,(/'Q     ','Width ','Depth ','Factor'/),4,1)
 ...
 ELSEIF(ITAB.EQ.ID_DISGATTRIBUTESTAB5)THEN
  CALL WDIALOGPUTMENU(IDF_MENU4,(/'Date          ','UpWaterLevel  ','DownWaterLevel'/),3,1)
 !## isq
 ELSEIF(ITAB.EQ.ID_DISGATTRIBUTESTAB5)THEN
  CALL WDIALOGPUTMENU(IDF_MENU4,(/'Q     ','Width ','Depth ','Factor'/),4,1)
  CALL WDIALOGFIELDSTATE(IDF_CHECK1,0)
 ...
 CALL WDIALOGFIELDSTATE(IDF_INTEGER7 ,0)
 CALL WDIALOGFIELDSTATE(IDF_INTEGER8 ,0)
 CALL WDIALOGFIELDSTATE(IDF_INTEGER9 ,0)
 CALL WDIALOGFIELDSTATE(IDF_INTEGER10,0)
 CALL WDIALOGFIELDSTATE(IDF_INTEGER11,0)
 CALL WDIALOGFIELDSTATE(IDF_INTEGER12,0)
   ...
   CASE (PUSHBUTTON)
    SELECT CASE (MESSAGE%VALUE1)
     ...
     CASE (IDOK)
      ...
      IF(ITAB.EQ.ID_DISGATTRIBUTESTAB1)THEN
       IAT=IAT+2; IF(ISFR.EQ.1)IAT=IAT+1
      ENDIF
      ...
      DO
       I=I+1
       CALL WGRIDGETCELLREAL(IDF_GRID1,I,IAT,Y)
       !## nothing read
       ...
       SELECT CASE (IOP)
        ...
        CASE (5); Y=X
       END SELECT
       CALL WGRIDPUTCELLREAL(IDF_GRID1,I,IAT,Y)
      ENDDO
 ...
 DO
  ...
  SELECT CASE (ITYPE)
   ...
   CASE (MOUSEMOVE)
    ...
    CALL ISGPLOTSHAPE(ISHAPE,X5,Y5,D,D)
