...
USE MOD_UTL, ONLY : ITOS,INVERSECOLOUR,UTL_MESSAGEHANDLE,UTL_CAP,EQUALNAMES,UTL_FILLDATES,RTOS,UTL_IDFSNAPTOGRID,UTL_GETUNIT,&
             ...
             ICOL_VAR,VAR,IACT_VAR,CCNST,UTL_IDFGETCLASS,UTL_IDFCRDCOR,UTL_GETCURRENTDATE,UTL_GETCURRENTTIME
USE DATEVAR
...
! CALL IGRUNITS(REAL(XMIN)-DX,YMIN-DY,REAL(XMAX)+DX,YMAX+DY)
 ...
 XTITLE='Date'
 CALL ISGATTRIBUTESPLOT_AXES(REAL(XMIN),YMIN,REAL(XMAX),YMAX,.TRUE.,XTITLE,YTITLE)
