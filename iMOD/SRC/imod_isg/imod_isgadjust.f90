...
!    CALL ISGSAVE(ISGFILE,1) !- saving ONLY *.ISG, *.isp, *.isd
 ...
 INTEGER :: NSEG,IPOLSEG,I,J,ISELADJ,IU,JU,IOS,ICASE,NPOL,IPNT,NPNT,ISEG,MXXY,IWIN,IPOL
 ...
 JU=UTL_GETUNIT(); CALL OSD_OPEN(JU,FILE=SESFNAME,STATUS='OLD')
 !## skip isgname
 IF(IBATCH.EQ.0)THEN
 ...
 IF(ISELADJ.EQ.3)THEN
  IU=UTL_GETUNIT(); CALL OSD_OPEN(IU,FILE=SESFNAME,STATUS='OLD')
 ENDIF
