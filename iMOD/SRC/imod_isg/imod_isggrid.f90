...
!      CALL ISGMEMORYISC(1,ISELISG,IPOS)
 ...
 LOGICAL FUNCTION ISG2GRID(PPOSTFIX,NROW,NCOL,NLAY,ILAY,TOP,BOT,IBATCH, &
                           MP,JU,GRIDISG) !ISTEADY,SDATE,EDATE)
 !###====================================================================
 IMPLICIT NONE
...
!                                            TRIM(GRIDISG%ROOT)//'\'//TRIM(FNAME(12))//TRIM(PPOSTFIX)//'.IDF')    !## next_id
 ...
 !###====================================================================
 LOGICAL FUNCTION ISG2SFR(NROW,NCOL,NLAY,ILAY,TOP,BOT,IPER,MP,JU,GRIDISG)!ISTEADY)
 !###====================================================================
 IMPLICIT NONE
 ...
 IF(IPER.EQ.1)THEN
  ...
  DO I=1,NISG
   ...
   DO J=ISEG+1,JSEG
    ...
    !## intersect line with rectangular-regular-equidistantial-grid
    N=0; CALL INTERSECT_EQUI(GRIDISG%XMIN,GRIDISG%XMAX,GRIDISG%YMIN,GRIDISG%YMAX,GRIDISG%CS, &
