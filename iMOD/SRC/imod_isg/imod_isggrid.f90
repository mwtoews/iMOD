...
!      CALL ISGMEMORYISC(1,ISELISG,IPOS)
 ...
 DO
  ...
  IF(ISS.EQ.2.AND.EDATE.LT.SDATE)THEN
   ...
   ENDIF
  ENDIF
  ISG2GRIDMAIN=ISG2GRID(PPOSTFIX,NROW,NCOL,NLAY,TOP,BOT,IBATCH)
...
!      CALL IDFGETLOC(THIESSEN,TRAP(1,ITRAP)%IROW,TRAP(1,ITRAP)%ICOL,XC,YC)
 ...
 !###====================================================================
 LOGICAL FUNCTION ISG2GRID(PPOSTFIX,NROW,NCOL,NLAY,TOP,BOT,IBATCH)
 !###====================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: NROW,NCOL,NLAY,IBATCH 
 TYPE(IDFOBJ),DIMENSION(NLAY),INTENT(INOUT) :: TOP,BOT
...
!          ENDDO
 ...
 ELSEIF(IEXPORT.EQ.1)THEN
  CALL ISG2GRID_EXPORTRIVER(IDF,NLAY,TOP,BOT)
 ENDIF
 ...
 !###====================================================================
 SUBROUTINE ISG2GRID_EXPORTRIVER(IDF,NLAY,TOP,BOT)
 !###====================================================================
 IMPLICIT NONE
