...
CONTAINS
 ...
 !##=====================================================================
 SUBROUTINE ISG_ADDSTAGES(ISGFILE,IPFFILE,IBATCH,STAGETYPE)
 !##=====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: ISGFILE,IPFFILE
 INTEGER,INTENT(IN) :: IBATCH,STAGETYPE
 ...
 INTEGER :: IU,IOS,N,I,J,IISG,IPOS,ISEG,NSEG,ICRS,NCRS,IPNT,NPNT,IROW,ICOL,IP,ZCHK,CVAL,NI,IN,ICLC,IREF
 INTEGER(KIND=1) :: CF
...
!   DO I=1,N/2; WRITE(*,*) X(I),X(I+N/2); ENDDO
   ...
   CALL ISGSTUWEN_INTERSECT(MAXDIST,XCRD,YCRD,PISG,NI) !IISG,TDIST)
