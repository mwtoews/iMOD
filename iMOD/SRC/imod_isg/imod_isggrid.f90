...
USE MODPLOT
USE MOD_ISG_PAR
USE MOD_UTL, ONLY : ITOS,RTOS,IDATETOJDATE,JDATETOIDATE,UTL_GETUNIT,UTL_WAITMESSAGE,UTL_IDFSNAPTOGRID,UTL_GETMED,UTL_CREATEDIR,PEUCKER_SIMPLIFYLINE
...
CONTAINS
 ...
 INTEGER :: IPNT,NPNT,ICLC,NCLC,I,J,IPOS,ISEG,N,ID,NTXT,MTXT,IU,IREF
 REAL :: MD,D,DIST,TD,DX,INFF,BTML,RESIS
 ...
 DO ISELISG=1,NISG
  ...
  DO J=1,NCLC
   ...
   DO I=1,NTXT; READ(IU,*) CDATE,FTXT%STAGE(I); READ(CDATE,'(I8)') FTXT%IDATE(I); ENDDO
   CLOSE(IU)
...
!      CALL ISGMEMORYISC(1,ISELISG,IPOS)
 ...
 DO
  ...
  IF(IBATCH.EQ.1)WRITE(*,*) SDATE,EDATE,TRIM(PPOSTFIX)
