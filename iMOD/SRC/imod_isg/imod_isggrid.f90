...
CONTAINS
 ...
 INTEGER :: IPNT,NPNT,ICLC,NCLC,I,J,IPOS,ISEG,N
...
!    N=1
!    DATISD(ISEG+N-1)%IDATE=20140101
!    DATISD(ISEG+N-1)%WLVL =10.0
!    DATISD(ISEG+N-1)%BTML = 0.0
!    DATISD(ISEG+N-1)%RESIS= 0.3
!    DATISD(ISEG+N-1)%INFF = 1.0
