...
USE MOD_QKSORT, ONLY : SHELLSORT_INT,UTL_QKSORT_INT2
...
CONTAINS
 ...
 REAL,ALLOCATABLE,DIMENSION(:) :: FSTAGE,FNODATA
 ...
 DO ISELISG=1,NISG
  ...
  DO J=1,NCLC
   ...
   !## sort date - 
!   CALL SHELLSORT_INT(K,IDATE) !N,A)
!   CALL WSORT(FIDATE,1,K,IORDER=ISORT)
   DO I=1,K; ISORT(I)=I; ENDDO
   CALL UTL_QKSORT_INT2(FIDATE,ISORT,K,K)
