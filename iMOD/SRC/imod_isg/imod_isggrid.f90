...
! TYPE(IDFOBJ),DIMENSION(NLAY),INTENT(INOUT) :: TOP,BOT
 ...
 !###====================================================================
 SUBROUTINE ISG2GRID_EXPORTRIVER(JU,IDF,NLAY,ILAY,TOP,BOT,KHV,BND,VCW,MP,GRIDISG,SFT,LSFT)
 !###====================================================================
 IMPLICIT NONE
 TYPE(GRIDISGOBJ),INTENT(INOUT) :: GRIDISG
 ...
 REAL :: T,WL,BL,CD,F,TL,WP,LC,C1,C0,DXY,D,K
