...
CONTAINS
 ...
 !###====================================================================
 LOGICAL FUNCTION ISG2GRIDMAIN(ISGFILE,IBATCH,NLAY,TOP,BOT,KHV,GRIDISG)
 !###====================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IBATCH,NLAY 
 TYPE(GRIDISGOBJ),INTENT(INOUT) :: GRIDISG
 CHARACTER(LEN=*),INTENT(IN) :: ISGFILE
 TYPE(IDFOBJ),DIMENSION(NLAY),INTENT(INOUT) :: TOP,BOT,KHV
 ...
 DO
  ...
  IF(GRIDISG%ISTEADY.EQ.2.AND.GRIDISG%EDATE.LT.GRIDISG%SDATE)THEN
   ...
   ENDIF
  ENDIF
  ISG2GRIDMAIN=ISG2GRID(PPOSTFIX,NROW,NCOL,NLAY,0,TOP,BOT,KHV,IBATCH,MP,0,GRIDISG) 
 ...
 !###====================================================================
 LOGICAL FUNCTION ISG2GRID(PPOSTFIX,NROW,NCOL,NLAY,ILAY,TOP,BOT,KHV,IBATCH, &
                           MP,JU,GRIDISG) 
 !###====================================================================
 IMPLICIT NONE
...
! IF(.NOT.IDFWRITE(IDF(9),TRIM(GRIDISG%ROOT)//'\'//TRIM(FNAME(9))//TRIM(PPOSTFIX)//'.IDF',1))THEN; endif
 ...
 ELSEIF(GRIDISG%IEXPORT.EQ.1)THEN
  CALL ISG2GRID_EXPORTRIVER(JU,IDF,NLAY,ILAY,TOP,BOT,KHV,MP,GRIDISG)
 ENDIF
 ...
 !###====================================================================
 SUBROUTINE ISG2GRID_EXPORTRIVER(JU,IDF,NLAY,ILAY,TOP,BOT,KHV,MP,GRIDISG)
 !###====================================================================
 IMPLICIT NONE
 TYPE(GRIDISGOBJ),INTENT(INOUT) :: GRIDISG
