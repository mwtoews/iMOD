...
!    enddo
 ...
 INTEGER :: ISEG,JSEG,NSEG,IREF,MAXDIM,NDIM,NSYM,NTRAP,ITRAP,JQHR,NITEMS,LU,IOS,ICRS,NCRS,IUSIMGRO,NDMM
         ...
         IF(C.GT.0.0D0)THEN
          ...
          IF(PBMAN%DMMFILE.EQ.1)THEN
           ...
           ELSE
            ...
            WRITE(IUDMM(2),'(I10,3F15.3)') MP(1),X(I2),Y(I2),W      ; NDMM=NDMM+1
           ENDIF           
