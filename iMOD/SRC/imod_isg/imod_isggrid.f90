...
!    enddo
 ...
 IF(PBMAN%DMMFILE.EQ.1)THEN
  IUDMM(1)=UTL_GETUNIT()
  CALL OSD_OPEN(IUDMM(1),FILE=TRIM(GRIDISG%ROOT)//'\MFRIVTODFM1D_Q.DMM',STATUS='UNKNOWN', &
                FORM='FORMATTED',ACTION='WRITE,DENYREAD',ACCESS='SEQUENTIAL')
  WRITE(IUDMM(1),'(3A15)') 'FM-X','FM-Y','RIV'
  IUDMM(2)=UTL_GETUNIT(); NDMM=0
  CALL OSD_OPEN(IUDMM(2),FILE=TRIM(GRIDISG%ROOT)//'\DFM1DWATLEVTOMFRIV_H.DMM',STATUS='UNKNOWN', &
                FORM='FORMATTED',ACTION='WRITE,DENYREAD',ACCESS='SEQUENTIAL')
  WRITE(IUDMM(2),'(4A15)') 'RIV','FM-X','FM-Y','WEIGHT'
  IUDMM(3)=UTL_GETUNIT(); NDMM=0
  CALL OSD_OPEN(IUDMM(3),FILE=TRIM(GRIDISG%ROOT)//'\DFLOWFM_POINTS.DAT',STATUS='UNKNOWN', &
                FORM='FORMATTED',ACTION='WRITE,DENYREAD',ACCESS='SEQUENTIAL')
