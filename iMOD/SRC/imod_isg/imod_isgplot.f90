...
!       ENDIF
 ...
 !###====================================================================
 SUBROUTINE ISGPLOT_LEGENDLINES()
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: I,J,K,IREC,JREC,IISG,MAXNSEG,TTIME,ISEG,JSEG,NSEG,NDIM
 LOGICAL :: LEX
 REAL :: X1,Y1,X2,Y2
