...
!!##
 ...
 ISFR=1; CALL ISGGEN_CREATEISG(ISGFILE,VAR)
...
ISFR=0; CALL ISGGEN_CREATEISG(OUTFILE,VAR)
...
INTEGER,INTENT(IN) :: IB
CHARACTER(LEN=*),POINTER,DIMENSION(:,:),INTENT(IN) :: VAR
REAL(KIND=DP_KIND) :: WL,WB,RS,FC,XDIST,XSAMPLE,FCT,D,DSAMPLE
...
END SUBROUTINE ISGGEN_CREATEISD1
 ...
 REAL(KIND=DP_KIND),INTENT(IN) :: DIST
 INTEGER,INTENT(IN) :: IB
 REAL(KIND=DP_KIND) :: WLVL,BTML,WD,THCK,HCND,QFLW,QROF,PPTSW,ETSW
