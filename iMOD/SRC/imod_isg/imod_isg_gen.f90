...
USE MOD_UTL, ONLY : UTL_GETUNIT,ITOS,UTL_CREATEDIR,UTL_GENLABELSREAD,UTL_GENLABELSGET,NV,NL,UTL_CAP,UTL_DIST, &
              UTL_DIRINFO_POINTER
...
!!##
 ...
 ISFR=1; CALL ISGGEN_CREATEISG(ISGFILE,2,VAR)
...
ELSE
 ...
 CALL UTL_GENLABELSREAD(GENFNAME(:INDEX(GENFNAME,'.',.TRUE.)-1)//'.DAT',VAR)
...
ISFR=0; CALL ISGGEN_CREATEISG(OUTFILE,1,VAR)
...
!##=====================================================================
SUBROUTINE ISGGEN_CREATEISG(OUTFILE,ISOURCE,VAR)
!##=====================================================================
IMPLICIT NONE
...
DO IB=1,NBRCH
 ...
 IF(ISFR.EQ.0)THEN
  CALL ISGGEN_CREATEISD1(ICLC,NCLC,IREFSD,DIST,IB,VAR)
 ...
 ELSEIF(ISFR.EQ.1)THEN
  ...
  CALL ISGGEN_CREATEISQ1(IQHR,NQHR,IREFQH,DIST,IB,IB)
 ENDIF 
...
WRITE(*,'(A,2I10)') TRIM(FNAME(ISQ1))//' ',IQHR,IREFQH
...
!##=====================================================================
SUBROUTINE ISGGEN_CREATEISD1(ICLC,NCLC,IREFSD,DIST,IB,VAR)
!##=====================================================================
IMPLICIT NONE
...
END SUBROUTINE ISGGEN_CREATEISD1
 ...
 !##=====================================================================
 SUBROUTINE ISGGEN_CREATEISQ1(IQHR,NQHR,IREFQH,DIST,IB,IPROF)
 !##=====================================================================
 IMPLICIT NONE
 ...
 WRITE(IU(ISQ1),REC=IQHR+ICF) 3,IREFQH+1,DIST/2.0,CNAME 
