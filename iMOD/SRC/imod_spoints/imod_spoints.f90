...
CONTAINS
 ...
 SELECT CASE(ITYPE)
  ...
  CASE (TABCHANGED)
   SELECT CASE (MESSAGE%VALUE2)
    CASE (ID_DSPTAB1)
     ITAB=1
     IF(.NOT.STARTP1FIELDS_GETTAB2(IQUIT,ITAB))THEN
      !## stay on the same tab! not anymore with the ITABCLOSE flag, only when one clicks on the "Draw" button
 ...
 !###======================================================================
 LOGICAL FUNCTION STARTP1FIELDS_GETTAB2(IQUIT,ITABCLOSE)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(OUT) :: IQUIT
 INTEGER,INTENT(IN) :: ITABCLOSE
 
 STARTP1FIELDS_GETTAB2=.FALSE.
 IQUIT=0
 
 IF(ITABCLOSE.EQ.0)THEN
 ...
 CALL WDIALOGSPINNERSTEP(IDF_REAL1,1.0,10.0)
 CALL WDIALOGSPINNERSTEP(IDF_REAL3,1.0,10.0)
