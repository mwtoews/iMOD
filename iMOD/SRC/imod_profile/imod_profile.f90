...
USE MOD_SOLID_PROFILE, ONLY : SOLID_PROFILEDRAW,SOLID_PROFILEMOUSE,SOLID_PROFILEADJUST,SOLID_PROFILEDELETE,SOLID_PROFILEFITDRILL, &
     ...
     SOLIDPLOTLOCATIONCROSSSECTIONS,ILOCK,ISSNAP,IFIND,SOLID_PROFILEFIT,SOLID_PROFILEDRAW_POLYGON,SOLID_PROFILEDRAW_MASK, &
...
CONTAINS
 ...
 IF(ISOLID.EQ.1)CALL SOLID_PROFILEUPDATECROSS(0)
...
!     IF(IEXIT.EQ.1)EXIT
  ...
  CASE(FIELDCHANGED)
   SELECT CASE (MESSAGE%VALUE2)
    ...
    CASE (IDF_CHECK4)
     ...
     CALL PROFILE_PLOT()
    CASE (IDF_MENU1)
     ISOLID=1; CALL SOLID_PROFILEUPDATECROSS(1)    
   END SELECT
  ...
  CASE(PUSHBUTTON)
   SELECT CASE (MESSAGE%VALUE1)
    CASE (ID_NEW)
     ...
     CALL SOLID_PROFILEUPDATECROSS(1)
    CASE (ID_DELETE)
 ...
 !###======================================================================
 SUBROUTINE SOLID_PROFILEUPDATECROSS(IMODE)
 !###======================================================================
 IMPLICIT NONE
