...
CONTAINS
 ...
 ILEG=1; CALL IPFGETVALUE_PLOTCOLOURS(ID_DSERIESPROPTAB6,ILEG)
...
!   CALL IGRCOLOURN(WRGB(0,0,0))
 ...
 ALLOCATE(XTMP(MXNIDF+NIPF+MXNIFF))
 ...
 DO I=1,MXNIDF
  ...
  ENDIF
 ENDDO
 DO I=1,NIPF;   J=J+1; XTMP(J)=REAL(MP(MPLOT(I))%ISCREEN); ENDDO
 DO I=1,MXNIFF; J=J+1; XTMP(J)=REAL(MP(KPLOT(I))%ISCREEN); ENDDO

 CALL UTL_GETUNIQUE(XTMP,MXNIDF+NIPF+MXNIFF,NSCREEN,NODATA=-1.0)
 
 !## recompute igraphs
 DO I=1,MXNIDF; DO J=1,NSCREEN
   IF(PROFIDF(I)%ISCREEN.EQ.INT(XTMP(J)))THEN; PROFIDF(I)%ISCREEN=J; EXIT; ENDIF
 ENDDO; ENDDO
 DO I=1,NIPF; DO J=1,NSCREEN
   IF(MP(MPLOT(I))%ISCREEN.EQ.INT(XTMP(J)))THEN; MP(MPLOT(I))%ISCREEN=J; EXIT; ENDIF
 ENDDO; ENDDO
 DO I=1,MXNIFF; DO J=1,NSCREEN
   IF(MP(KPLOT(I))%ISCREEN.EQ.INT(XTMP(J)))THEN; MP(KPLOT(I))%ISCREEN=J; EXIT; ENDIF
 ENDDO; ENDDO
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: I,J,K,ITAB,IROW,ICOL,IRGB,IFIX,ICONFIG,ICLR,ILEG
 LOGICAL :: LEX
...
!###======================================================================
 ...
 IMPLICIT NONE
 INTEGER,INTENT(OUT) :: IEXIT
 INTEGER :: IU,IOS,I,J,IACT,IFIXX,IFIXY,IPN,IFL,ILN,ICL,IIPF,I1T,ILG,ICLR,ILEG
 REAL :: XINT,YINT
