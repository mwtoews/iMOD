...
!   CALL IGRCOLOURN(WRGB(0,0,0))
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: IEXIT,IFIXX,IFIXY,IIPF
 REAL :: BMPX1,BMPX2,BMPY1,BMPY2
...
!  IF(ISOLID.EQ.1)CALL WGRIDSTATECELL(IDF_GRID1,2,I+1,0)
 ...
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: I,J,K,IROW,ICOL,IRGB,IFIX,ICONFIG,ICLR,ILEG,IIPF
 LOGICAL :: LEX
...
!   IF(ISOLID.EQ.0)CALL WGRIDSTATECELL(IDF_GRID1,2,IROW,1)
 ...
 IMPLICIT NONE
 INTEGER,INTENT(OUT) :: IEXIT
 INTEGER :: IU,IOS,I,IACT,IFIXX,IFIXY,IPN,IFL,ILN,ICL,IIPF,I1T,ILG,ILEG
 REAL :: XINT,YINT
 ...
 IF(PROFIDF(IIDF)%IDF%IEQ.EQ.0)THEN
  ...
  CALL INTERSECT_EQUI(PROFIDF(IIDF)%IDF%XMIN,PROFIDF(IIDF)%IDF%XMAX,PROFIDF(IIDF)%IDF%YMIN, &
                      PROFIDF(IIDF)%IDF%YMAX,PROFIDF(IIDF)%IDF%DX,X1ISG,X2ISG,Y1ISG,Y2ISG,N,.FALSE.)
 ELSE
  ...
  CALL INTERSECT_NONEQUI(PROFIDF(IIDF)%IDF%SX,PROFIDF(IIDF)%IDF%SY,PROFIDF(IIDF)%IDF%NROW, &
                      PROFIDF(IIDF)%IDF%NCOL,X1ISG,X2ISG,Y1ISG,Y2ISG,N,.FALSE.)
 ENDIF
 ...
 CALL WMESSAGETIMER(60*1000,1,IREPEAT=1)  !1.0 minute, autosave
 CALL WMESSAGETIMER(30*1000,2,IREPEAT=1)  !0.5 minute, plugin
