...
USE MOD_SOLID_PROFILE, ONLY : SOLIDPROFILEDRAW,SOLIDPROFILEMOUSE,SOLIDPROFILEADJUST,SOLIDPROFILEDELETE,SOLIDPROFILEFITDRILL, &
...
CONTAINS
 ...
 DO I=1,NSCREEN
  ...
  CALL WMENUSETSTATE(ID_BITMAP,2,PBITMAP%IACT)
 ENDDO
  ...
  CASE(FIELDCHANGED)
   SELECT CASE (MESSAGE%VALUE2)
    ...
    CASE (IDF_CHECK4)
     ...
     CALL PROFILE_PLOT()
    CASE (IDF_MENU1)
     ISOLID=1; CALL SOLIDPROFILEUPDATECROSS(1)    
   END SELECT
  ...
  CASE(PUSHBUTTON)
   SELECT CASE (MESSAGE%VALUE1)
    CASE (ID_NEW)
     ...
     ISOLID=1; CALL SOLIDPROFILEFIT(1)
 ...
 !###======================================================================
 SUBROUTINE SOLIDPROFILEUPDATECROSS(IMODE)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IMODE
 INTEGER :: I,IACT
 REAL :: BMPX1,BMPY1,BMPX2,BMPY2
 ...
 SELECT CASE (MESSAGE%WIN)
  ...
  CASE (ID_DSERIES)
   SELECT CASE (MESSAGE%VALUE1)
    ...
    !## zoom
    CASE (ID_ZOOMINMAP,ID_ZOOMOUTMAP,ID_ZOOMFULLMAP)
     CALL IDFZOOM(MESSAGE%VALUE1,(MPW%XMAX+MPW%XMIN)/2.0,(MPW%YMAX+MPW%YMIN)/2.0,ID_DSERIES) 
     CALL PROFILE_REPLOT2D()
...
!###======================================================================
 ...
 IF(PBITMAP%IACT.EQ.0)THEN
  ...
  PBITMAP%IACT=1; CALL PROFILE_BACKGROUND_OPENBITMAP()
 ELSE
  CALL WBITMAPDESTROY(PBITMAP%IBITMAP)
  CALL WMENUSETSTATE(ID_BITMAP,2,0); PBITMAP%IACT=0
 ENDIF
 CALL PROFILE_PLOT()
...
!###======================================================================
 ...
 IF(PBITMAP%IACT.EQ.1)CALL WBITMAPDESTROY(PBITMAP%IBITMAP); PBITMAP%IACT=0
