...
CONTAINS
 ...
 IF(LINI)THEN
  AXES%XMIN= HUGE(1.0) !10.0E10
  AXES%XMAX=-HUGE(1.0) !10.0E10
  DO I=1,SIZE(GRAPH,1)
   NP=GRAPH(I,NG)%NP
  ...
  ENDIF
  AXES%YMIN= HUGE(1.0) !10.0E10
  AXES%YMAX=-HUGE(1.0) !10.0E10
  DO I=1,SIZE(GRAPH,1)
   NP=GRAPH(I,NG)%NP
  ...
  DO
   ...
   DO
    ...
    IF(Y.GT.AXES%Y2MIN)THEN
     ...
     DY=DY+1.2*WGRTEXTLENGTH(TRIM(CDATE))*WINFOGRREAL(GRAPHICSCHHEIGHT)
    ENDIF
   END DO
