...
! WRITE(*,*) UTL_INSIDEELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/10.0, 0.0,192000.0,364000.0)
! WRITE(*,*) UTL_INSIDEELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/20.0, 0.0,195488.0,363914.0)
! WRITE(*,*) UTL_INSIDEELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/20.0,45.0,191028.0,365509.0)
