...
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_MESSAGEHANDLE,UTL_IDFCRDCOR,UTL_FILLARRAY,IDFPLOT1BITMAP,IDFPLOT2BITMAP,UTL_DRAWELLIPSE
...
! CALL IGRUNITS(MPW%XMIN,MPW%YMIN,MPW%XMAX,MPW%YMAX)
 ...
 CALL UTL_DRAWELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/10.0,0.0)
 CALL UTL_DRAWELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/20.0,0.0)
 CALL UTL_DRAWELLIPSE((MPW%XMIN+MPW%XMAX)/2.0,(MPW%YMIN+MPW%YMAX)/2.0,(MPW%XMAX-MPW%XMIN)/10.0,(MPW%XMAX-MPW%XMIN)/20.0,45.0)

! call IGrEllipse((MPW%XMIN+MPW%XMax)/2.0,(MPW%yMIN+MPW%yMax)/2.0,(MPW%XMax-MPW%XMin)/10.0,1.0)
! call IGrUnitsRotate(30)
! call IGrEllipse((MPW%XMIN+MPW%XMax)/2.0,(MPW%yMIN+MPW%yMax)/2.0,(MPW%XMax-MPW%XMin)/10.0,2.0)
! call IGrUnitsRotate(45)
! call IGrEllipse((MPW%XMIN+MPW%XMax)/2.0,(MPW%yMIN+MPW%yMax)/2.0,(MPW%XMax-MPW%XMin)/10.0,0.5)
! call IGrUnitsRotate(0)
