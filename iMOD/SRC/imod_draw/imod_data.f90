...
DO I=0,LEG%NCLR
 CALL IGRLINEWIDTH(MAX(1,ABS(THICKNESS/2)))
 IF(MOD(I,5).EQ.0)CALL IGRLINEWIDTH(MAX(ABS(THICKNESS/2)-1,1))
 IF(IP(1).EQ.0)THEN
...
IF(THICKNESS.GT.0)THEN
 CALL UTL_SETTEXTSIZE(TWIDTH,THEIGHT,FCT=DBLE(THICKNESS))
