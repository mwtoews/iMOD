...
DO I=0,LEG%NCLR
 ...
 CALL IDFPLOT_COMPCONTOUR2(IDF%X,IDF%NCOL,IDF%NROW,XC,YC,LEG%CLASS(I),IDF%NODATA)
...
!###======================================================================
SUBROUTINE IDFPLOT_COMPCONTOUR2(XVAL,NCOL,NROW,XC,YC,V,XNODATA)
!###======================================================================
...
REAL :: X1,X2,X3,X4,Y1,Y2,Y3,Y4,XMIN,YMIN,XMAX,YMAX,DX,DY,DA,DV
REAL,DIMENSION(4) :: A
...
!    ENDIF
  ...
  !## add label
  IF(II.GT.1)CALL IDFPLOT_PUTLABEL(XS(1),YS(1),XS(2),YS(2),V,INILAB,XMIN,YMIN,XMAX,YMAX)
