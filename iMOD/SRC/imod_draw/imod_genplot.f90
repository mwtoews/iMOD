...
USE MOD_UTL, ONLY : UTL_WAITMESSAGE,UTL_MESSAGEHANDLE,UTL_GETUNIT,ITOS,UTL_GETRELEVANTDIR,UTL_FILLARRAY,UTL_IDFGETCLASS,UTL_SETTEXTSIZE,&
  UTL_READARRAY,UTL_WSELECTFILE,RTOS,UTL_INSIDEPOLYGON,NV,NL,IVAR,VAR_TMP,IV,DVAR,MAXLEN,UTL_GENLABELSREAD,UTL_GENLABELSGET,UTL_GENLABELSDEALLOCATE, &
  UTL_GENLABELSWRITE
...
DOLOOP: DO
 ...
 CHARACTER(LEN=52),POINTER,DIMENSION(:,:),INTENT(IN),OPTIONAL :: VARS
 CHARACTER(LEN=52),POINTER,DIMENSION(:,:) :: VAR
