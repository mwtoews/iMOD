...
USE MOD_UTL, ONLY : UTL_WAITMESSAGE,UTL_MESSAGEHANDLE,UTL_GETUNIT,ITOS,UTL_GETRELEVANTDIR,UTL_FILLARRAY,UTL_IDFGETCLASS,UTL_SETTEXTSIZE,&
  ...
  UTL_GENLABELSWRITE !,NV,NL,IVAR,VAR,VAR_TMP,IV,DVAR
...
!INTEGER,PRIVATE :: NL,NV
!CHARACTER(LEN=MAXLEN),POINTER,DIMENSION(:,:),PRIVATE :: VAR
!CHARACTER(LEN=MAXLEN),POINTER,DIMENSION(:),PRIVATE :: CCNST
...
!    CALL GENLABELSPLOT(JL,N,IPLOT,TWIDTH,THEIGHT) 
 ...
 IF(ASSOCIATED(VAR))DEALLOCATE(VAR) !CALL UTL_GENLABELSDEALLOCATE()
