...
USE MOD_UTL, ONLY : UTL_WAITMESSAGE,UTL_MESSAGEHANDLE,UTL_GETUNIT,ITOS,UTL_GETRELEVANTDIR,UTL_FILLARRAY,UTL_IDFGETCLASS,UTL_SETTEXTSIZE,&
  UTL_READARRAY,UTL_WSELECTFILE,RTOS,UTL_INSIDEPOLYGON,IV,MAXLENVAR,UTL_GENLABELSREAD,UTL_GENLABELSGET,UTL_GENLABELSDEALLOCATE, &
  UTL_GENLABELSWRITE
...
!    CALL GENLABELSPLOT(JL,N,IPLOT,TWIDTH,THEIGHT) 
  ...
  ELSE
   ...
   IF(LEX)THEN
    ...
    !## put labels if jl.ne.0
    CALL IGRCOLOURN(WRGB(0,0,0)); CALL IGRFILLPATTERN(OUTLINE); CALL IGRLINETYPE(SOLIDLINE); CALL IGRLINEWIDTH(1)
    CALL GENLABELSPLOT(JL,N,IPLOT,TWIDTH,THEIGHT,VAR) 
   ENDIF
 ...
 !###======================================================================
 SUBROUTINE GENLABELSPLOT(JL,N,IPLOT,TWIDTH,THEIGHT,VAR)
 !###======================================================================
 IMPLICIT NONE
...
DOLOOP: DO
 ...
 CHARACTER(LEN=MAXLENVAR) :: LABELNAME
 CHARACTER(LEN=*),POINTER,DIMENSION(:,:),INTENT(IN),OPTIONAL :: VARS
 CHARACTER(LEN=MAXLENVAR),POINTER,DIMENSION(:,:) :: DVAR,VAR_TMP
