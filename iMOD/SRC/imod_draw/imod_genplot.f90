...
! USE gdal 
 ...
 IF(IOS.NE.0)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not read '//CHAR(13)//TRIM(FNAME),'Error')
  GOTO 10
 ENDIF
 ...
 IF(IOS.NE.0)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not open '//CHAR(13)//FNAME(:INDEX(FNAME,'.',.TRUE.)-1)//'.gen','Error')
  GOTO 10
 ENDIF
 IF(IU(2).GT.0)THEN
  ...
  IF(IOS.NE.0)THEN
   CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not open '//CHAR(13)//FNAME(:INDEX(FNAME,'.',.TRUE.)-1)//'.dat','Error')
   GOTO 10
  ENDIF
 ENDIF
 ...
 IF(IOS.NE.0)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not open '//CHAR(13)//FNAME(:INDEX(FNAME,'.',.TRUE.)-1)//'.ipf','Error')
  GOTO 10
 ENDIF
 ...
 IF(IU(2).GT.0)THEN
  ...
  IF(IOS.NE.0)THEN
   CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not allocate memory for reading dbf file.','Error')
   GOTO 10
  ENDIF
...
!  IF(IOS.NE.0)THEN
!   CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not allocate memory for reading column width from file.','Error')
!   GOTO 10
!  ENDIF
