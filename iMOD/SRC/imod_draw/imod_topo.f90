...
! CALL WBITMAPSTRETCHMODE(STRETCHHALFTONE)
 ...
 !###======================================================================
 SUBROUTINE TOPO1DRAW() !IWIN,WINXMIN,WINYMIN,WINXMAX,WINYMAX)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,PARAMETER :: SSIZE=2000 !## bmp scale size
! REAL(KIND=DP_KIND),INTENT(IN) :: WINXMIN,WINYMIN,WINXMAX,WINYMAX
! INTEGER,INTENT(IN) :: IWIN
 ...
 CALL WINDOWSELECT(0); IF(WMENUGETSTATE(ID_TOPTRANSPARACY,2).EQ.1)CALL WBITMAPPLOTMODE(MODEAND)
 ...
 CALL WINDOWSELECT(0); IF(WMENUGETSTATE(ID_TOPTRANSPARACY,2).EQ.1)CALL WBITMAPPLOTMODE(MODECOPY)
 ...
 !###======================================================================
 SUBROUTINE TOPO1BMPTONE(IHANDLE)
 !###======================================================================
 IMPLICIT NONE
