...
CONTAINS
 ...
 SUBROUTINE KRIGING_MAIN(MD,XD,YD,ZD,IDF,IDFV,MINP,RANGE,SILL,NUGGET,KTYPE, &
               PNTSEARCH,IEXPVARIOGRAM,LAGINTERVAL,LAGDISTANCE,IADJRANGE,IQUADRANT,IBATCH,GENFNAME)     
 !###======================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF,IDFV
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER,INTENT(IN) :: MD,KTYPE,PNTSEARCH,IEXPVARIOGRAM,LAGINTERVAL,IADJRANGE,IQUADRANT
 ...
 INTEGER :: MINP,KTYPE,IROW,ICOL,I,PNTSEARCH,ND,NR,NC,MX,IEXPVARIOGRAM,LAGINTERVAL,IADJRANGE,IQUADRANT
 ...
 IEXPVARIOGRAM=1; LAGINTERVAL=20; LAGDISTANCE=RANGE/REAL(LAGINTERVAL); IADJRANGE=0; IQUADRANT=0
 MX=RANGE/IDF%DX
