...
CONTAINS
 ...
 SUBROUTINE KRIGING_MAIN(MD,XD,YD,ZD,IDF,IDFV,MINP,MAXP,RANGE,SILL,NUGGET,KTYPE, &
               SEARCHDISTANCE,NOSEARCH,IEXPVARIOGRAM,LAGINTERVAL,LAGDISTANCE,IBATCH)     
 !###======================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF,IDFV
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER,INTENT(IN) :: MD,KTYPE,NOSEARCH,IEXPVARIOGRAM,LAGINTERVAL
...
! CLOSE(10)
 ...
 !###====================================================================
 SUBROUTINE KRIGINGSETTINGS(MINP,MAXP,KTYPE,RANGE,SILL,NUGGET,SEARCHDISTANCE,NOSEARCH)
 !###====================================================================
 IMPLICIT NONE
 REAL,INTENT(INOUT) :: RANGE,SILL,NUGGET,SEARCHDISTANCE
 INTEGER,INTENT(INOUT) :: MINP,MAXP,KTYPE,NOSEARCH
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: ITYPE,I
