...
!   WRITE(*,*) 'Asigned for #COLUMNVOID='//TRIM(ITOS(I))//',-999.99'
 ...
 ALLOCATE(GEFEX(5,NROW)) !##Allocate GEF-variable for character valued part IPF-file
 ...
 DO IROW=1,NROW
  ...
  IF(IOS.NE.0)THEN
   ...
   RETURN
  ENDIF
  GEFEX(:,IROW)=GEF2(NCOL+1:NCOLLINE(IROW),IROW)  
  DEALLOCATE(GEF2)
 END DO

 DO I=NCOL+1,MAXVAL(NCOLLINE)
  IF(I.EQ.NCOL+1)THEN
   ATTRIB1(I)='[]'; ATTRIB2(I)='Lithography'
  ELSE
