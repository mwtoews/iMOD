...
CONTAINS
   ...
   CASE (PUSHBUTTON)
    SELECT CASE (MESSAGE%VALUE1)
     ...
     CASE (IDOK)
      ...
      IF(I.EQ.1)CALL GEF2IPF_GEFORG(IBATCH)
      IF(I.EQ.2)CALL GEF2IPF_GEFDINO(IBATCH)
      EXIT
     CASE (IDHELP)
    END SELECT
  END SELECT
 ...
 !###======================================================================
 SUBROUTINE GEF2IPF_GEFORG(IBATCH)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IBATCH
 ...
 END SUBROUTINE GEF2IPF_GEFORG

 !###======================================================================
 SUBROUTINE GEF2IPF_GEFDINO(IBATCH)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER :: I,ICOL,IROW,KU,IDIR,JCOL
 CHARACTER(LEN=256) :: LINE,IPFDIR
 INTEGER,PARAMETER :: NCOLIPF=9
 ...
 END SUBROUTINE GEF2IPF_GEFDINO
