      ...
      !## put in max/min values
       ...
       CASE (IDF_INTEGER1,IDF_INTEGER2,IDF_INTEGER3,IDF_INTEGER4,IDF_INTEGER5,IDF_INTEGER6,IDF_INTEGER7)
        ...
        IF(WINFODIALOG(4).EQ.1)THEN
         ...
         CALL LEG_GET(IPLOT); CALL LEG_CREATE_COLORS(IPLOT); CALL LEG_PLOT(IPLOT)
        ENDIF
      END SELECT
...
!  ENDDO
 ...
 IF(MP(IPLOT)%LEG%NCLR.LE.MXCLASS)THEN
  CALL LEG_PLOT_CLASSES_LEGEND(IPLOT)
 ELSE
 ...
 !###====================================================================
 SUBROUTINE LEG_PLOT_CLASSES_LEGEND(IPLOT)
 !###====================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IPLOT
 INTEGER :: I,IRGB
...
!  CALL WDIALOGGETCHECKBOX(IDF_CHECK8,I)
 ...
 DO I=1,MXCGRAD
  ...
  XVAL=MP(IPLOT)%LEG%CLASS(IPOS(I))
 ...
 IF(IOPTION.EQ.0)THEN
  ...
  IF(LTYPE.EQ.1)THEN
   ...
   IF(V1-V2.NE.0.0)THEN
    ...
    !## number of classes
    M=NSX; DI=SXVALUE(2)-SXVALUE(1); V1=SXVALUE(1); V2=SXVALUE(NSX)
    !## check i
    IF(M.GT.N)THEN
