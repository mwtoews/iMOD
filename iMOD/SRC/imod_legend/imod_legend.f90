      ...
      SELECT CASE (MESSAGE%VALUE2)
       CASE (ID_GRIDLEVELS)
        ...
        IF(ICOL.EQ.3)THEN
         ...
         ENDIF
        ENDIF
        CALL LEG_CREATE_COLORS(IPLOT); CALL LEG_PLOT(IPLOT)
...
!         CALL LEG_PLOT_STRETCHED_LEGEND(IPLOT)
 ...
 J=1; IF(I.EQ.1)J=3 
 DO I=2,6; CALL WDIALOGFIELDSTATE(ID1(I),J); END DO
 DO I=2,6; CALL WDIALOGFIELDSTATE(ID3(I),J); END DO
...
!  ENDDO
 ...
 !###====================================================================
 SUBROUTINE LEG_PLOT_CLASSES_LEGEND()
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: NCLR,I,IRGB
 REAL :: X1,X2
...
!  ENDIF
 ...
 I=1; IF(NCLR.GE.MXCLASS)I=0; CALL WDIALOGFIELDSTATE(ID_PLUS,I)
 I=1; IF(NCLR.LE.1)I=0;       CALL WDIALOGFIELDSTATE(ID_MIN,I)
...
!  CALL WDIALOGGETCHECKBOX(IDF_CHECK8,I)
 ...
 !###====================================================================
 SUBROUTINE LEG_GETSTRETCHED(IPLOT)
 !###====================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IPLOT
 INTEGER :: I,J,N,ICLR
...
! CALL LEG_PUT_STRETCHED_LEGEND(IPLOT)
 
 END SUBROUTINE LEG_GETSTRETCHED
...
!    CALL WSORT(IDFVAL,1,NUNIQUE,1)
 ...
 DO I=2,MXCGRAD
  ...
  DO J=CLRGIVEN(I1),CLRGIVEN(I)
   IRED=  PCLR(I1,1)+INT(INTCLR(1)*K)
   IGREEN=PCLR(I1,2)+INT(INTCLR(2)*K)
   IBLUE= PCLR(I1,3)+INT(INTCLR(3)*K)
