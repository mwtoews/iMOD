...
!  CALL WDIALOGGETCHECKBOX(IDF_CHECK8,I)
 ...
 ELSE
  ...
  DO I=1,MXCGRAD
   ...
   ELSE
    DC=(MP(IPLOT)%LEG%CLASS(CLRGIVEN(I))-MP(IPLOT)%LEG%CLASS(CLRGIVEN(I1)))
    DR=(CLRGIVEN(I)-CLRGIVEN(I1))
    DC= DC/DR
 ...
 N=MP(IPLOT)%LEG%NCLR
 N=N/7; J=1; DO I=1,MXCGRAD; IPOS(I)=J; J=J+N; ENDDO; IPOS(MXCGRAD)=MP(IPLOT)%LEG%NCLR
 ...
 DO I=1,MXCGRAD
  ...
  CALL WDIALOGPUTREAL(ID1(I),XVAL)
