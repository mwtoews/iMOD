...
CONTAINS
     ...
     CASE(TABCHANGED)
      ...
      SELECT CASE (MESSAGE%VALUE2)
       CASE (ID_DLEGTAB1)
        ...
        CALL LEG_GETNOCLASSES(IPLOT,IOPTION)
        IF(MP(IPLOT)%LEG%NCLR.GT.0)THEN
         CALL LEG_GETCLASS(IPLOT)
         CALL LEG_SAMPLECLASS(IPLOT,IOPTION,NLEG)
 ...
 !###====================================================================
 SUBROUTINE LEG_GETNOCLASSES(IPLOT,IOPTION)
 !###====================================================================
 IMPLICIT NONE
...
! CALL LEG_CREATECOLORS(IPLOT)
 ...
 DO I=1,MXCGRAD
  ...
  IF(MP(IPLOT)%LEG%CGRAD(I).EQ.1)THEN
   ...
   !## store colour in cgrad
   CALL WDIALOGGETINTEGER(ID3(I),MP(IPLOT)%LEG%CGRAD(I))
 ...
 !###====================================================================
 SUBROUTINE LEG_SAMPLECLASS(IPLOT,IOPTION,NLEG)
 !###====================================================================
 IMPLICIT NONE
