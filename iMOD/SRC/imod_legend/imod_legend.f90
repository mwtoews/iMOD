...
! END SELECT
 ...
 INTEGER :: N,M,I,J,ICOL,IROW,NODES,CLNODE,NUNIQUE,SAMPLE,LNCOL,LNROW,NC1,NC2,NR1,NR2,IRAT,IRAT1,IPLOT,IP,JP,IDR,IR
 REAL :: XMIN,XMAX,YMIN,YMAX,IDFVALUE,DMIN,DMAX,DR
 REAL,POINTER,DIMENSION(:) :: IDFVAL,IDFVAL_BU
...
!    CALL WSORT(IDFVAL,1,NUNIQUE,1)
 ...
 REAL,DIMENSION(:),POINTER :: IDFVAL_BU
