...
USE MODPLOT
USE MOD_LEGPLOT_PAR
USE MOD_UTL, ONLY : RTOS,UTL_SETTEXTSIZE,IDFPLOT1BITMAP,IDFPLOT2BITMAP,UTL_DIST,UTL_REALTOSTRING,UTL_GETFORMAT  
...
CONTAINS
 ...
 XRELCRD(1)=0.4; YRELCRD(1)=0.4
 XRELCRD(2)=0.5; YRELCRD(2)=0.6
 ...
 DO IPLOT=1,MXMPLOT; IF(DRWLIST(IPLOT).EQ.1)EXIT; END DO
 IF(IPLOT.GT.MXMPLOT)THEN; CALL LEGPLOT_PLOT_CLOSE(); RETURN; ENDIF
