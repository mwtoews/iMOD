...
CONTAINS
 ...
 !###====================================================================
 SUBROUTINE LEGPLOT_BITMAP(IBLEG,NC,X1,Y1,X2,Y2)
 !###====================================================================
 IMPLICIT NONE
...
!  CALL WindowOpenChild(IWINDOW,FLAGS=HideWindow,TITLE='Bitmap viewer')
!  CALL WBitmapView(IBLEG,0,0,Modal)
 
 ENDDO 
 
 END SUBROUTINE LEGPLOT_BITMAP
 ...
 END SUBROUTINE LEGSHOW

 !###======================================================================
 SUBROUTINE LEGPLOTINIT()
 !###======================================================================
 IMPLICIT NONE
 INTEGER :: IPLOT
 ...
 END SUBROUTINE LEGPLOTINIT

 !###======================================================================
 SUBROUTINE LEGPLOTCLOSE()
 !###======================================================================
 IMPLICIT NONE
 ...
 END SUBROUTINE LEGPLOTCLOSE

 !###====================================================================
 SUBROUTINE LEGPLOTUPDATE(LBITMAP)
 !###====================================================================
 IMPLICIT NONE
 ...
 IF(LBITMAP)THEN
  CALL LEGPLOT_BITMAP(IBLEG,NC,XRELCRD(1),YRELCRD(1),XRELCRD(2),YRELCRD(2))
  IF(IBLEG.NE.0)THEN
 ...
 END SUBROUTINE LEGPLOTUPDATE

 !###====================================================================
 SUBROUTINE LEGPLOT(LEG,NC,TSIZE)
 !###====================================================================
 IMPLICIT NONE
...
! CALL WGRTEXTFONT(TFONT,WIDTH=CHW,HEIGHT=CHH)
...
!  CALL WGRTEXTFONT(TFONT,WIDTH=CHW,HEIGHT=CHH,ISTYLE=FSBOLD) !FSITALIC)
 ...
 END SUBROUTINE LEGPLOT

 !###======================================================================
 SUBROUTINE LEGPLOTMOUSEMOVE(XC,YC,ICRD,CRDITYPE)
 !###======================================================================
 IMPLICIT NONE
 ...
 END SUBROUTINE LEGPLOTMOUSEMOVE

 !###======================================================================
 SUBROUTINE LEGADJUSTSHAPE(CRDITYPE,ICRD,XC,YC,DOWNX,DOWNY)
 !###======================================================================
 IMPLICIT NONE
...
!IF(XCRD(2)+DX.GE.MPW%XMAX)DX=MPW%XMAX-XCRD(2)+DX
!IF(XCRD(1)+DX.LE.MPW%XMIN)DX=XCRD(1)+DX-MPW%XMIN
!IF(YCRD(2)+DY.GE.MPW%YMAX)DY=MPW%YMAX-YCRD(2)+DY
!IF(YCRD(1)+DY.LE.MPW%YMIN)DY=YCRD(2)+DY-MPW%YMIN
...
!XCRD(1)=MAX(MPW%XMIN,XCRD(1))
!XCRD(2)=MIN(MPW%XMAX,XCRD(2))
!YCRD(1)=MAX(MPW%YMIN,YCRD(1))
!YCRD(2)=MIN(MPW%YMAX,YCRD(2))
 ...
 END SUBROUTINE LEGADJUSTSHAPE

 !###======================================================================
 SUBROUTINE LEGPLOTSHAPE()
 !###======================================================================
 IMPLICIT NONE
 ...
 END SUBROUTINE LEGPLOTSHAPE

 !###======================================================================
 SUBROUTINE LEGDRAWSHAPE()
 !###======================================================================
 IMPLICIT NONE
