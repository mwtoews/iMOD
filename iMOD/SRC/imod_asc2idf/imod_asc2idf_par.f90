...
MODULE MOD_ASC2IDF_PAR
 ...
 INTEGER :: IGRIDFUNC,MINP,KTYPE,IXCOL,IYCOL,IZCOL,PNTSEARCH,LAGINTERVAL,ASSF_INDICATOR,ASSF_NTHRESHOLD, &
       ASSF_COLUMN,ASSF_STARTDATE,ASSF_ENDDATE,ASSF_DDATE,ILOG,COINCIDENT,IQUADRANT,ASSF_IDEPTH
 CHARACTER(LEN=1) :: ASSF_CDDATE
 REAL,ALLOCATABLE,DIMENSION(:) :: ASSF_K_THRESHOLD !,ASSF_STO_THRESHOLD,ASSF_SPY_THRESHOLD
