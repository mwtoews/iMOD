...
MODULE MOD_ASC2IDF_PAR
 ...
 INTEGER :: IGRIDFUNC,IXCOL,IYCOL,IZCOL,ASSF_INDICATOR,ASSF_NTHRESHOLD,  &
       ASSF_COLUMN,ASSF_STARTDATE,ASSF_ENDDATE,ASSF_DDATE,ASSF_IDEPTH,IINT_IDF
...
! INTEGER :: MINP,KTYPE,PNTSEARCH,LAGINTERVAL,ILOG,COINCIDENT,IQUADRANT,IBLNTYPE
