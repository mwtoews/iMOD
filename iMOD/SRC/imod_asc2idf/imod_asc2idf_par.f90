...
MODULE MOD_ASC2IDF_PAR
 ...
 INTEGER :: IGRIDFUNC,MINP,KTYPE,IXCOL,IYCOL,IZCOL,PNTSEARCH,IEXPVARIOGRAM,LAGINTERVAL, &
       ASSF_COLUMN,ASSF_STARTDATE,ASSF_ENDDATE,ASSF_MTYPE,ASSF_DDATE,ILOG,IADJRANGE,IQUADRANT
 CHARACTER(LEN=1) :: ASSF_CDDATE
 REAL :: CS,NODATA,PERCENTILE,RANGE,SILL,NUGGET,LAGDISTANCE
