...
CONTAINS
 ...
 INTEGER :: IOS,I,J,N,IU,II,III,J1,J2,IROW,ICOL,IL,M,NN
 ...
 IL=1; NN=0; TP%X=TP%NODATA; BT%X=BT%NODATA
 DO
...
!    BT%X(ICOL,IROW) =BT%NODATA
  ...
  NN=NN+1
  TP%FNAME=TRIM(OUTPUTDIR)//'\'//TRIM(ITOS(NN))//'TOP_L'//TRIM(ITOS(IL))//'.IDF'
  WRITE(*,'(A)') 'Writing '//TRIM(TP%FNAME)//' ...'
  IF(.NOT.IDFWRITE(TP,TP%FNAME,1))RETURN

  NN=NN+1
  IDF%FNAME=TRIM(OUTPUTDIR)//'\'//TRIM(ITOS(NN))//'PROP_L'//TRIM(ITOS(IL))//'.IDF'
  WRITE(*,'(A)') 'Writing '//TRIM(IDF%FNAME)//' ...'
  IF(.NOT.IDFWRITE(IDF,IDF%FNAME,1))RETURN

  NN=NN+1
  BT%FNAME=TRIM(OUTPUTDIR)//'\'//TRIM(ITOS(NN))//'BOT_L'//TRIM(ITOS(IL))//'.IDF'
