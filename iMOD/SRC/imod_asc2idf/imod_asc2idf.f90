...
USE MOD_UTL, ONLY : UTL_GETUNIT,ITOS,RTOS,UTL_MESSAGEHANDLE,UTL_SUBST,UTL_WAITMESSAGE,UTL_CAP,UTL_DIRINFO,UTL_IDFSNAPTOGRID,&
    UTL_GETMED,UTL_DIRINFO_POINTER,UTL_IDATETOJDATE,UTL_GETMED,UTL_JDATETOIDATE,UTL_GENLABELSGET,UTL_PCK_READTXT,VAR
USE MODPLOT
   ...
   NP=0; DO I=1,N
    ...
    ELSE     
     ...
     IF(LT.AND.LB.AND.(STIME.NE.ETIME))THEN
      ...
      LEX=UTL_PCK_READTXT(ASSF_COLUMN,STIME,ETIME,Z,TXTFNAME,ASSF_INDICATOR,ASSF_THRESHOLD(ASSF_INDICATOR)) 
     ELSE
     LEX=.FALSE.; Z=0.0
     ENDIF
    ENDIF
