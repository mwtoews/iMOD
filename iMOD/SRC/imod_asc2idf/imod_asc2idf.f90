...
!0.1E+31 0.1E+31 0.1E+31 0.1E+31 0.1E+31  
 ...
 WRITE(*,'(A)') 'Fill grid ...'
 IF(.NOT.ASC2IDF_INT_GETVALUES(XYZFNAMES(IFILE),IIPF,IXCOL,IYCOL,IZCOL,IWCOL))RETURN
 ...
 !###======================================================================
 LOGICAL FUNCTION ASC2IDF_INT_GETVALUES(FNAME,ITYPE,IXCOL,IYCOL,IZCOL,IWCOL)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: ITYPE,IXCOL,IYCOL,IZCOL,IWCOL
 ...
 REAL(KIND=DP_KIND) :: X,Y,Z,W,X1,X2,Y1,Y2,ZV,NCOUNT
 LOGICAL :: LEX,LT,LB
