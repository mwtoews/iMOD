   ...
   DO I=1,N
    ...
    IF(IROW.NE.0.AND.ICOL.NE.0)THEN
     ...
     ELSE
      ...
      LEX=PMANAGER_SAVEMF2005_PCK_READTXT(ASSF_COLUMN,STIME,ETIME,ASSF_MTYPE,Z, &
   ...
   ELSE
    J=0; DO I=1,N
     ...
     ELSE
      STIME=UTL_JDATETOIDATE(ASSF_STARTDATE)*1000000
      ETIME=UTL_JDATETOIDATE(ASSF_ENDDATE)  *1000000
      IF(.NOT.PMANAGER_SAVEMF2005_PCK_READTXT(ASSF_COLUMN,STIME,ETIME,ASSF_MTYPE,ZA(J), &
