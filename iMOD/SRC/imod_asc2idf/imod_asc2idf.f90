...
CONTAINS
 ...
 !###======================================================================
 LOGICAL FUNCTION ASC2IDF_IMPORTXYZ_VOXEL(XYZFNAME,OUTPUTDIR,IWINDOW,XC1,YC1,XC2,YC2,CELLSIZE,DZV)
 !###======================================================================
 IMPLICIT NONE
 ...
 DO
  ...
  IDFC%X=0.0
  DO I=1,N
   IF(XYZP(I,3).LT.IDF%TOP.AND. &
      XYZP(I,3).GE.IDF%BOT)THEN
