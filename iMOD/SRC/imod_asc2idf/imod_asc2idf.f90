...
!0.1E+31 0.1E+31 0.1E+31 0.1E+31 0.1E+31  
 ...
 !###======================================================================
 LOGICAL FUNCTION ASC2IDF_INT_MAIN(IFILE,XMIN,YMIN,XMAX,YMAX,IN_TYPE,IBATCH)
 !###======================================================================
 IMPLICIT NONE
 ...
 SELECT CASE (IGRIDFUNC)
  ...
  CASE (8)
   ...
   ENDDO
   MICNVG=25; ITIGHT=1 
   CALL SOLID_PCGINT(XP,YP,ZP,SIZE(XP),IERROR,IDF(1),-1,CD=WP,IPC=IPC,CC_GIVEN=IDF(3),IBATCH=IBATCH)
