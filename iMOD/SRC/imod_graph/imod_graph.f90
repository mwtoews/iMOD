...
CONTAINS
 ...
 INTEGER :: ITYPE,NG,IBITMAP,I,IXDLU,IYDLU,IXPIX,IYPIX,NGRAPHS,IGRAPH
...
!  write(*,*) WInfoScreen(ScreenHeight )
 ...
 CALL GRAPH_DRAW(IBITMAP,1,NGRAPHS,.TRUE.,LEXPORTIT,LMULTIT)
    ...
    CASE (PUSHBUTTON)
     SELECT CASE (MESSAGE%VALUE1)
      CASE (ID_ZOOMIN,ID_ZOOMOUT,ID_ZOOMFULL,ID_ZOOMBOX,ID_MOVE)
       CALL GRAPH_ZOOM(ID_DSCENTOOL_FIGURE,MESSAGE%VALUE1,IBITMAP,NG,LMULTIT) 
      CASE (ID_COPY)
    ...
    CASE (FIELDCHANGED)
     SELECT CASE (MESSAGE%VALUE2)
      CASE (IDF_MENU1)
       ...
       CALL GRAPH_DRAW(IBITMAP,NG,NG,.FALSE.,LEXPORTIT,LMULTIT) 
     END SELECT
    CASE (RESIZE,EXPOSE)
     !## refresh graph
 ...
 !###======================================================================
 SUBROUTINE GRAPH_DRAW(IBITMAP,IG,JG,LINI,LEXPORTIT,LMULTIT)  
 !###======================================================================
 IMPLICIT NONE
 ...
 !###====================================================================
 SUBROUTINE GRAPH_ZOOM(IDD,IDZ,IBITMAP,NG,LMULTIT) 
 !###====================================================================
 IMPLICIT NONE
 ...
 ELSE  
  CALL GRAPH_DRAW(IBITMAP,NG,NG,.TRUE.,.FALSE.,LMULTIT) 
  RETURN
 ENDIF
    ...
    CASE(MOUSEMOVE)
     ...
     IF(IDZ.EQ.ID_MOVE)THEN
      IF(IDOWN.GT.0)THEN
       ...
       PGYMAX(:)=PGYMAX(:)+DY
       PGYMIN(:)=PGYMIN(:)+DY
       CALL GRAPH_DRAW(IBITMAP,NG,NG,.FALSE.,.FALSE.,LMULTIT) 
      ENDIF
     ELSEIF(IDZ.EQ.ID_ZOOMBOX)THEN
