...
CONTAINS
 ...
 NG=SIZE(GRAPHNAMES)
 CALL GRAPH_DRAW(IBITMAP,1,NG,XTXT,YTXT,LDATE,.TRUE.)
   ...
   CASE (FIELDCHANGED)
    SELECT CASE (MESSAGE%VALUE2)
     CASE (IDF_MENU1)
      ...
      CALL GRAPH_DRAW(IBITMAP,NG,NG,XTXT,YTXT,LDATE,.FALSE.)
    END SELECT
   CASE (RESIZE,EXPOSE)
    !## refresh graph
    CALL GRAPH_DRAW(IBITMAP,NG,NG,XTXT,YTXT,LDATE,.FALSE.)
 ...
 !###======================================================================
 SUBROUTINE GRAPH_DRAW(IBITMAP,IG,JG,XTITLE,YTITLE,LDATE,LINI)
 !###======================================================================
 IMPLICIT NONE
...
! CALL IGRCOLOURN(WRGB(234,255,255))
! CALL IGRRECTANGLE(AXES%XMIN,0.0,AXES%XMAX,AXES%YMAX)
! CALL IGRCOLOURN(WRGB(255,242,244))
! CALL IGRRECTANGLE(AXES%XMIN,AXES%YMIN,AXES%XMAX,0.0)
...
!   END DO
 ...
 CALL WGRTEXTSTRING(AXES%XMAX-1.5*DX,AXES%YMIN+1.5*DY,TRIM(GRAPHNAMES(NG))) !'teksten')
 ...
 ELSE
  CALL GRAPH_DRAW(IBITMAP,NG,NG,XTXT,YTXT,LDATE,.TRUE.)
  RETURN
 ENDIF
