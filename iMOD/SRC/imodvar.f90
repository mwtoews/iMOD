...
INTEGER :: EXPDATE=20160215 !# expire data, after this date the iMOD-beta version cannot be used.

CHARACTER(LEN=30),PARAMETER :: RVERSION='V3_3_7'    !## release message - only with single subnummers
...
REAL :: DOWNX,DOWNY
!REAL :: IDF_OLDND !## stores old NODATA value IDF read from Map Info window
