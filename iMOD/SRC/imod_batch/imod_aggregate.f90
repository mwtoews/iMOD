...
!     IF(II.NE.I.AND.JJ.NE.J)THEN
     IF(II.LT.I)THEN !.AND.JJ.LT.J)THEN
...
!   CALL LHM_ADDIWHB_RASTER_CHECK_CONSISTENCY(ODF,K,IROW,ICOL)
   ...
   !## check base data
   N=0; DO I=1,NF; CALL LHM_ADDIWHB_RASTER_CHECK(ODF(:,I),K,ICOL,IROW,N); ENDDO; I=I-1
   
   !## check insert data
   DO J=1,NA; I=I+1; CALL LHM_ADDIWHB_RASTER_CHECK(ODF(:,I),K,ICOL,IROW,N); ENDDO
