MODULE MOD_AGGREGATE
 ...
 DO I=1,2; M=1; N=1; DO
   ...
   N=N+1; IF(I.EQ.2)M=N
  ENDDO; IF(I.EQ.1)THEN; DEALLOCATE(SLIST); ALLOCATE(SLIST(N-1)); ENDIF
  REWIND(IU); READ(IU,*)
 ENDDO; CLOSE(IU)
 ...
 DO J=1,SIZE(ALIST)
  ...
  I=J
  !## read data
  IF(.NOT.LHM_ADDIWHB_READFLIST(IDF,TPIDF,BTIDF,KHIDF,KVIDF,VAIDF,SIZE(ALIST(J)%FILE),ALIST(J)%FILE,IWHBDIR))STOP 
