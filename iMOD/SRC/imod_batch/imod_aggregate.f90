...
!   ENDIF
 ...
 DO I=1,SIZE(FLIST)
  CALL LHM_ADDIWHB_RASTER_OPENFILES_READ(FLIST(I)%FILE,FLIST(I)%DUPL_F,FLIST(I)%DUPL_T,INDIR,IDF,I,MDL) !(:,I))
 ENDDO; I=I-1
 !## open all iwhb files for reading
 DO J=1,NA; I=I+1
  CALL LHM_ADDIWHB_RASTER_OPENFILES_READ(ALIST(J)%FILE,ALIST(J)%DUPL_F,ALIST(J)%DUPL_T,IWHBDIR,IDF,I,MDL) !(:,I))
 ENDDO
 !## check all files
