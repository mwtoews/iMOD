...
! READ(LINE,*) MAXZ; WRITE(*,'(A,F10.2)') 'MAXZ=',MAXZ
 ...
 IMPLICIT NONE
 INTEGER :: IMASK,IHYPO,ICKDC,I,J,NGEN,RNLAY
 REAL :: ZOFFSET
 ...
 IF(ICKDC.EQ.1)THEN
  ...
  IF(UTL_READINITFILE('RNLAY',LINE,IU,1))THEN
   READ(LINE,*) RNLAY; WRITE(*,'(A,I10)') 'RNLAY=',RNLAY
   ALLOCATE(REGISFILES_TOP(RNLAY),REGISFILES_BOT(RNLAY),REGISFILES_KHV(RNLAY),REGISFILES_KVV(RNLAY))
   REGISFILES_TOP=''; REGISFILES_BOT=''; REGISFILES_KHV=''; REGISFILES_KVV=''
   DO I=1,RNLAY
    !## read top formation
