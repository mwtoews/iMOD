...
!## Write GEN and RUN file  ! FR 20131016
 ...
 PBMAN%NLINESEARCH=10; PBMAN%NCPU=1; PBMAN%CMDHIDE=1; PBMAN%PREGULARISATION=0
 ...
 ELSEIF(UTL_READINITFILE('PRJFILE_IN',LINE,IU,1))THEN
  ...
  IF(PBMAN%IPEST.EQ.0)THEN
   ...
   IF(PBMAN%IPESTP.EQ.1)THEN
    ...
    IF(UTL_READINITFILE('PREGULARISATION',LINE,IU,1))READ(LINE,*) PBMAN%PREGULARISATION
    WRITE(*,'(A,I10)') 'PREGULARISATION=',PBMAN%PREGULARISATION
   ENDIF
  ENDIF
