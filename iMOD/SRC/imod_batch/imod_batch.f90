...
USE MOD_UTL,ONLY : UTL_CAP,UTL_GETUNIT,UTL_READINITFILE,ITOS,RTOS,UTL_IDATETOJDATE,UTL_DIRINFO,UTL_CREATEDIR, &
  ...
  UTL_GETUNIQUE,UTL_GETIDPROC,UTL_WSELECTFILE,PROCOBJ,UTL_GDATE
...
! ENDIF
 ...
 IF(N.EQ.0)THEN
  ...
  DO   
   ...
   ENDIF
   IF(.NOT.ASC2IDF_TYPE3(1,XMIN,YMIN,XMAX,YMAX,IDEPTH))THEN; ENDIF
   IDATE=IDATE+DDATE
   IF(IDEPTH.EQ.0)THEN
 ...
 ELSE
  ...
  DO 
   ...
   DO I=1,N
    ...
    IF(.NOT.ASC2IDF_TYPE3(I,XMIN,YMIN,XMAX,YMAX,IDEPTH))THEN
    ENDIF
   ENDDO
