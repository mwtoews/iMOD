...
USE MOD_PMANAGER, ONLY : PMANAGERPRJ,PMANAGERRUN,PMANAGER_UTL_INIT,PMANAGER_SAVEMF2005_HFB_GENFILES
...
!USE MOD_KRIGING, ONLY : KRIGING_GETGAMMA
INTEGER,PARAMETER,PRIVATE :: MAXFUNC=88
...
DATA CFUNC/'PLOT','GXG','AHNFILTER','IDFSCALE','IDFCALC','IDFMERGE','CREATEIDF','IMPORTMODFLOW',&
  ...
  'CREATEWELBORELOG','CREATEENSEMBLES','IPFEVALUATE','LAYERFROMTHICKNESS','MODPATH7'/
...
!       WRITE(*,'(A,I10)') 'THIS IS CELL: ', N
       ...
       NODE=N; CALL UTL_GETIROWICOL(NODE,NLAY,IDF%NROW,IDF%NCOL,ILAY,IROW,ICOL)
...
!       WRITE(*,'(A,4I10)') 'NUMBER OF CONNECTED CELLS IS CELL,ILAY,IROW,ICOL', NCON,ILAY,IROW,ICOL
       DO IPOS=IA(N)+1,IA(N+1)-1
        ...
        NODE=M; CALL UTL_GETIROWICOL(NODE,NLAY,IDF%NROW,IDF%NCOL,JLAY,JROW,JCOL)
...
!      write(*,*) txt1id1,txt2id1,txt1id2,txt2id2,nlist
 ...
 WRITE(*,'(A,F10.2)') 'LOGTRANSFORM=',ILOGTRANSFORM
