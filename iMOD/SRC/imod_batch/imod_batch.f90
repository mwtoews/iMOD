...
!  TNG=TNG-0.5*PI
 ...
 INTEGER :: I,IFLOW,IPNTR,IWINDOW,IWRITE,IGRAD
 ...
 I=5; IF(IFLOW.EQ.1)I=4; IF(IFLOW.EQ.2)I=4
 ...
 ELSEIF(IFLOW.EQ.2)THEN
  ...
  READ(LINE,*) IDF(4)%FNAME; WRITE(*,'(A)') 'RESULTIDF='//TRIM(IDF(4)%FNAME)

  CALL SOF_CATCHMENTS(IDF,SIZE(IDF))
