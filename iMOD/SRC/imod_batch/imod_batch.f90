...
INTEGER,PARAMETER,PRIVATE :: MAXFUNC=50
...
DATA CFUNC/'PLOT','GXG','AHNFILTER','IDFSCALE','IDFCALC','IDFMERGE','CREATEIDF','IMPORTMODFLOW',&
  ...
  'CREATEIZONE','GEF2IPF','UTM2LATLONG','ISGADDSTAGES'/
...
! CALL ISG_ADDSTAGES(FNAME,WIDTHFNAME,MAXDIST,CROSS_PNTR,CROSS_BATH,CELL_SIZE)
