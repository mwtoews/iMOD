...
!## Write GEN and RUN file  ! FR 20131016
 ...
 ELSEIF(UTL_READINITFILE('PRJFILE_IN',LINE,IU,1))THEN
  ...
  IF(UTL_READINITFILE('INTSHD',LINE,IU,1))READ(LINE,*) PBMAN%INTSHD
  IF(UTL_READINITFILE('INTKHV',LINE,IU,1))READ(LINE,*) PBMAN%INTKHV
  IF(UTL_READINITFILE('INTKDW',LINE,IU,1))READ(LINE,*) PBMAN%INTKDW
  IF(UTL_READINITFILE('INTKVV',LINE,IU,1))READ(LINE,*) PBMAN%INTKVV
  IF(UTL_READINITFILE('INTKVA',LINE,IU,1))READ(LINE,*) PBMAN%INTKVA
  IF(UTL_READINITFILE('INTVCW',LINE,IU,1))READ(LINE,*) PBMAN%INTVCW
  IF(UTL_READINITFILE('INTTOP',LINE,IU,1))READ(LINE,*) PBMAN%INTTOP
  IF(UTL_READINITFILE('INTSF1',LINE,IU,1))READ(LINE,*) PBMAN%INTSF1
  IF(UTL_READINITFILE('INTSF2',LINE,IU,1))READ(LINE,*) PBMAN%INTSF2
  IF(UTL_READINITFILE('INTANF',LINE,IU,1))READ(LINE,*) PBMAN%INTANF
