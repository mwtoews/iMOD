...
!  TNG=TNG-0.5*PI
 ...
 INTEGER :: I,J,IFLOW,IPNTR,IWINDOW,IWRITE,IGRAD,ITQP,NTQP,TTQP,YTQP
 ...
 ELSEIF(IFLOW.EQ.2)THEN
  ...
  YTQP=0; IF(TTQP.EQ.1)THEN
   IF(.NOT.UTL_READINITFILE('YTQP',LINE,IU,0))RETURN
   READ(LINE,*) YTQP; WRITE(*,'(A,I10)') 'YTQP=',YTQP
  ENDIF
  ...
  CALL SOF_CATCHMENTS(RESULTIDF,OUTPUTFOLDER,IDF,TQP,PTQP,ITQP,TTQP,YTQP)
