...
USE MOD_UTL,ONLY : UTL_CAP,UTL_GETUNIT,UTL_READINITFILE,ITOS,RTOS,UTL_IDATETOJDATE,UTL_DIRINFO,UTL_CREATEDIR, &
  ...
  UTL_GETUNIQUE,UTL_GETIDPROC,UTL_WSELECTFILE,PROCOBJ,UTL_GDATE,NV,NL,UTL_GENLABELSREAD
USE MODPLOT, ONLY : MPW,MP,MXMPLOT
USE IMODVAR, ONLY : IBACKSLASH,ILABELNAME,EXENAME
...
INTEGER,PARAMETER,PRIVATE :: MAXFUNC=56
...
!     CALL CREATEIMODBATCHKILL()
 ...
 WRITE(IU,'(A/)') 'rem iMOD Batch generated by iMOD '//TRIM(BVERSION)
...
! ENDIF
 ...
 CALL WGRTEXTSTRING(XP-BND,0.0+0.5*BND,'Powered by iMOD '//TRIM(BVERSION)//' Copyright © 2005-2013')
