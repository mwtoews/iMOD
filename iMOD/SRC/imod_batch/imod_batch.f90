...
! READ(LINE,*) MAXZ; WRITE(*,'(A,F10.2)') 'MAXZ=',MAXZ
 ...
 ICOLS=0; DO I=1,6; ICOLS(I)=I; ENDDO  
 ...
 IF(UTL_READINITFILE('DCOL',LINE,IU,1))READ(LINE,*) ICOLS(4); WRITE(*,'(A,I2)') 'DCOL=',ICOLS(4)
 IF(UTL_READINITFILE('ICOL',LINE,IU,1))READ(LINE,*) ICOLS(5); WRITE(*,'(A,I2)') 'ICOL=',ICOLS(5)
 IF(UTL_READINITFILE('ACOL',LINE,IU,1))READ(LINE,*) ICOLS(6); WRITE(*,'(A,I2)') 'ACOL=',ICOLS(6)
 IF(UTL_READINITFILE('LCOL',LINE,IU,1))READ(LINE,*) ICOLS(7); WRITE(*,'(A,I2)') 'LCOL=',ICOLS(7)
...
! ENDIF
 ...
 CALL DEVWELL_IMPORT(CSVFNAME,IPFFNAME,ICOLS)
