...
!      write(*,*) txt1id1,txt2id1,txt1id2,txt2id2,nlist
 ...
 !###======================================================================
 IMPLICIT NONE
 REAL(KIND=DP_KIND) :: XMIN,YMIN,XMAX,YMAX,SMALL,X1,Y1,X2,Y2,XCOR,S,T
 INTEGER :: IN_TYPE,ICOL,IROW,ICOL2,IROW2,N,I,J,ISIM,NSIM
...
! REAL(KIND=DP_KIND),DIMENSION(3,3) :: A
 ...
 I=0; DO IROW=1,STDEV%NROW; DO ICOL=1,STDEV%NCOL
  ...
  I=I+1; V(I)=STDEV%X(ICOL,IROW)*10.0D0; M(I)=MEAN%X(ICOL,IROW)
 ENDDO; ENDDO
...
!## met dit werkt het niet - heel vreemd
   XCOR=KRIGING_GETGAMMA(X1,Y1,X2,Y2,RANGE,SILL-NUGGET,NUGGET,3) !KTYPE)
   XCOR=(XCOR-NUGGET)/(SILL-NUGGET)
!## dit werkt ook
!   xcor=UTL_DIST(X1,Y1,X2,Y2)/range
!   call random_number(xcor)
   !## alleen inverse-distance weighted ...
!   xcor=0.0d0
   COR(I,J)=XCOR; COR(J,I)=XCOR
!   COV(I,J)=XCOR; COV(J,I)=COV(I,J)
   COV(I,J)=COV(I,I)*COV(J,J)*XCOR; COV(J,I)=COV(I,J)
!   COV(I,J)=COV(I,I)-XCOR; COV(J,I)=COV(I,J)
  ENDDO
 ENDDO

 OPEN(10,FILE='d:\IMOD-MODELS\IES\CREATEENSEMBLES\COV.TXT',STATUS='UNKNOWN',ACTION='WRITE')
 WRITE(10,*) 'COVARIANCE MAXTRIX'; WRITE(10,*) N
