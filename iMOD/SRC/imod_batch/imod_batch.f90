...
!  IF(GC_INIT_IDENTIFY(IU))
 ...
 TYPE(IDFOBJ) :: MASK
 INTEGER :: NLAY,ILAY,IVCW,DI,IROW,ICOL,NG,N,JU,KU,NP,IAQUIFER,IAQUITARD,IQ3D,IFM,IMASK,IACT
 ...
 !IF(UTL_READINITFILE('MINTHICKNESS',LINE,IU,1))READ(LINE,*) MINTHICKNESS
 !WRITE(*,'(A)') 'MINTHICKNESS='//TRIM(RTOS(MINTHICKNESS,'F',2))
