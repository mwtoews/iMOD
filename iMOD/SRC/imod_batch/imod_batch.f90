...
! ENDDO; ENDDO; ENDDO 
 ...
 !###======================================================================
 USE MOD_SOLID_PAR, ONLY : IBATCH,IWINDOW,SOLFILE,OUTPUTFOLDER,IMIDELEV, &
 ...
 IF(IHYPO.EQ.1)THEN
  ...
  IF(.NOT.UTL_READINITFILE('IMIDELEV',LINE,IU,0))RETURN
  READ(LINE,*) IMIDELEV; WRITE(*,'(A,I1)') 'IMIDELEV=',IMIDELEV
