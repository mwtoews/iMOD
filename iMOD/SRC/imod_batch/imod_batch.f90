...
!## Write GEN and RUN file  ! FR 20131016
 ...
 IMODE=0; PBMAN%IFORMAT=0; PBMAN%TIMFNAME='' !; LQBD=.FALSE.
...
!  TNG=TNG-0.5*PI
 ...
 USE MOD_ISG_PAR, ONLY : ISGFNAME
 IMPLICIT NONE
 CHARACTER(LEN=256) :: FNAME,WIDTHFNAME,CROSS_PNTR,CROSS_BATH,CROSS_ZCHK,CROSS_CVAL
 INTEGER :: ISAVE
 ...
 CALL ISG_ADDCROSSSECTION(FNAME,WIDTHFNAME,MAXDIST,CROSS_PNTR,CROSS_BATH,CROSS_ZCHK,CROSS_CVAL,CELL_SIZE)
