...
! READ(LINE,*) MAXZ; WRITE(*,'(A,F10.2)') 'MAXZ=',MAXZ
 ...
 IMPLICIT NONE
 INTEGER :: I,J,K,N,IN_TYPE,JU,M,IDATE,SDATE,EDATE,DDATE,IOS,ICOL,IROW,JF
...
!      WRITE(*,*) 'SPY_THRESHOLD'//TRIM(ITOS(I))//'=',ASSF_SPY_THRESHOLD(I)
 ...
 ELSEIF(IN_TYPE.EQ.4)THEN
  ...
  CALL UTL_GENLABELSREAD(XYZFNAMES(1)(:INDEX(XYZFNAMES(1),'.',.TRUE.)-1)//'.dat')
 ...
 IF(N.EQ.0)THEN
  ...
  IF(ASSF_INDICATOR.GE.0)THEN
   ...
   DO I=1,ASSF_NTHRESHOLD
    ...
    IF(ASSF_IDEPTH.EQ.0)IDATE=SDATE
    DO   
     IF(ASSF_IDEPTH.EQ.0)THEN
