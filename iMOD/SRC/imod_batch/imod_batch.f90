...
!  IF(.NOT.UTL_READINITFILE('MEAN',LINE,IU,0))RETURN; READ(LINE,*) AVERAGE
!  WRITE(*,'(A,F10.2)') 'MEAN=',AVERAGE
!  IF(.NOT.UTL_READINITFILE('STDEV',LINE,IU,0))RETURN; READ(LINE,*) STDV
!  WRITE(*,'(A,F10.2)') 'STDEV=',STDV
