...
!## Write GEN and RUN file  ! FR 20131016
 ...
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=256) :: RUNFILE,PRJFILE,OUTFOLDER
 ...
 ELSEIF(UTL_READINITFILE('PRJFILE_IN',LINE,IU,1))THEN
  ...
  PBMAN%IFORMAT=1; IF(UTL_READINITFILE('SIM_TYPE',LINE,IU,1))READ(LINE,*) PBMAN%IFORMAT
  SELECT CASE (PBMAN%IFORMAT)
   ...
   CASE (3)
    ...
    PBMAN%IGENMF6=0; IF(UTL_READINITFILE('IGENMF6',LINE,IU,1))READ(LINE,*) PBMAN%IGENMF6
    !## read model network
    ...
    ENDIF
!    IF(UTL_READINITFILE('TCOMPLEX',LINE,IU,1))READ(LINE,*) PBMAN%TCOMPLEX
