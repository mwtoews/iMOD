...
!   ENDIF
 ...
 !## default irun=0
 ICONVERTGEN=0; IRUN=0; RUNFILE=''; IF(UTL_READINITFILE('IRUN',LINE,IU,1))READ(LINE,*) IRUN
 IF(IRUN.EQ.1)THEN
...
! IY1=1980; IY2=2015; 
 ...
 IMPLICIT NONE
 INTEGER :: IMASK,IHYPO,ICKDC,I,J,NGEN,FNLAY
 REAL :: ZOFFSET
...
!  IF(GC_INIT_IDENTIFY(IU))
 ...
 READ(LINE,*) INPUTFILE; WRITE(*,'(A,A)') 'INPUTFILE=',TRIM(INPUTFILE)
 ...
 READ(LINE,*) BMPNAME; WRITE(*,'(A,A)') 'BMPNAME=',TRIM(BMPNAME)
 IF(.NOT.UTL_READINITFILE('ICOLS',LINE,IU,0))RETURN
 READ(LINE,*) (ICOL(I),I=1,3); WRITE(*,'(A,A)') 'ICOLS=',(ICOL(I),I=1,3)
 
 CALL RESIDUAL_MAIN(INPUTFILE,BMPNAME,IPLOT)
