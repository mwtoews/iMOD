...
USE MOD_SOLID_PCG, ONLY : SOLID_CALC_HYPO
...
INTEGER,PARAMETER,PRIVATE :: MAXFUNC=59
...
DATA CFUNC/'PLOT','GXG','AHNFILTER','IDFSCALE','IDFCALC','IDFMERGE','CREATEIDF','IMPORTMODFLOW',&
  ...
  'CLIPVOXELS','FAULTS3D','RUNFILE','FLUMY','GEOCONNECT','IPFSUM'/
...
! I=INDEX(FUNC,'('); I=MAX(I,1)
 ...
 CALL ASC2IDF_IMPORTASC_MAIN(DIRNAME,TOPWC,BOTEL,MULT,ADD,IBATCH)
