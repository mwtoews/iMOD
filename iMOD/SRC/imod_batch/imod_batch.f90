...
! ENDIF
 ...
 INTEGER :: JU,NCOL,NROW,ILAY,KSTP,KPER,ICOL,IROW,IOS,I1,I2,I3,NDIM1,NDIM2,NDIM3, &
  IMETH,NDAT,NLIST,I,J
 ...
 CHARACTER(LEN=256) :: ROOT
 REAL(KIND=DP_KIND) :: PERTIM,TOTIM,DELT
 ...
 IF(UTL_READINITFILE('BDG',LINE,IU,1))THEN
  ...
  DO
   ...
   SELECT CASE (IMETH)
    CASE (1)
     ALLOCATE(X(NDIM1,NDIM2,NDIM3))
     READ(JU) (((X(I1,I2,I3),I1=1,NDIM1),I2=1,NDIM2),I3=1,NDIM3)
     DO ILAY=1,NDIM3
      IDF%NODATA=1.0D30
    ...
    CASE (6)
     ...
     READ(JU) (AUXTXT(I),I=1,NDAT-1)
     READ(JU) NLIST
     ALLOCATE(ID1(NDAT),ID2(NDAT),X(NDAT,NLIST,1))
     READ(JU) ((ID1(I),ID2(I),(X(I,J,1),I=1,NDAT)),J=1,NLIST)
     DEALLOCATE(AUXTXT,ID1,ID2,X)
    CASE DEFAULT
