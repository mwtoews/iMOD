...
USE MOD_UTL,ONLY : UTL_CAP,UTL_GETUNIT,UTL_READINITFILE,ITOS,RTOS,UTL_IDATETOJDATE,UTL_DIRINFO,UTL_CREATEDIR, &
  ...
  UTL_MINTHICKNESS,UTL_GETHELP,UTL_STDEF
...
! REAL(KIND=DP_KIND),DIMENSION(3,3) :: A
 ...
 !## error standard-deviation (=sqrt(variance)) - used as parameter variance
...
!   COV(I,J)=COV(I,I)*COV(J,J)*XCOR; COV(J,I)=COV(I,J)
  ENDDO
 ENDDO

 OPEN(10,FILE='d:\IMOD-MODELS\IES\CREATEENSEMBLES\COV.TXT',STATUS='UNKNOWN',ACTION='WRITE')
...
!   DO I=1,NE; CALL IPEST_LUBACKSUB_DBL(M,INDX,B(1,I),NE); ENDDO
 ...
 IF(N.LT.200)THEN
  OPEN(10,FILE='d:\IMOD-MODELS\IES\CREATEENSEMBLES\COV.M',STATUS='UNKNOWN',ACTION='WRITE')
  WRITE(10,*) 'COR=['
...
! DEALLOCATE(COV)
 ...
 DO ISIM=1,NSIM
  ...
  DO I=1,N
   ...
   ENDIF
  ENDDO
  CALL UTL_STDEF(V,N,-999.99D0,VAR,XT,NPOP)
  
  WRITE(*,'(I10,2F15.7)') NPOP,XT,VAR
 ...
 !###======================================================================
 REAL(KIND=DP_KIND) FUNCTION IMODBATCH_CREATEENSEMBLES_GETGAMMA(X1,Y1,X2,Y2,RANGE,C1,C0,KTYPE)  !c1=sill-nugget c0=nugget
 !###======================================================================
 IMPLICIT NONE
 ...
 IF(DXY.GE.RANGE)THEN
  IMODBATCH_CREATEENSEMBLES_GETGAMMA=C1; RETURN
!  H=0.999D0 
 ELSE
...
!    H=1.0D0-EXP(-3.0D0*(DXY**2.0D0)/(RANGE**2.0D0))
 ...
 IMODBATCH_CREATEENSEMBLES_GETGAMMA=(C1-C0)*H+C0
! KRIGING_GETGAMMA=C0+C1*H
 
 END FUNCTION IMODBATCH_CREATEENSEMBLES_GETGAMMA
