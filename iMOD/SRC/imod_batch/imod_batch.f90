...
!      write(*,*) txt1id1,txt2id1,txt1id2,txt2id2,nlist
 ...
 !###======================================================================
 IMPLICIT NONE
 REAL(KIND=DP_KIND) :: XMIN,YMIN,XMAX,YMAX,SMALL,X1,Y1,X2,Y2,XCOR,S
 INTEGER :: IN_TYPE,ICOL,IROW,ICOL2,IROW2,N,I,J
 ...
 !## fill in variance (kriging) - alles normaliseren naar 1.0 !!! (nog doen)
 SILL=1.0D0
 !# scale variances to 1.0
 ...
 IROW=1; ICOL=0; DO I=1,N
  ...
  IROW2=IROW; ICOL2=ICOL; DO J=I+1,N
   ...
   XCOR=KRIGING_GETGAMMA(X1,Y1,X2,Y2,RANGE,SILL-NUGGET,NUGGET,KTYPE)
...
! DEALLOCATE(COV)
 ...
 ALLOCATE(X(N)); X=0.0D0; CALL RANDOM_NUMBER(X); V=0.0D0
 ...
 ENDDO; ENDDO
 MEAN%FNAME=IDFFILE(:INDEX(IDFFILE,'.',.TRUE.)-1)//'_MEAN.IDF'
 IF(.NOT.IDFWRITE(MEAN,MEAN%FNAME,0))STOP
