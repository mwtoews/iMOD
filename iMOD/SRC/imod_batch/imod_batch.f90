...
! WRITE(JU,'(A)') 'MP7.TIMESERIES7'
 ...
 TYPE(IDFOBJ) :: MOTHER,TOP,BOT
 CHARACTER(LEN=256) :: OUTPUTFOLDER
 INTEGER :: NLAY,IOS,I,IROW,ICOL
 REAL(KIND=DP_KIND) :: X,MINTHICKNESS
 ...
 DO I=1,SIZE(THK)
  ...
  TOP%FNAME=TRIM(OUTPUTFOLDER)//'\TOP_L'//TRIM(ITOS(I))//'.IDF'
  IF(.NOT.IDFWRITE(TOP,TOP%FNAME,1))RETURN
  BOT%FNAME=TRIM(OUTPUTFOLDER)//'\BOT_L'//TRIM(ITOS(I))//'.IDF'
