...
!      write(*,*) txt1id1,txt2id1,txt1id2,txt2id2,nlist
 ...
 INTEGER :: IN_TYPE,NSIM,ILOGTRANSFORM,I
 ...
 ELSE
  ...
  !## set sill/nugget for cholesky/eigenvalue decomposition
  SILL=1.0D0; NUGGET=0.0D0; KTYPE=3
  ...
  CALL UTL_IDFSNAPTOGRID_LLC(MEAN%XMIN,MEAN%XMAX,MEAN%YMIN,MEAN%YMAX,MEAN%DX,MEAN%DX,MEAN%NCOL,MEAN%NROW) !,LLC)
 ...
 DIR=IDFFILE(:INDEX(IDFFILE,'\',.TRUE.)-1)
