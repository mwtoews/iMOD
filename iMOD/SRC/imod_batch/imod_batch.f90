...
! IIPF=NIPF
 ...
 IF(.NOT.IMODBATCH_READPOINTER(NLAYER,ILAYER,'ILAYER',0))RETURN
! IF(.NOT.IMODBATCH_READPOINTER(NIPF,IIPF,'IIPF',0))RETURN
! IF(.NOT.IMODBATCH_READPOINTER(NDATE,IDATE,'IDATE',0))RETURN
