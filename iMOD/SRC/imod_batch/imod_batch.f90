...
!  TNG=TNG-0.5*PI
 ...
 INTEGER :: I,J,IFLOW,IPNTR,IWINDOW,IWRITE,IGRAD,ITQP,NTQP,TTQP,IFORMAT
 REAL,DIMENSION(:),ALLOCATABLE :: PTQP
 CHARACTER(LEN=256) :: RESULTIDF,OUTPUTFOLDER,FNAME
 REAL :: XMIN,YMIN,XMAX,YMAX,CELLSIZE,MINQ
 ...
 ELSEIF(IFLOW.EQ.3)THEN
  ...
  IF(IFORMAT.EQ.1)I=8 !## standard river
  IF(IFORMAT.EQ.2)I=4 !## isg(sfr)
  ...
  CALL SOF_EXPORT(IDF,SIZE(IDF),IFORMAT)
