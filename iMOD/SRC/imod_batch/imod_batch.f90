...
!  TNG=TNG-0.5*PI
 ...
 USE MOD_ISG_PAR, ONLY : ISGFNAME
 IMPLICIT NONE
 CHARACTER(LEN=256) :: FNAME,WIDTHFNAME,CROSS_PNTR,CROSS_BATH,CROSS_ZCHK
 INTEGER :: ISAVE
 ...
 CALL ISG_ADDCROSSSECTION(FNAME,WIDTHFNAME,MAXDIST,CROSS_PNTR,CROSS_BATH,CROSS_ZCHK,CELL_SIZE)
