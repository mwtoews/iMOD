...
USE MOD_SOF, ONLY : SOF_MAIN,SOF_TRACE,SOF_CATCHMENTS
 ...
 IF(UTL_READINITFILE('PRJFILE_IN',LINE,IU,1))THEN
  ...
  IF(PBMAN%ISS.EQ.1)THEN
   ...
   ELSE
    ...
    PBMAN%NSTEP=1;   IF(UTL_READINITFILE('NSTEP',LINE,IU,1))READ(LINE,*) PBMAN%NSTEP
    WRITE(*,'(A12,I10)') 'NSTEP=',PBMAN%NSTEP
    PBMAN%NMULT=1.0; IF(UTL_READINITFILE('NMULT',LINE,IU,1))READ(LINE,*) PBMAN%NMULT
...
!  TNG=TNG-0.5*PI
 ...
 INTEGER :: I,J,IFLOW,IPNTR,IWINDOW,IWRITE,IGRAD,ITQP,NTQP,TTQP
