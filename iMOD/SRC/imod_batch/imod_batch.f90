...
!  IF(GC_INIT_IDENTIFY(IU))
 ...
 IF(UTL_READINITFILE('IXY',LINE,IU,0))READ(LINE,*) IXY
 WRITE(*,'(A,I1)') 'IXY=',IXY
 IF(IXY.EQ.1)THEN
  IF(UTL_READINITFILE('XMAX',LINE,IU,0))READ(LINE,*) XMAX
  WRITE(*,'(A,F10.2)') 'XMAX=',XMAX
  IF(UTL_READINITFILE('XMIN',LINE,IU,0))READ(LINE,*) XMIN
  WRITE(*,'(A,F10.2)') 'XMIN=',XMIN
  IF(UTL_READINITFILE('YMAX',LINE,IU,0))READ(LINE,*) YMAX
  WRITE(*,'(A,F10.2)') 'YMAX=',YMAX
  IF(UTL_READINITFILE('YMIN',LINE,IU,0))READ(LINE,*) YMIN
  WRITE(*,'(A,F10.2)') 'YMIN=',YMIN
 ENDIF
