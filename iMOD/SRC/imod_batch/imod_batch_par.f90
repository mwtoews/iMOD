...
CONTAINS
 ...
 CALL BATCHINIT_DEVWELTOIPF(38)
 CALL BATCHINIT_IPFEVALUATE(39)
 ...
 BAT(I)%LVL(10)="(DEP)"; BAT(I)%KEY(10)="IPFASSFILES"
 BAT(I)%LVL(11)="(DEP)"; BAT(I)%KEY(11)="IPFASSFILES_ALL"
 BAT(I)%LVL(12)="(DEP)"; BAT(I)%KEY(12)="NLABELS"
 BAT(I)%LVL(13)="(DEP2)"; BAT(I)%KEY(13)="ILABELS"
 BAT(I)%LVL(14)="(DEP)"; BAT(I)%KEY(14)="IPFSTYLE"
 BAT(I)%LVL(15)="(DEP2)"; BAT(I)%KEY(15)="IPFILCOL"
 BAT(I)%LVL(16)="(DEP2)"; BAT(I)%KEY(16)="IPFLEGFILE"
 BAT(I)%LVL(17)="(DEP2)"; BAT(I)%KEY(17)="IPFLEGTEXT"
 BAT(I)%LVL(18)="(OPT)"; BAT(I)%KEY(18)="IFFFILE"
 BAT(I)%LVL(19)="(DEP)"; BAT(I)%KEY(19)="IFFLEGFILE"
 BAT(I)%LVL(20)="(DEP)"; BAT(I)%KEY(20)="IFFLEGTEXT"
 BAT(I)%LVL(21)="(OPT)"; BAT(I)%KEY(21)="NGEN"
 BAT(I)%LVL(22)="(DEP)"; BAT(I)%KEY(22)="GENFILE{i=1,NGEN}"
 BAT(I)%LVL(23)="(DEP)"; BAT(I)%KEY(23)="GENCOLOUR{i=1,NGEN}"
 BAT(I)%LVL(24)="(OPT)"; BAT(I)%KEY(24)="LEGSIZE"
 BAT(I)%LVL(25)="(OPT)"; BAT(I)%KEY(25)="WINDOW"
 BAT(I)%LVL(26)="(OPT)"; BAT(I)%KEY(26)="TITLE"
 BAT(I)%LVL(27)="(OPT)"; BAT(I)%KEY(27)="SUBTITLE"
 BAT(I)%LVL(28)="(OPT)"; BAT(I)%KEY(28)="FIGTXT"
 BAT(I)%LVL(29)="(OPT)"; BAT(I)%KEY(29)="PRJTXT"
 BAT(I)%LVL(30)="(OPT)"; BAT(I)%KEY(30)="YFRACLEGEND"
 BAT(I)%LVL(31)="(OPT)"; BAT(I)%KEY(31)="RESOLUTION"
 ...
 BAT(I)%CFUNC="IDFCALC"; BAT(I)%N= 14
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(14)="(OPT)"; BAT(I)%KEY(14)="TRIM_VALUE"
 ...
 BAT(I)%CFUNC="IDFMEAN"; BAT(I)%N= 13
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(13)="(OPT)"; BAT(I)%KEY(13)="OUTFILE"
 ...
 BAT(I)%CFUNC="IDFCONSISTENCY"; BAT(I)%N=  8
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(7)="(OPT)"; BAT(I)%KEY(7)="MINLAY_THICKNESS"
 BAT(I)%LVL(8)="(OPT)"; BAT(I)%KEY(8)="MINLTZERO_OPT"
 ...
 BAT(I)%LVL(11)="(OPT)"; BAT(I)%KEY(11)="GENFNAME"
 BAT(I)%LVL(12)="(OPT)"; BAT(I)%KEY(12)="IDFNAME"
 BAT(I)%LVL(13)="(OPT)"; BAT(I)%KEY(13)="HGLG3"
 ...
 BAT(I)%CFUNC="IPFSAMPLE"; BAT(I)%N=6  
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(6)="(OPT)"; BAT(I)%KEY(6)="IACOL"
 ...
 BAT(I)%CFUNC="XYZTOIDF"; BAT(I)%N= 26
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(16)="(DEP)"; BAT(I)%KEY(16)="MAXPNT"
 BAT(I)%LVL(17)="(DEP)"; BAT(I)%KEY(17)="RANGE"
 BAT(I)%LVL(18)="(DEP)"; BAT(I)%KEY(18)="SILL"
 BAT(I)%LVL(19)="(DEP)"; BAT(I)%KEY(19)="NUGGET"
 BAT(I)%LVL(20)="(DEP)"; BAT(I)%KEY(20)="KTYPE"
 BAT(I)%LVL(21)="(DEP)"; BAT(I)%KEY(21)="STDEVIDF"
 BAT(I)%LVL(22)="(DEP)"; BAT(I)%KEY(22)="LAGINTERVAL"
 BAT(I)%LVL(23)="(DEP)"; BAT(I)%KEY(23)="LAGDISTANCE"
 BAT(I)%LVL(24)="(DEP)"; BAT(I)%KEY(24)="HCLOSE"
 BAT(I)%LVL(25)="(DEP)"; BAT(I)%KEY(25)="RCLOSE"
 BAT(I)%LVL(26)="(DEP)"; BAT(I)%KEY(26)="NINNER"
 ...
 BAT(I)%CFUNC="CREATESOF"; BAT(I)%N=  10
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))

 BAT(I)%LVL(1)="(COMP)"; BAT(I)%KEY(1)="LEVELIDF"
 BAT(I)%LVL(2)="(COMP)"; BAT(I)%KEY(2)="SOFIDF"
 BAT(I)%LVL(3)="(OPT)"; BAT(I)%KEY(3)="IFLOW"
 BAT(I)%LVL(4)="(OPT)"; BAT(I)%KEY(4)="ASPECTIDF"
 BAT(I)%LVL(5)="(OPT)"; BAT(I)%KEY(5)="OUTLETIDF"
 BAT(I)%LVL(6)="(OPT)"; BAT(I)%KEY(6)="WINDOW"
 BAT(I)%LVL(7)="(OPT)"; BAT(I)%KEY(7)="CELLSIZE"
 BAT(I)%LVL(8)="(OPT)"; BAT(I)%KEY(8)="IGRAD"
 BAT(I)%LVL(9)="(OPT)"; BAT(I)%KEY(9)="IWRITE"
 BAT(I)%LVL(10)="(OPT)"; BAT(I)%KEY(10)="DISZONEIPF"
 ...
 BAT(I)%CFUNC="GEF2IPF"; BAT(I)%N=  5
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))

 BAT(I)%LVL(1)="(COMP)"; BAT(I)%KEY(1)="GEFDIR"
 BAT(I)%LVL(2)="(COMP)"; BAT(I)%KEY(2)="IPFFILE"
 BAT(I)%LVL(3)="(COMP)"; BAT(I)%KEY(3)="GEFTYPE"
 BAT(I)%LVL(4)="(OPT)"; BAT(I)%KEY(4)="WINDOW"
 BAT(I)%LVL(5)="(OPT)"; BAT(I)%KEY(5)="GENFILE"
 ...
 !###======================================================================
 SUBROUTINE BATCHINIT_DEVWELTOIPF(I)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: I

 BAT(I)%CFUNC="DEVWELLTOIPF"; BAT(I)%N=11
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))

 BAT(I)%LVL(1)="(COMP)"; BAT(I)%KEY(1)="CSVFNAME"
 BAT(I)%LVL(2)="(COMP)"; BAT(I)%KEY(2)="IPFFNAME"
 BAT(I)%LVL(3)="(OPT)";  BAT(I)%KEY(3)="NLCOL"
 BAT(I)%LVL(4)="(DEP)";  BAT(I)%KEY(4)="LCOL{i=1,NLCOL}"
 BAT(I)%LVL(5)="(OPT)";  BAT(I)%KEY(5)="NCOL"
 BAT(I)%LVL(6)="(OPT)";  BAT(I)%KEY(6)="XCOL"
 BAT(I)%LVL(7)="(OPT)";  BAT(I)%KEY(7)="YCOL"
 BAT(I)%LVL(8)="(OPT)";  BAT(I)%KEY(8)="ZCOL"
 BAT(I)%LVL(9)="(OPT)";  BAT(I)%KEY(9)="DCOL"
 BAT(I)%LVL(10)="(OPT)"; BAT(I)%KEY(10)="ICOL"
 BAT(I)%LVL(11)="(OPT)"; BAT(I)%KEY(11)="ACOL"
 
 END SUBROUTINE BATCHINIT_DEVWELTOIPF

 !###======================================================================
 SUBROUTINE BATCHINIT_IPFEVALUATE(I)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: I

 BAT(I)%CFUNC="IPFEVALUATE"; BAT(I)%N=7
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))

 BAT(I)%LVL(1)="(COMP)";  BAT(I)%KEY(1)="SOURCEDIR"
 BAT(I)%LVL(2)="(COMP)";  BAT(I)%KEY(2)="NIPF"
 BAT(I)%LVL(3)="(COMP)";  BAT(I)%KEY(3)="IPFFILE_OUT"
 BAT(I)%LVL(4)="(COMP)";  BAT(I)%KEY(4)="IPF{i=1,NIPF}"
 BAT(I)%LVL(5)="(COMP)";  BAT(I)%KEY(5)="HEADSDIR"
 BAT(I)%LVL(6)="(COMP)";  BAT(I)%KEY(6)="NLAY"
 BAT(I)%LVL(7)="(COMP)";  BAT(I)%KEY(7)="ITRANSIENT"
 
 END SUBROUTINE BATCHINIT_IPFEVALUATE 
