...
CONTAINS
 ...
 BAT(I)%LVL(6)="(OPT)"; BAT(I)%KEY(5)="IACOL"
 ...
 BAT(I)%LVL(7)="(OPT)"; BAT(I)%KEY(6)="CELLSIZE"
 BAT(I)%LVL(8)="(OPT)"; BAT(I)%KEY(7)="IGRAD"
 BAT(I)%LVL(9)="(OPT)"; BAT(I)%KEY(4)="IWRITE"
 BAT(I)%LVL(10)="(OPT)"; BAT(I)%KEY(4)="DISZONEIPF"
