...
CONTAINS
 ...
 BAT(I)%CFUNC="ISGGRID"; BAT(I)%N= 15
 ALLOCATE(BAT(I)%LVL(BAT(I)%N),BAT(I)%KEY(BAT(I)%N))
 ...
 BAT(I)%LVL(9)="(OPT)"; BAT(I)%KEY(9)="IPERIOD"
 BAT(I)%LVL(10)="(DEP)"; BAT(I)%KEY(10)="SDATE"
 BAT(I)%LVL(11)="(DEP)"; BAT(I)%KEY(11)="EDATE"
 BAT(I)%LVL(12)="(DEP)"; BAT(I)%KEY(12)="DDATE"
 BAT(I)%LVL(13)="(COMP)"; BAT(I)%KEY(13)="ICDIST"
 BAT(I)%LVL(14)="(COMP)"; BAT(I)%KEY(14)="ISIMGRO"
 BAT(I)%LVL(15)="(COMP)"; BAT(I)%KEY(15)="MINDEPTH"
 ...
 BAT(I)%LVL(5)="(COMP)"; BAT(I)%KEY(5)="CROSS-SECTION_IN"
