...
CONTAINS
 ...
 SELECT CASE (PBMAN%IFORMAT)
  ...
  CASE (5)
   ...
   READ(LINE,*) PBMAN%RESULT_DIR; IF(IBATCH.EQ.1)WRITE(*,'(A)') 'RESULT_DIR='//TRIM(PBMAN%RESULT_DIR)
 ...
 IF(PBMAN%ISOLVE.EQ.1)THEN
  SELECT CASE (PBMAN%IFORMAT)
   ...
   CASE (3)
    ...
    READ(LINE,*) PBMAN%MODFLOW6; IF(IBATCH.EQ.1)WRITE(*,'(A)') 'IMOD-WQ='//TRIM(PBMAN%MODFLOW6)
   !## seawat,mt3d
   CASE (4,5)
