...
!  WRITE(IU,'(A)') TRIM(LINE)
 ...
 ENDIF
 IBNDCHK=0; IFVDL=0
 WRITE(IU,'(12(I10,1X))') NLAY,MXNLAY,NPER,0,1,0,PBMAN%ICONCHK,N,PBMAN%UNCONFINED,IFVDL,IARMWP,IBNDCHK
...
! TOPICS(33)%TNAME='(PCG) Precondition Conjugate-Gradient'
 ...
 !## write bndfile
 WRITE(IU,'(A)') CHAR(39)//TRIM(BNDFNAME)//CHAR(39) !TRIM(TOPICS(4)%STRESS(1)%FILES(1,1)%FNAME)//CHAR(39)
...
!save_no_buf 
 ...
 ITOPIC=15; IF(.NOT.PMANAGER_SAVEMF2005_HFB_COMPUTE(IDF,ITOPIC,JU,TOP,BOT,BND,IPRT,IBATCH))RETURN
...
!     SIMGRO(ICOL,IROW)%BODEM=22
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_HFB_COMPUTE(IDF,ITOPIC,IU,TOP,BOT,BND,IPRT,IBATCH)
 !###======================================================================
 IMPLICIT NONE
 ...
 REAL :: NODATA,C,C1,C2,Z,ZZ,TPV,BTV,TFV,BFV
 INTEGER(KIND=1),ALLOCATABLE,DIMENSION(:,:,:) :: IPC
...
!     TFB,BFV
 ...
 SUBROUTINE PMANAGER_SAVEMF2005_HFB_GENFILES(IU,JU,IPC,IDF,NROW,NCOL,IROW,ICOL,N, &
                  C,RES,FDZ,ISYS,IT,LTB,TFV,BFV) !TOP,BOT)
 !###====================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF
