...
!  ENDDO
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_SAVEPST(IU)
 !###======================================================================
 IMPLICIT NONE
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_LOADPST(IU,NPARAM)
 !###======================================================================
 IMPLICIT NONE
 ...
 DO I=1,MAXTOPICS
  ...
  IF(I.EQ.20)THEN
   ...
   CALL PMANAGER_SAVEPST(IU); CYCLE
  ENDIF
...
!  CALL WDIALOGPUTSTRING(IDF_STRING1,MODELNAME)
 ...
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: DID,I,J,ISTEP,IROW,IROW1,IROW2
   ...
   CASE(PUSHBUTTON)
    SELECT CASE (MESSAGE%VALUE1)
     CASE (ID_APPLY)
      ...
      CALL PMANAGER_INSERTTIMES(IROW1,IROW2,I,ISTEP)
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_INSERTTIMES(IROW1,IROW2,IPERIOD,ISTEP)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IROW1,IROW2,IPERIOD,ISTEP
  ...
  IF(ITOPIC.GT.0)THEN
   IF(TOPICS(ITOPIC)%IACT.EQ.1)THEN
    ...
    IF(ITOPIC.EQ.20)THEN
     ...
     CALL PMANAGER_LOADPST(IU,NSYS); TOPICS(ITOPIC)%IACT_MODEL=1; CYCLE
    ENDIF
