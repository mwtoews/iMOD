...
!    JDI=UTL_IDATETOJDATE(IDATE)
 ...
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: IDY,IYR,IMH,ITOPIC,IPER,I,J,MINJD,MAXJD,IDATE,IHR,IMT,ISC,IHMS,MINHMS,MAXHMS,ISTEADY
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: IDF
 LOGICAL :: LEX
 ...
 CALL WDIALOGPUTMENU(IDF_MENU4,(/'Hourly  ','Daily   ','Weekly  ','Monthly ','Yearly  ','Packages','Custom  '/),7,7)
 CALL WDIALOGPUTMENU(IDF_MENU5,(/'Hourly  ','Daily   ','Weekly  ','Monthly ','Yearly  ','Packages','Inherit','Custom  '/),8,7)
