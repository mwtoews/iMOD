...
! CALL WDIALOGPUTREAL(IDF_REAL4,5808000.0,'(F15.7)') 
 ...
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: DID,I,ICOL,ICOL1,ICOL2,IROW,IROW1,IROW2
 ...
 CALL WDIALOGSHOW(-1,-1,0,3)
 IROW1=0; IROW2=0; ICOL1=0; ICOL2=0
  ...
  SELECT CASE (ITYPE)
   CASE(FIELDCHANGED)
    IF(MESSAGE%VALUE1.EQ.MESSAGE%VALUE2)THEN
     ...
     CALL WGRIDCOLOURCOLUMN(IDF_GRID1,3,-1,-1)
!     IF(MESSAGE%VALUE3.EQ.0)THEN
!     CALL WGRIDPOS(MESSAGE%X,ICOL,IROW1) !## from
     ...
     ELSEIF(ICOL.EQ.2)THEN
      IROW2=IROW
     ENDIF
     IF(IROW1.NE.0.AND.IROW2.NE.0)THEN
      DO IROW=IROW1,IROW2
       CALL WGRIDCOLOURROW(IDF_GRID1,IROW,-1,WRGB(255,0,0))
      ENDDO
      CALL WDIALOGPUTINTEGER(IDF_INTEGER1,IROW1)
      CALL WDIALOGPUTINTEGER(IDF_INTEGER2,IROW2)
