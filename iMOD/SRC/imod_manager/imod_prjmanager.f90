...
!    ICB=IRIVCB; CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
!   CASE (30); LEX=LSFR
!    CPCK='SFR'; ICB=ISFRCB; CMAXNO1='NaN1'; CMAXNO2='NaN2'; CAUX='NOPRINT'; TEXT='_'
!   CASE (31); LEX=LFHB; CPCK='FHB'; ICB=IFHBCB; CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT=''
!   CASE (32); LEX=LLAK
!  END SELECT
!
...
! !## read and save packages
!  IF(.NOT.PMANAGER_SAVEMF2005_PCK(IU,ITOPIC,BND,DIR,TRIM(CPCK)//'7\'//TRIM(CPCK),NP,LTB,TOP,BOT,KD,IBATCH,IFHBUN))RETURN
!  CLOSE(IU); IF(TEXT.NE.'')CALL PMANAGER_SAVEMF2005_MAXNO(TRIM(DIRMNAME)//'.'//TRIM(CPCK)//'7'//TRIM(TEXT),NP)
 ...
 !## correct drn with riv in case ichk=1
...
!   CALL PMANAGER_SAVEMF2005_EXPORT(EXFNAME,ISYS)
 ...
 CALL PMANAGER_SAVEMF2005_MAXNO(TRIM(DIRMNAME)//'.ISG7_',(/NP/))
 ...
 CHARACTER(LEN=52),ALLOCATABLE,DIMENSION(:) :: STRING
 INTEGER :: IU,JU,KU,ILAY,IROW,ICOL,I,KTOP,ISYS,NROWIPF,NCOLIPF,IEXT,IOS,KPER,IPER,NP,NTOP,NSYS,SCL_D,SCL_U,ICNST
 REAL,ALLOCATABLE,DIMENSION(:) :: TLP,KH,TP,BT
 INTEGER(KIND=8) :: ITIME,JTIME
 INTEGER,PARAMETER :: ICLAY=1 !## shift to nearest aquifer
 ...
 SELECT CASE (ITOPIC)
  CASE (21); CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
  CASE (22); CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
  CASE (23); CMAXNO1='NaN1'; CAUX='AUXILIARY INFFCT AUXILIARY SYSTEM NOPRINT'; TEXT='_'
  CASE (24); CMAXNO1=TRIM(ITOS(NEVTOP)); CAUX=''; TEXT=''
  CASE (25); CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
  CASE (26); CMAXNO1=TRIM(ITOS(NRCHOP)); CAUX=''; TEXT=''
  CASE (27); CPCK='OLF'; IF(.NOT.LDRN)CPCK='DRN'; CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
  CASE (28); CMAXNO1='NaN1'; CAUX='AUXILIARY SYSTEM NOPRINT'; TEXT='_'
 END SELECT

 LINE=TRIM(CMAXNO1)//','//TRIM(ITOS(ICB))//','//TRIM(CAUX)
 WRITE(IU,'(A)') TRIM(LINE)
...
!     IS1=0
   !## wel,drn,riv,ghb,chd,olf,isg,sfr,fhb
   CASE (21:23,25,27:32) 
