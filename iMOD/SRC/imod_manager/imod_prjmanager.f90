...
!     SIMGRO(ICOL,IROW)%BODEM=22
 ...
 DO IROW=1,NROW; DO ICOL=1,NCOL; DO ILAY=IL1,IL2
  ...
  IF(IPC(ICOL,IROW,1).EQ.INT(1,1))THEN
   IF(ICOL.LT.NCOL)THEN
    ...
    WRITE(IU,'(5I10,2G15.7,I10,2G15.7)') ILAY,IROW,ICOL,IROW,ICOL+1,HFBRESIS,FDZ,ISYS,TPV,BTV !## x-direction
  ...
  IF(IPC(ICOL,IROW,2).EQ.INT(1,1))THEN
   IF(IROW.LT.NROW)THEN
    ...
    !## write fault always, as it becomes confused 
    WRITE(IU,'(5I10,2G15.7,I10,2G15.7)') ILAY,IROW,ICOL,IROW+1,ICOL,HFBRESIS,FDZ,ISYS,TPV,BTV !## y-direction
 ...
 REAL :: NODATA,C,C1,C2,Z,ZZ,TPV,BTV
 INTEGER(KIND=1),ALLOCATABLE,DIMENSION(:,:,:) :: IPC
 ...
 DO ILAY=1,NLAY
  ...
  DO
   ...
   READ(JU,'(5I10,2G15.7,I10,2G15.7)',IOSTAT=IOS) JLAY,IR1,IC1,IR2,IC2,C,Z,ISYS,TPV,BTV
   IF(IOS.NE.0)EXIT
