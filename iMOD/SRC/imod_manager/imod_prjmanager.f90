...
!## cannot be here
 ...
 ELSE
  JTIME=SIM(IPER  )%IYR*10000000000+SIM(IPER  )%IMT*100000000+SIM(IPER-1)%IDY*1000000+ &
        SIM(IPER  )%IHR*10000      +SIM(IPER  )%IMT*100      +SIM(IPER-1)%ISC
  ITIME=JTIME
  IF(IPER.GT.1)THEN
   IF(SIM(IPER-1)%DELT.NE.0.0)THEN !## previous timestep steady-state
    ITIME=SIM(IPER-1)%IYR*10000000000+SIM(IPER-1)%IMT*100000000+SIM(IPER-1)%IDY*1000000+ &
