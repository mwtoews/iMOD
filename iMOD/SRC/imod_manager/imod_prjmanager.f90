...
!  ELSE
 ...
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: IDY,IYR,IMH,ITOPIC,IPER,I,J,MINJD,MAXJD,IOS,IDATE,IH,IM,IS,IHMS,MINHMS,MAXHMS
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: IDF
 LOGICAL :: LEX
  ...
  DO IPER=1,SIZE(TOPICS(ITOPIC)%STRESS)
   ...
   ELSE
    ...
    IF(IOS.EQ.0)THEN
     ...
     IHMS=HMSTOITIME(TOPICS(ITOPIC)%STRESS(IPER)%IH,TOPICS(ITOPIC)%STRESS(IPER)%IM,TOPICS(ITOPIC)%STRESS(IPER)%IS)
 ...
 ELSE
  ...
  CALL WDIALOGPUTINTEGER(IDF_INTEGER2,IDY)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER3,IYR)
  CALL ITIMETOHMS(MINHMS,IH,IM,IS)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER6,IH)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER7,IM)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER8,IS)

  CALL UTL_GDATE(MAXJD,IYR,IMH,IDY)
  CALL WDIALOGPUTMENU(IDF_MENU3,CDATE,12,IMH)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER4,IDY)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER5,IYR)
  CALL ITIMETOHMS(MAXHMS,IH,IM,IS)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER9,IH)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER10,IM)
  CALL WDIALOGPUTINTEGER(IDF_INTEGER11,IS)
 ENDIF
