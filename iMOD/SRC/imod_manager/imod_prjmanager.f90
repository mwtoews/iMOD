...
!   ENDIF
 ...
 DO ILAY=1,NLAY
  ...
  IF(IQUASIBED.EQ.1.OR.ILAY.EQ.NLAY)THEN
 ...
 IF(LLPF)THEN
  ...
  DO ILAY=1,NLAY
   ...
   !## quasi-3d scheme add bot aquifer modellayer
   IF(IQUASIBED.EQ.1.AND.ILAY.NE.NLAY)THEN
    !## kvv
...
!## cannot be here
 ...
 ELSE
  ITIME=STRESS(IPER)%IYR*10000000000+STRESS(IPER)%IMH*100000000+STRESS(IPER)%IDY*1000000+STRESS(IPER)%IHR*10000+STRESS(IPER)%IMT*100+STRESS(IPER)%ISC
  JTIME=STRESS(IPER)%IYR*10000000000+STRESS(IPER)%IMH*100000000+STRESS(IPER)%IDY*1000000+STRESS(IPER)%IHR*10000+STRESS(IPER)%IMT*100+STRESS(IPER)%ISC

  !## ISG not yet supports timescales less than 1 day
  SDATE=STRESS(IPER)%IYR*10000+STRESS(IPER)%IMH*100+STRESS(IPER)%IDY
 ...
 IF(SIM(IPER)%DELT.EQ.0.0)THEN !## steady-state
  KPER=PMANAGER_GETIPER(INT(0,8),INT(0,8),TOPICS(ITOPIC)%STRESS)   
 ELSE
  JTIME=SIM(IPER  )%IYR*10000000000+SIM(IPER  )%IMH*100000000+SIM(IPER)%IDY*1000000+ &
        SIM(IPER  )%IHR*10000      +SIM(IPER  )%IMT*100      +SIM(IPER)%ISC
  ITIME=JTIME
  IF(IPER.GT.1)THEN
   IF(SIM(IPER-1)%DELT.NE.0.0)THEN !## previous timestep steady-state
    ITIME=SIM(IPER-1)%IYR*10000000000+SIM(IPER-1)%IMH*100000000+SIM(IPER-1)%IDY*1000000+ &
          SIM(IPER-1)%IHR*10000      +SIM(IPER-1)%IMT*100      +SIM(IPER-1)%ISC
   ENDIF
  ENDIF
  KPER=PMANAGER_GETIPER(ITIME,JTIME,TOPICS(ITOPIC)%STRESS)
 ENDIF
...
!    ENDDO
   ELSE
    KTIME=STRESS(I)%IYR*10000000000+STRESS(I)%IMH*100000000+STRESS(I)%IDY*1000000+STRESS(I)%IHR*10000+STRESS(I)%IMT*100+STRESS(I)%ISC
