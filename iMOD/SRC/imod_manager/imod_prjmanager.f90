...
! IF(PMANAGER_SAVEMF2005_HFB)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)
  ...
  IF(IPC(ICOL,IROW,1).EQ.INT(1,1))THEN
   IF(ICOL.LT.NCOL)THEN
    ...
    DO ILAY=IL1,IL2
     ...
     IF(IWRITE.EQ.1)CALL PMANAGER_SAVEMF2005_HFBGENFILES(IUGEN(ILAY),IPC,IDF,NROW,NCOL,IROW,ICOL,ILAY) !,I,JLINE)
 ...
 IF(FCT.EQ.0.0)THEN
  PMANAGER_SAVEMF2005_HFBGETFACTOR=10.0E10*(1.0/DZ**2.0)
 ELSE
