...
!     IF(.NOT.LEX)CYCLE
 ...
 INTEGER,ALLOCATABLE,DIMENSION(:) :: MXFB
 
 PMANAGER_SAVEMF2005_HFB=.TRUE.

 !## compute block-faces
 ALLOCATE(IPC(IDF%NCOL,IDF%NROW,2),MXFB(NLAY)); MXFB=0
 ...
 DO ILAY=1,NLAY
  ...
  CALL PMANAGER_SAVEMF2005_HFBEXPORT(IPC,IDF%NROW,IDF%NCOL,FCT,MXFB(ILAY))
 ENDDO
...
! NHFBBMP=0
! NPHFB=
! WRITE(IU,'(3I10,A)') NPHFB,SUM(MXFB),NHFBNP,'NOPRINT'
! DO ILAY=1,NLAY
!  WRITE(IU,'(A)') 'OPEN/CLOSE '//TRIM(FNAME)//' 1.0 (FREE) -1'
! ENDDO
! !## read/clip/scale idf file
...
! IF(PMANAGER_SAVEMF2005_HFB)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)
 ...
 !###====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_HFBEXPORT(IPC,NROW,NCOL,HFBFCT,NHFB) !,IUHFB,JUHFB,NHFB,ILAY,JLINE)
 !###====================================================================
