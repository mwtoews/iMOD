...
!save_no_buf 
 ...
 INTEGER :: IU,ILAY,ITOPIC,NPHFB,MXFB
 ...
 ENDDO
 ITOPIC=15; IF(.NOT.PMANAGER_SAVEMF2005_HFB_COMPUTE(DIRMNAME,IDF,ITOPIC,IU,IUGEN,IUDAT,TOP,BOT,BND,KDW,IPRT,NHFBNP))RETURN
 DEALLOCATE(IUGEN,IUDAT)

 !## close hfb file
 CLOSE(IU)
 
 !## breuken aggregreren per modellaag weerstanden sommeren en fracties meenemen
...
! ENDIF
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_HFB_COMPUTE(DIRMNAME,IDF,ITOPIC,IU,IUGEN,IUDAT,TOP,BOT,BND,KD,IPRT,NHFBNP)
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 ...
 REAL :: FCT,IMP,CNST
 INTEGER :: ILAY,ISYS,IWRITE,ICNST
