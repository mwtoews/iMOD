...
KLOOP: DO K=1,SIZE(TOPICS(JJ)%STRESS(1)%FILES,1)
 ...
 IF(IMODE.EQ.1)THEN
  ...
  IF(LSFR)THEN
   ...
   WRITE(IU,'( A)')  'ECHO ISGFILE_IN= "'//TRIM(DIR)//'\'//TRIM(MNAME)//'\SFR7\SFR_T1.ISG" >> SFRTOISG.INI'
   WRITE(IU,'( A)')  'ECHO ISGFILE_OUT="'//TRIM(DIR)//'\'//TRIM(MNAME)//'\SFR7\SFR_RESULTS.ISG" >> SFRTOISG.INI'
   WRITE(IU,'(A/)')  'ECHO SFRFILE_IN= "'//TRIM(DIR)//'\TUT10_FSFR.TXT" >> SFRTOISG.INI'
!   WRITE(IU,'(A)')  ' SFRTOISG.INI'
  ENDIF
 ...
 IF(.NOT.LMODFLOW2005)WRITE(IU,'(A)') 'MET 11  '//CHAR(39)//TRIM(LINE)//'.MET7'//CHAR(39)
 WRITE(IU,'(A)') 'BAS6 12 '//CHAR(39)//TRIM(LINE)//'.BAS6'//CHAR(39)
 WRITE(IU,'(A)') 'DIS  13 '//CHAR(39)//TRIM(LINE)//'.DIS6'//CHAR(39)
 IF(LBCF) WRITE(IU,'(A)') 'BCF6 14 '//CHAR(39)//TRIM(LINE)//'.BCF6'//CHAR(39)
 IF(LLPF) WRITE(IU,'(A)') 'LPF  14 '//CHAR(39)//TRIM(LINE)//'.LPF7'//CHAR(39)
 IF(LPCG) WRITE(IU,'(A)') 'PCG  15 '//CHAR(39)//TRIM(LINE)//'.PCG7'//CHAR(39)
 IF(LPCGN)WRITE(IU,'(A)') 'PCGN 15 '//CHAR(39)//TRIM(LINE)//'.PCGN'//CHAR(39)
 IF(LSIP) WRITE(IU,'(A)') 'SIP  15 '//CHAR(39)//TRIM(LINE)//'.SIP'//CHAR(39)
          WRITE(IU,'(A)') 'OC   16 '//CHAR(39)//TRIM(LINE)//'.OC'//CHAR(39)
 IF(LRCH) WRITE(IU,'(A)') 'RCH  17 '//CHAR(39)//TRIM(LINE)//'.RCH7'//CHAR(39)
 IF(LEVT) WRITE(IU,'(A)') 'EVT  18 '//CHAR(39)//TRIM(LINE)//'.EVT7'//CHAR(39)
 IF(LDRN.OR.LOLF) WRITE(IU,'(A)') 'DRN  19 '//CHAR(39)//TRIM(LINE)//'.DRN7'//CHAR(39)
 IF(LRIV.OR.LISG) WRITE(IU,'(A)') 'RIV  20 '//CHAR(39)//TRIM(LINE)//'.RIV7'//CHAR(39)
 IF(LGHB) WRITE(IU,'(A)') 'GHB  21 '//CHAR(39)//TRIM(LINE)//'.GHB7'//CHAR(39)
 IF(LCHD) WRITE(IU,'(A)') 'CHD  22 '//CHAR(39)//TRIM(LINE)//'.CHD7'//CHAR(39)
 IF(LWEL) WRITE(IU,'(A)') 'WEL  23 '//CHAR(39)//TRIM(LINE)//'.WEL7'//CHAR(39)
 IF(LHFB) WRITE(IU,'(A)') 'HFB6 24 '//CHAR(39)//TRIM(LINE)//'.HFB7'//CHAR(39)
 IF(LSFR) WRITE(IU,'(A)') 'SFR  25 '//CHAR(39)//TRIM(LINE)//'.SFR7'//CHAR(39)
 IF(LFHB)THEN; WRITE(IU,'(A)') 'FHB  26 '//CHAR(39)//TRIM(LINE)//'.FHB7'//CHAR(39); IFHBUN=26; ENDIF
 ...
 IF(.NOT.LMODFLOW2005)THEN  
  !## construct pcg-file
  IU=UTL_GETUNIT(); CALL OSD_OPEN(IU,FILE=TRIM(DIR)//'.MET7',STATUS='UNKNOWN',ACTION='WRITE',FORM='FORMATTED'); IF(IU.EQ.0)RETURN
