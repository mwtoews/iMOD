...
CONTAINS
 ...
 IF(ITOPIC.EQ.20)THEN
  ...
  CALL PMANAGEROPEN_PEST(LNEW); RETURN
 ENDIF
 ...
 !###======================================================================
 SUBROUTINE PMANAGEROPEN_PEST(LNEW)
 !###======================================================================
 IMPLICIT NONE
   ...
   CASE(PUSHBUTTON)
    SELECT CASE (MESSAGE%VALUE1)
     ...
     CASE (ID_PARAMETERS)
      ...
      CALL WDIALOGPUTINTEGER(IDF_INTEGER10,N)
     CASE (ID_ZONES)
      CALL UTL_LISTOFFILES(PEST%IDFFILES,(/'*.IDF','','','','','Info'/),I,'Specify the files to be added to the package')
