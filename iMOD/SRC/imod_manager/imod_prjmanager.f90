...
! CHARACTER(LEN=512) :: LINE
 ...
 REAL :: HNOFLOW,STOPERROR,CONST,DLEAK,DDAY,DSEC
 ...
 IF(.NOT.PMANAGER_SAVEMF2005_DIS_READ())RETURN
 ...
 DO ILAY=1,NLAY
  ...
  IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
   IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))THEN
    IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(TOP(ILAY),ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,IINV))RETURN
  ...
  IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS))THEN
   IF(ASSOCIATED(TOPICS(ITOPIC)%STRESS(1)%FILES))THEN
    IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(BOT(ILAY),ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,IINV))RETURN
...
!  ENDDO
 ...
 !## write metaswap
 IF(LMSP)THEN
  IF(IBATCH.EQ.0)CALL WINDOWOUTSTATUSBAR(4,'Writing '//TRIM(DIRMNAME)//'.MSP7 ...')
  IF(IBATCH.EQ.1)WRITE(*,'(/1X,A)') 'Writing '//TRIM(DIRMNAME)//'.MSP7 ...'
  CALL PMANAGER_SAVEMF2005_MSP(IDF%NCOL,IDF%NROW,NLAY,HNOFLOW,IDF)
 ENDIF
 ...
 IF(LBCF)THEN
  ...
  DO ILAY=1,NLAY
   ...
   IF(ISS.EQ.1)THEN
    ...
    IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(IDF,ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,IINV))RETURN
    CALL PMANAGER_SAVEMF2005_CORRECT(ILAY,BND,IDF,0,ITOPIC)
    EXFNAME=TRIM(DIR)//'\BCF6\SF1_L'//TRIM(ITOS(ILAY))//FEXT(IIDEBUG)
    IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(EXFNAME,IDF,IINT,IU,HNOFLOW))RETURN
   ENDIF   
   !## kdw
   ITOPIC=6; SCL_D=1; SCL_U=3; IINV=0; IINT=0
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(KD(ILAY),ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,IINV))RETURN
   CALL PMANAGER_SAVEMF2005_CORRECT(ILAY,BND,KD(ILAY),0,ITOPIC)
   EXFNAME=TRIM(DIR)//'\BCF6\TRAN_L'//TRIM(ITOS(ILAY))//FEXT(IIDEBUG)
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(EXFNAME,KD(ILAY),IINT,IU,HNOFLOW))RETURN
...
!  WRITE(IULAK,'(A)') '# LAK7 File Generated by '//TRIM(UTL_IMODVERSION())
  ...
  DO I=1,9
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(LAK(I),ITOPIC,1,I,1,SCL_D,SCL_U,HNOFLOW,IINV))RETURN 
   IF(I.EQ.1)THEN
 ...
 !## construct bas6-file
 IF(.NOT.PMANAGER_SAVEMF2005_BAS(DIR,DIRMNAME,IBATCH,HNOFLOW,STOPERROR))RETURN
 !## use hfb
 ...
 DO ITOPIC=21,SIZE(TOPICS)
  ...
  IF(.NOT.PMANAGER_SAVEMF2005_PCK(IU,ITOPIC,BND,HNOFLOW,DIR,TRIM(CPCK)//'7\'//TRIM(CPCK),NP,LTB,TOP,BOT,KD,IBATCH,IFHBUN))RETURN
 ...
 DO ILAY=1,NLAY
  ...
  IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(BND(ILAY),ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,0))RETURN 
 ...
 DO ILAY=1,NLAY
  ...
  IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(SHD(ILAY),ITOPIC,1,1,ILAY,SCL_D,SCL_U,HNOFLOW,0))RETURN
 ...
 !####====================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_BAS(DIR,DIRMNAME,IBATCH,HNOFLOW,STOPERROR)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,DIRMNAME
 REAL,INTENT(IN) :: HNOFLOW,STOPERROR
 INTEGER,INTENT(IN) :: IBATCH
 INTEGER :: IU,ILAY

 PMANAGER_SAVEMF2005_BAS=.FALSE.
 ...
 DO ILAY=1,NLAY
  IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(TRIM(DIR)//'\BAS6\STRT_L'//TRIM(ITOS(ILAY))//FEXT(IIDEBUG), &
      SHD(ILAY),0,IU,HNOFLOW))RETURN
 ENDDO

 CLOSE(IU)

 PMANAGER_SAVEMF2005_BAS=.TRUE.

 END FUNCTION PMANAGER_SAVEMF2005_BAS

 !####====================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_DIS(DIR,DIRMNAME,IBATCH)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 DO ILAY=1,NLAY
  ...
  IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(EXFNAME,TOP(ILAY),IINT,IU,HNOFLOW))RETURN
  ...
  IF(LQBD.OR.ILAY.EQ.NLAY)THEN
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(EXFNAME,BOT(ILAY),IINT,IU,HNOFLOW))RETURN
  ENDIF
 ENDDO
 ...
 END FUNCTION PMANAGER_SAVEMF2005_DIS
...
!save_no_buf 
 ...
 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MSP(NCOL,NROW,NLAY,HNOFLOW,IDF)
 !####====================================================================
 IMPLICIT NONE
 ...
 DO ISYS=1,NIDF
  ...
  !## read in data
  IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ(IDF,ITOPIC,IPER,ISYS,ILAY,SCL_D,SCL_U,HNOFLOW,IINV))RETURN
 ...
 CALL PMANAGER_SAVEMF2005_MSP_CHECK(IDF,NCOL,NROW,NLAY,NODATA)
  
 ISYS=8
 CALL PMANAGER_SAVEMF2005_MSP_INPFILES(NROW,NCOL,NODATA(20),TOPICS(ITOPIC)%STRESS(IPER)%FILES(ISYS,ILAY)%FNAME,IDF,LPWT)
...
! CALL PMANAGER_SAVEMF2005_MSP_METEGRID()
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_MSP
...
! CHARACTER(LEN=256) :: LINE
 ...
 !###====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MSP_INPFILES(NROW,NCOL,NODATA_PWT,IPFFILE,IDF,LPWT)
 !###====================================================================
 IMPLICIT NONE
 LOGICAL :: LPWT
...
!   IF(M.LT.5)CALL PRINTTEXT('IPF for artificial recharge should be at least 5 column, x,y,ilay,id,capacity',2)
 ...
 !###====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MSP_CHECK(IDF,NCOL,NROW,NLAY,NODATA)
 !###====================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(IN) :: IDF
 INTEGER,INTENT(IN) :: NCOL,NROW,NLAY
...
! CHARACTER(LEN=256) :: LINE
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_PCK(IU,ITOPIC,BND,HNOFLOW,DIR,EXT,NP,LTB,TOP,BOT,KD,IBATCH,IFHBUN)
 !###======================================================================
 IMPLICIT NONE
...
!## cannot be here
   ...
   SELECT CASE (ITOPIC)
    CASE (21) !## wel
     ...
     IF(.NOT.PMANAGER_SAVEMF2005_PCK_ULSTRD(EXFNAME,PCK,NSYS,NTOP,IU,HNOFLOW,(/1/),NP,BND,TOP,BOT,KD,IPER,KPER,NPER,ITOPIC))RETURN
    CASE (22) !## drn
     EXFNAME=TRIM(DIR)//'\'//TRIM(EXT)//'_t'//TRIM(ITOS(IPER))//FEXT(IIDEBUG)
     IF(.NOT.PMANAGER_SAVEMF2005_PCK_ULSTRD(EXFNAME,PCK,NSYS,NTOP,IU,HNOFLOW,(/2,1/),NP,BND,TOP,BOT,KD,IPER,KPER,NPER,ITOPIC))RETURN
    CASE (23) !## riv
     EXFNAME=TRIM(DIR)//'\'//TRIM(EXT)//'_t'//TRIM(ITOS(IPER))//FEXT(IIDEBUG)
     IF(.NOT.PMANAGER_SAVEMF2005_PCK_ULSTRD(EXFNAME,PCK,NSYS,NTOP,IU,HNOFLOW,(/2,1,3,4/),NP,BND,TOP,BOT,KD,IPER,KPER,NPER,ITOPIC))RETURN
    CASE (24) !## evt
 ...
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_PCK_ULSTRD(EXFNAME,PCK,NSYS,NTOP,IU, &
            HNOFLOW,JTOP,NP,BND,TOP,BOT,KD,IPER,KPER,NPER,ITOPIC)
 !###======================================================================
...
! IF(PMANAGER_SAVEMF2005_HFB_COMPUTE)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_MOD_READ(IDF,ITOPIC,IPER,ISYS,ILAY,SCL_D,SCL_U,HNOFLOW,IINV) 
 !###======================================================================
 IMPLICIT NONE
 ...
 ENDIF
 IF(PMANAGER_SAVEMF2005_MOD_READ)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)

 END FUNCTION PMANAGER_SAVEMF2005_MOD_READ
 
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_MOD_READ_U2DREL(EXFNAME,IDF,IINT,IU,HNOFLOW)
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: EXFNAME
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF
 ...
 IF(MAXV.EQ.MINV)THEN
  ...
  IF(IINT.EQ.1)WRITE(IU,'(A)') TRIM(LINE)
 ...
 IF(IPER.EQ.0)THEN
  ...
  DO ILAY=1,NLAY
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(LINE,KD(ILAY),1,IULAK,-999.9))RETURN
  ENDDO
...
!      IF(ALLOCATED(KVA))C3=C3*1.0/KVA(ILAY)%X(ICOL,IROW)
  ...
  DO ILAY=1,NLAY
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_READ_U2DREL(LINE,KD(ILAY),0,IULAK,-999.9))RETURN
  ENDDO
