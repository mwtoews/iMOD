...
! CHARACTER(LEN=512) :: LINE
 ...
 CHARACTER(LEN=512) :: DIRMNAME,DIR  !,LINE
 INTEGER :: IU,IUBAS,IULAK,IPER,KPER,IERROR,SCL_D,SCL_U,IINT,ITOPIC,ILAY,ISS,IINV,NRCHOP,NEVTOP,ISFRCB2
 INTEGER :: ICB,IROW, &
   ICOL,ISTEADY,NHED,NFLW,IFHBUN,IFHBSS,NFHBX1,NFHBX2,NBDTIM,I,J,JD0,JD1,ISEC0,ISEC1,ILKCB
 INTEGER,DIMENSION(2) :: NP
 REAL :: HNOFLOW,STOPER,CONST,DLEAK,DDAY,DSEC
 CHARACTER(LEN=52) :: TEXT,CAUX,CMAXNO1,CMAXNO2,CPCK,MNAME
...
! ALLOCATE(KD (NLAY)); DO ILAY=1,SIZE(KD ); CALL IDFNULLIFY(KD (ILAY)); ENDDO
 ...
 CALL PMANAGER_SAVEMF2005_MET(DIR,DIRMNAME)
...
!  ENDDO
 ...
 IF(LMSP)THEN
  ...
  CALL PMANAGER_SAVEMF2005_MSP(IDF%NCOL,IDF%NROW,NLAY,HNOFLOW,BND,IDF)
 ENDIF
...
!  WRITE(IULAK,'(A)') '# LAK7 File Generated by '//TRIM(UTL_IMODVERSION())
  ...
  DO I=1,9
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD(LAK(I),ITOPIC,1,I,1,SCL_D,SCL_U,HNOFLOW,IINV))RETURN 
   IF(I.EQ.1)THEN
 ...
 !## construct bas6-file
 IUBAS=UTL_GETUNIT(); CALL OSD_OPEN(IUBAS,FILE=TRIM(DIRMNAME)//'.BAS6',STATUS='UNKNOWN',ACTION='WRITE',FORM='FORMATTED'); IF(IUBAS.EQ.0)RETURN
 WRITE(IUBAS,'(A)') '# BAS6 File Generated by '//TRIM(UTL_IMODVERSION())
 ...
 !## use hfb
 CALL PMANAGER_SAVEMF2005_HFB(IBATCH,DIRMNAME)
 !## use pcg
 CALL PMANAGER_SAVEMF2005_PCG(IBATCH,DIRMNAME)
 !## use pcgn
 CALL PMANAGER_SAVEMF2005_PCGN(IBATCH,DIRMNAME)
 !## use sip
 CALL PMANAGER_SAVEMF2005_SIP(IBATCH,DIRMNAME)
 !## construct oc-file
 CALL PMANAGER_SAVEMF2005_OCD(IBATCH,DIRMNAME)
 ...
 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MET(DIR,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
...
!save_no_buf 
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_MET

 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_HFB(IBATCH,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_HFB
 
 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_OCD(IBATCH,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_OCD
 
 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_PCG(IBATCH,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_PCG

 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_SIP(IBATCH,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_SIP

 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_PCGN(IBATCH,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 END SUBROUTINE PMANAGER_SAVEMF2005_PCGN
 ...
 !####====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MSP(NCOL,NROW,NLAY,HNOFLOW,BND,IDF)
 !####====================================================================
 IMPLICIT NONE
 ...
 ISYS=8
 CALL PMANAGER_SAVEMF2005_MSP_INPFILES(NROW,NCOL,NLAY,NODATA(20),TOPICS(ITOPIC)%STRESS(IPER)%FILES(ISYS,ILAY)%FNAME,IDF,LPWT)
...
! CHARACTER(LEN=256) :: LINE
 ...
 !###====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_MSP_INPFILES(NROW,NCOL,NLAY,NODATA_PWT,IPFFILE,IDF,LPWT)
 !###====================================================================
 IMPLICIT NONE
 LOGICAL :: LPWT
...
! IF(PMANAGER_SAVEMF2005_HFB_COMPUTE)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)
  ...
  IF(IPC(ICOL,IROW,1).EQ.INT(1,1))THEN
   IF(ICOL.LT.NCOL)THEN
    ...
    DO ILAY=IL1,IL2
     ...
     IF(IWRITE.EQ.1)CALL PMANAGER_SAVEMF2005_HFB_GENFILES(IUGEN(ILAY),IPC,IDF,NROW,NCOL,IROW,ICOL,ILAY)
 ...
 !###====================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_HFB_GENFILES(IU,IPC,IDF,NROW,NCOL,IROW,ICOL,ILAY) 
 !###====================================================================
 IMPLICIT NONE
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF
 INTEGER,INTENT(IN) :: NROW,NCOL,IROW,ICOL,ILAY,IU
 INTEGER(KIND=1),INTENT(IN),DIMENSION(NCOL,NROW,2) :: IPC 
 ...
 REAL :: THETA,SSCNCR,LVL,ILVL,C1,C2,C3,D,A
! CHARACTER(LEN=256) :: LINE
 ...
 IF(IPER.EQ.0)THEN
  ...
  DO ILAY=1,NLAY
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_U2DREL(LINE,KD(ILAY),1,IULAK,-999.9))RETURN
  ENDDO
...
!      IF(ALLOCATED(KVA))C3=C3*1.0/KVA(ILAY)%X(ICOL,IROW)
  ...
  DO ILAY=1,NLAY
   ...
   IF(.NOT.PMANAGER_SAVEMF2005_MOD_U2DREL(LINE,KD(ILAY),0,IULAK,-999.9))RETURN
  ENDDO
