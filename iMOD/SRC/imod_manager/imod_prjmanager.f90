...
LOGICAL,PRIVATE :: LBCF,LLPF,LPCG,LPCGN,LSIP,LRCH,LEVT,LDRN
...
KLOOP: DO K=1,SIZE(TOPICS(JJ)%STRESS(1)%FILES,1)
 ...
 INTEGER :: IHEDUN,IBCFCB,IRCHCB,IEVTCB,IDRNCB
 REAL :: HNOFLOW
 TYPE(IDFOBJ) :: IDF
  ...
  ELSE
   ...
   DO K=1,NTOP 
    ...
    DO ISYS=1,NSYS 
     ...
     CALL PMANAGER_SAVEMF2005_CORRECT(SCL_U,0,ILAY,BND,PCK(K,ISYS),HNOFLOW,FCT,IMP)
 ...
 CALL PMANAGER_SAVEMF2005_CORRECT(SCL_U,IINV,ILAY,BND,IDF,HNOFLOW,FCT,IMP)
 ...
 !###======================================================================
 SUBROUTINE PMANAGER_SAVEMF2005_CORRECT(SCL_U,IINV,ILAY,BND,IDF,HNOFLOW,FCT,IMP)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: SCL_U,IINV,ILAY
 REAL,INTENT(IN) :: HNOFLOW,FCT,IMP
 TYPE(IDFOBJ),INTENT(INOUT) :: IDF
 TYPE(IDFOBJ),INTENT(INOUT),DIMENSION(:) :: BND
 INTEGER :: IROW,ICOL
