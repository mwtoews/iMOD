...
KLOOP: DO K=1,SIZE(TOPICS(JJ)%STRESS(1)%FILES,1)
 ...
 INTEGER :: IHEDUN,IBCFCB,IRCHCB,IEVTCB,IDRNCB,IRIVCB,IGHBCB,ICHDCB,IWELCB,ISFRCB,ICB,IROW,ICOL,ISTEADY
 ...
 !## output unit numbers for sfr package
 ISFRCB=60
 !## detailed output
 ISFRCB2=0
  ...
  ELSE
   ...
   DO K=1,NTOP 
    ...
    SELECT CASE (ITOPIC)
     ...
     CASE (26) !## rch
      SCL_D=1; SCL_U=4
     CASE (22,23,25,27) !## drn,riv,ghb,chd,olf
...
! IF(PMANAGER_SAVEMF2005_HFB)CALL PMANAGER_SAVEMF2005_FCTIMP(IINV,ICNST,IDF,HNOFLOW,FCT,IMP)
 ...
 INTEGER :: ITYPE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER :: IDY,IYR,IMH,ITOPIC,IPER,I,J,K,MINJD,MAXJD,IDATE,IHR,IMT,ISC,IHMS,MINHMS,MAXHMS,ISTEADY,ISTEP
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: IDF
 LOGICAL :: LEX
