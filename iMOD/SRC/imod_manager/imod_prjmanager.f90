...
! CHARACTER(LEN=512) :: LINE
 ...
 IF(.NOT.PMANAGER_SAVEMF2005_LAK_SAVE(0,IBATCH,DIR,DIRMNAME))RETURN
 !## save hfb file
...
!  ENDDO
 ...
 !####====================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_LAK_SAVE(IPER,IBATCH,DIR,DIRMNAME)
 !####====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,DIRMNAME
