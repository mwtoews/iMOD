...
KLOOP: DO K=1,SIZE(TOPICS(JJ)%STRESS(1)%FILES,1)
 ...
 WRITE(IU,'(A)') '# BAS6 File Generated by iMOD V'//TRIM(RVERSION)
 WRITE(IU,'(A)') 'FREE'
 !## bnd settings
 ...
 WRITE(IU,'(A)') '# DIS File Generated by iMOD V'//TRIM(RVERSION)
 ...
 ELSE
  ...
  DO ISYS=1,NSYS
   ...
   IF(LISG)THEN
    ...
    IF(.NOT.ISG2GRID(EXFNAME,BND(1)%NROW,BND(1)%NCOL,NLAY,TOP,BOT,IBATCH))EXIT
