...
!save_no_buf 
 ...
 ENDDO
 ITOPIC=15; IF(.NOT.PMANAGER_SAVEMF2005_HFB_COMPUTE(DIRMNAME,IDF,ITOPIC,IU,IUGEN,IUDAT,TOP,BOT,BND,KDW,IPRT))RETURN
...
! ENDIF
 ...
 !###======================================================================
 LOGICAL FUNCTION PMANAGER_SAVEMF2005_HFB_COMPUTE(DIRMNAME,IDF,ITOPIC,IU,IUGEN,IUDAT,TOP,BOT,BND,KD,IPRT)
 !###======================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIRMNAME
 ...
 IF(LLPF)THEN
  WRITE(IU,'(2I10,A)') NPHFB,MXFB,'NaN1#, NOPRINT HFBFACT'
 ELSEIF(LBCF)THEN
  WRITE(IU,'(2I10,A)') NPHFB,MXFB,'NaN1#, NOPRINT HFBRESIS'
 ENDIF  
