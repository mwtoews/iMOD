...
KLOOP: DO K=1,SIZE(TOPICS(JJ)%STRESS(1)%FILES,1)
 ...
 IHEDUN=51; IBCFCB=52; IRCHCB=53; IEVTCB=54; IDRNCB=55; IRIVCB=56; IGHBCB=57; ICHDCB=58; IWELCB=59; ISFRCB=60
 ...
 IF(LSFR)WRITE(IU,'(A,I3,A)') 'DATA(BINARY) ',ISFRCB,' '//CHAR(39)//TRIM(LINE)//'_FSFR.DAT'//CHAR(39) 
