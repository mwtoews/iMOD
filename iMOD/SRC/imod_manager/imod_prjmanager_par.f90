...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW
  REAL :: XMIN,YMIN,XMAX,YMAX,CELLSIZE,BUFFER
  CHARACTER(LEN=256) :: TIMFNAME
 END TYPE PMANBATCH
 ...
 LOGICAL :: LBCF,LLPF,LPCG,LPCGN,LSIP,LRCH,LEVT,LDRN,LRIV,LGHB,LOLF,LCHD,LWEL,LISG,LPWT,LHFB,LMSP,LQBD,LSFR,LFHB
 
 REAL,DIMENSION(:,:),ALLOCATABLE :: FHBHED,FHBFLOW
