...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PERIODOBJ
  ...
  INTEGER,DIMENSION(2) :: IHR,IMT,ISC
 END TYPE PERIODOBJ
 ...
 TYPE SIMOBJ
  ...
  INTEGER :: IHR,IMT,ISC
 END TYPE SIMOBJ
 TYPE(SIMOBJ),POINTER,DIMENSION(:) :: SIM,SIM_C
 ...
 INTEGER :: NLAY,MXNLAY,IUNCONF,ISTEADY,IFORMAT,ISUBMODEL,NPER
 INTEGER,DIMENSION(4) :: IFULL
 LOGICAL :: LBCF,LLPF,LPCG,LPCGN,LSIP,LRCH,LEVT,LDRN,LRIV,LGHB,LOLF,LCHD,LWEL,LISG,LPWT,LHFB,LMSP
