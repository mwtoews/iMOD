...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,UNCONFINED,SSYSTEM,IPEST,ISTEADY,ICONCHK
  REAL :: XMIN,YMIN,XMAX,YMAX,CELLSIZE,BUFFER,NMULT,MINKD,MINC
  INTEGER,POINTER,DIMENSION(:) :: SAVESHD,SAVEFLX,SAVEUZF,SAVESFR,SAVEWEL,SAVEDRN,SAVERIV,SAVEGHB,SAVEMNW,SAVERCH,SAVEEVT,SAVELAK
 ...
 TYPE(IDFOBJ) :: IDF
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: BND,TOP,BOT,SHD,LAK,KHV,KVV,KVA,STO,SPY,KDW,VCW,LBD,LCD,PCK,ANA,ANF
