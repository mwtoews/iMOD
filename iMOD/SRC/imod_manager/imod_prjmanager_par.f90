...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,UNCONFINED,SSYSTEM,IPEST,ISTEADY,ICONCHK,ISAVEENDDATE
 ...
 INTEGER :: NLAY,MXNLAY,IFORMAT,ISUBMODEL,NPER  !IUNCONF
