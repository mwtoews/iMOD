...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE
  REAL :: XMIN,YMIN,XMAX,YMAX,CELLSIZE,BUFFER
 ...
 LOGICAL :: LBCF,LLPF,LPCG,LPCGN,LSIP,LRCH,LEVT,LDRN,LRIV,LGHB,LOLF,LCHD,LWEL,LISG,LPWT,LHFB,LMSP,LQBD,LSFR,LFHB,LLAK
 INTEGER :: IHEDUN,IBCFCB,IRCHCB,IEVTCB,IDRNCB,IRIVCB,IGHBCB,ICHDCB,IWELCB,ISFRCB,IFHBCB,ISFRCB2,IFHBUN,ILKCB
 
 REAL,DIMENSION(:,:),ALLOCATABLE :: FHBHED,FHBFLW
 REAL,DIMENSION(:),ALLOCATABLE :: FHBNBDTIM
 
 TYPE(IDFOBJ) :: IDF
 TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:) :: BND,TOP,BOT,SHD,LAK,KHV,KVV,KVA,KD,LBD,LCD,PCK
! TYPE(IDFOBJ),ALLOCATABLE,DIMENSION(:,:) :: PCK 

 REAL,DIMENSION(:),ALLOCATABLE :: ULAKES,DULAKES
 INTEGER :: NLAKES

! INTEGER,SAVE :: MXITER=500
! INTEGER,SAVE :: ITER1=20
 INTEGER,SAVE :: IIDEBUG=0
! REAL,SAVE :: HCLOSE=0.1E-3
! REAL,SAVE :: RCLOSE=0.1E-1
! REAL,SAVE :: RELAX=0.98
! INTEGER,SAVE :: NPCOND=1
 REAL,SAVE :: MINTHICKNESS=0.001
 CHARACTER(LEN=52),SAVE :: MODELNAME='Model'
 CHARACTER(LEN=4),DIMENSION(0:2) :: FEXT
 DATA FEXT/'.ARR','.ASC','.IDF'/
