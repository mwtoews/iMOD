...
MODULE MOD_PMANAGER_PAR
 ...
 TYPE PMANBATCH
  ...
  INTEGER :: ITT,IDT,ISS,IFORMAT,IWINDOW,ISOLVE,NSTEP,UNCONFINED,SSYSTEM,IPEST,ISTEADY,ICONCHK,ISAVEENDDATE,IFVDL
  REAL :: XMIN,YMIN,XMAX,YMAX,CELLSIZE,BUFFER,NMULT,MINKD,MINC,BUFFERCS
  ...
  CHARACTER(LEN=256) :: TIMFNAME,MODFLOW,BNDFILE
 END TYPE PMANBATCH
 ...
 INTEGER :: NLAY,MXNLAY,IFORMAT,ISUBMODEL,NPER
 ...
 LOGICAL :: LBCF,LLPF,LPCG,LPCGN,LSIP,LRCH,LEVT,LDRN,LRIV,LGHB,LOLF,LCHD,LWEL,LISG,LPWT,LHFB,LMSP,LQBD,LSFR, &
            LFHB,LLAK,LMNW,LUZF,LPST,LANI,LSFT
