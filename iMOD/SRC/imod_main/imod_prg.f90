...
USE MOD_3D, ONLY : IMOD3D_INTERPOLATOR,IMOD3D_MAIN_MESSAGES
USE MOD_3D_DISPLAY, ONLY : IMOD3D_DISPLAY
USE MOD_3D_PAR, ONLY : IWIN
USE MOD_PLINES_PAR, ONLY : PL
USE MOD_PLINES_TRACE, ONLY : TRACE_3D_COMPUTE
USE MOD_3D_SETTINGS, ONLY : IMOD3D_SETTINGSMAIN_STOP
USE MOD_DEMO
USE IMOD
...
IF(LEXPDATE)THEN
 ...
 IF(JD(IY,IM,ID).GE.UTL_IDATETOJDATE(EXPDATE))THEN
...
!         ENDIF
 ...
 SELECT CASE(MESSAGE%WIN)
  ...
  CASE(ID_D3DSETTINGS,ID_D3DSETTINGS_TAB1,ID_D3DSETTINGS_TAB2,ID_D3DSETTINGS_TAB3,ID_D3DSETTINGS_TAB4,ID_D3DSETTINGS_TAB5, &
       ID_D3DSETTINGS_TAB6,ID_D3DSETTINGS_TAB7,ID_D3DSETTINGS_TAB8)
   CALL IMOD3D_MAIN_MESSAGES(ITYPE,MESSAGE)
 ...
 IF(PL%IRUN.EQ.1)THEN
  ...
  IF(.NOT.TRACE_3D_COMPUTE())THEN
   CALL IMOD3D_SETTINGSMAIN_STOP() !EXIT
  ELSE
