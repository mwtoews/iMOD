...
USE MOD_3D, ONLY : IMOD3D_SETTINGSMAIN,IMOD3D_INTERPOLATOR,IMOD3D_MAIN_MESSAGES
USE MOD_3D_SETTINGS, ONLY : IMOD3D_HORIZONTALAXES
...
CALL WINDOWOPEN(FLAGS=SYSMENUON+MINBUTTON+MAXBUTTON+STATUSBAR+MAXWINDOW, &
                TITLE='iMOD ['//TRIM(BVERSION)//'; '//TRIM(CCONFIG)//']')
...
DO
 ...
 SELECT CASE(MESSAGE%WIN)
  ...
  CASE(ID_D3DSETTINGS,ID_D3DSETTINGS_TAB1,ID_D3DSETTINGS_TAB2,ID_D3DSETTINGS_TAB3,ID_D3DSETTINGS_TAB4,ID_D3DSETTINGS_TAB5, &
       ID_D3DSETTINGS_TAB6,ID_D3DSETTINGS_TAB7)
   CALL IMOD3D_MAIN_MESSAGES(ITYPE,MESSAGE)
