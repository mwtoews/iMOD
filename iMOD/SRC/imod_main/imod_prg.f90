...
USE MOD_UTL, ONLY : INFOUNITS,UTL_CAP,UTL_CREATEDIR,JD,UTL_IDATETOJDATE,ITOS,UTL_IMODVERSION !,UTL_GET_ANGLE
...
!WRITE(*,*) UTL_GET_ANGLE((/0.0,0.0,-1.0/),(/0.0,1.0,1.0/))
!CALL UTL_GET_ANGLES(1.0,0.0,0.0,RX,RY,RZ)
!CALL UTL_GET_ANGLES(0.0,1.0,0.0,RX,RY,RZ)
!CALL UTL_GET_ANGLES(0.0,0.0,1.0,RX,RY,RZ)
!CALL UTL_GET_ANGLES(1.0,1.0,1.0,RX,RY,RZ)
