...
!USE MOD_UTL, ONLY : CTIMETOFTIME,FTIMETOCTIME
...
!genfname='d:\IMOD-MODELS\BGK\DBASE\HOR_BARRIER_FLOW\VERSION_1\HFB_L1.GEN'
!call puzzlemain()

!CTIME='23:54:34'
!F=CTIMETOFTIME(CTIME)
!CALL FTIMETOCTIME(F,CTIME)
