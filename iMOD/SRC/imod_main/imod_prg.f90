...
USE MOD_UTL, ONLY : UTL_CAP,UTL_CREATEDIR,JD,UTL_IDATETOJDATE,ITOS,UTL_IMODVERSION,UTL_MINTHICKNESS
...
DO
 ...
 SELECT CASE(MESSAGE%WIN)
  ...
  CASE (ID_DMSPANALYSER,ID_DMSPANALYSER_TAB1,ID_DMSPANALYSER_TAB2,ID_DMSPANALYSER_TAB3,ID_DMSPANALYSER_TAB4)
