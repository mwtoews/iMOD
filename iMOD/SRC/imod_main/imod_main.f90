...
USE MODPLOT
USE MOD_UTL, ONLY : IMESSAGE,UTL_WSELECTFILE,ICDEBUGLEVEL,UTL_DEBUGLEVEL
...
!## adjust show-mode segments
 CASE(ID_ISGNODES,ID_ISGCLCNODES,ID_ISGCRSSCTNS,ID_ISGSEGNODES,ID_ISGSTUWEN,ID_ISGQHR,ID_ISGSFR)
...
!## pathlines
 ...
 CASE (ID_CREATEIPF)
  CALL CREATEIPF1INIT()
 CASE (ID_ISGCREATERIV,ID_ISGCREATESFR)
