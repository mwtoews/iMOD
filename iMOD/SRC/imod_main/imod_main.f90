...
ELSE
 ...
 OFFSTTXT=OFFSTTXT*2.0D0  !*0.5D0
 
 IW=WINFODRAWABLE(DRAWABLEWIDTH)
 IH=WINFODRAWABLE(DRAWABLEHEIGHT)
 IX1=AX_XP1*IW-OFFSTTXT
 IX2=AX_XP2*IW+OFFSTTXT
 IY1=AX_YP1*IH-OFFSTTXT
 IY2=AX_YP2*IH+OFFSTTXT
...
CALL INFOUNITS(FNAME,UNITS,NOPEN)
IF(NOPEN.EQ.0)THEN
...
CALL WDIALOGLOAD(ID_DFILESOPEN)
...
END SUBROUTINE IMOD1LISTOPENFILES
