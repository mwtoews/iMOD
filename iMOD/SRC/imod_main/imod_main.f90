...
USE MOD_PLUGIN, ONLY : PLUGIN_MAIN,PLUGIN_EXE,PLUGIN_EXE_CHECK_RUN,PLUGIN_INITMENU_RUN,PLUGIN_INITMENU_TIMECHECK
...
!## Plugin tool manager
 CASE(ID_TI1,ID_TI2,ID_TI3,ID_TI4) 
  ...
  CALL WMENUSETSTATE(MESSAGE%VALUE1,2,1)   
  CALL PLUGIN_INITMENU_TIMECHECK()  
...
CALL WMESSAGETIMER(TI*1000,ID=2,IREPEAT=1)  !Interval minute, plugin
