...
IF(IDEMO.EQ.1)THEN
 WRITE(IU,'(A8,A)') 'FUNCTION=',DEMO%TDNAME
 WRITE(IU,'(I10 )') DEMO%NXY
 DO I=1,DEMO%NXY; WRITE(IU,*) DEMO%X(I),DEMO%Y(I); ENDDO
ENDIF
WRITE(IU,'(50A1)') ('D',K=1,50)
...
DO
 ...
 DO 
  ...
  IF(I.LE.MAXDEMOKEYS)THEN
   ...
   !#LOOP INBOUWEN DIE CHECKT OF DE BETREFFENDE VARIABELEN AANWEZIG ZIJN
   DO I=1,DEMO%NXY
    READ(IU,*,IOSTAT=IOS) DEMO%X(I),DEMO%Y(I)
    IF(IOS.NE.0)EXIT
   ENDDO   
