...
!  IF(TRACE_3D_INIT('d:\IMOD-MODELS\IBRAHYM_V2.0\iMOD\IMOD_USER\RUNFILES\erfverband.run'))CALL IMOD3D_INIT(0,1)
  IF(TRACE_3D_INIT('d:\IMOD-MODELS\SANFRANSISCO\IMOD_USER\RUNFILES\imodpath.run'))CALL IMOD3D_INIT(0,1)
