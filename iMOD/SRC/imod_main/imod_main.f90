...
USE MOD_PLUGIN, ONLY : PLUGIN_MAIN,PLUGIN_EXE,PLUGIN_EXE_CHECK_RUN
...
!## Plugin tool manager
 ...
 CASE(ID_PLUGIN1,ID_PLUGIN2,ID_PLUGIN3,ID_PLUGIN4,ID_PLUGIN5, &
  ...
  CALL PLUGIN_EXE_CHECK_RUN(1)
  !CALL WMESSAGETIMER(120*1000,IREPEAT=1)  !minutes
...
WRITE(IU,'(A/)') 'IMOD META-FILE '//TRIM(RVERSION)
...
IMESSAGE(TIMEREXPIRED)=2
CALL WMESSAGETIMER(120*1000,IREPEAT=1)  !2 minute
