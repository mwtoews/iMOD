...
DO
 ...
 READ(LINE,'(3X,I2)') TI
 SELECT CASE (TI)
  CASE (60);    CALL WMENUSETSTATE(ID_TI1,2,0)
  CASE (30);    CALL WMENUSETSTATE(ID_TI2,2,0)
  CASE (15);    CALL WMENUSETSTATE(ID_TI3,2,0)
  CASE (1);     CALL WMENUSETSTATE(ID_TI4,2,0)
  CASE DEFAULT; CALL WMENUSETSTATE(ID_TI1,2,0)
 END SELECT
