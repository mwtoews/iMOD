...
USE MOD_PLUGIN, ONLY : PLUGIN_MAIN,PLUGIN_EXE,PLUGIN_EXE_CHECK_RUN,PLUGIN_UPDATEMENU_RUN
...
CALL WMESSAGETIMER(45*1000,ID=2,IREPEAT=1)  !0.75 minute, plugin
