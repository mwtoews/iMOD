  ...
  IF(I.LE.MAXMPKEYS)THEN
   ...
   SELECT CASE (I)
    CASE (1)
     ...
     MP(IPLOT)%IDFNAME=UTL_SUBST(MP(IPLOT)%IDFNAME,TRIM(REPLACESTRING),PREFVAL(5))
    CASE (2)
  ...
  IF(I.LE.MAXGENKEYS)THEN
   ...
   SELECT CASE (I)
    CASE (1)
     ...
     GEN(IPLOT)%GENFNAME=UTL_SUBST(GEN(IPLOT)%GENFNAME,TRIM(REPLACESTRING),PREFVAL(5))
    CASE (2)
  ...
  IF(I.LE.MAXBMPKEYS)THEN
   ...
   SELECT CASE (I)
    CASE (1)
     ...
     BMP(IPLOT)%BMPFNAME=UTL_SUBST(BMP(IPLOT)%BMPFNAME,TRIM(REPLACESTRING),PREFVAL(5))
    CASE (2)
