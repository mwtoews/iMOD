...
USE MOD_COLOURS
USE MODPLOT
USE MOD_UTL, ONLY : ITOS,UTL_GETUNIT,UTL_CREATEDIR,UTL_IMODFILLMENU,UTL_WSELECTFILE,UTL_RELPATHNAME
USE MOD_PREF_PAR
...
!   IRGB=IRGB*255.0
   ICOLOR(I)=COLOUR_RANDOM() !WRGB(INT(IRGB(1)),INT(IRGB(2)),INT(IRGB(3)))
  END DO
  DEALLOCATE(IRGB)
