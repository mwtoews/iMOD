...
! CALL WDIALOGRANGEINTEGER(IDF_INTEGER2,1,32000) !32767=max binnen winteracter
 CALL WDIALOGRANGEINTEGER(IDF_INTEGER3,1,500000)!5000) !MAX. BINNEN WINTERACTER!
 CALL WDIALOGRANGEINTEGER(IDF_INTEGER4,1,150)   !mxmplot
! CALL WDIALOGSPINNERSTEP(IDF_INTEGER1,1,1)
