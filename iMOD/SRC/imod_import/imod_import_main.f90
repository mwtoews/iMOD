...
USE MOD_UTL, ONLY : ITOS,UTL_IDATETOJDATE,UTL_FILLDATES,UTL_CAP,UTL_MESSAGEHANDLE,UTL_CLOSEUNITS,UTL_WSELECTFILE,UTL_GETHELP,UTL_DIALOGSHOW
USE DATEVAR
USE MOD_PREF_PAR, ONLY : PREFVAL

REAL(KIND=DP_KIND),PRIVATE,PARAMETER :: NODATA=-999.99
...
CONTAINS
 ...
 CALL WDIALOGUNDEFINED(DVALUE=NODATA)
    ...
    CASE (PUSHBUTTON)
     SELECT CASE (MESSAGE%VALUE1)
      ...
      CASE (IDCANCEL)
       EXIT
      CASE (IDHELP)
       CALL UTL_GETHELP('5.5.2','TMO.IT.Modflow')
    END SELECT
 ...
 IF(LEX)THEN
  ...
  CALL WDIALOGPUTSTRING(IDF_LABEL8,TRIM(RUNFILE)//' does exist already')
 ENDIF
