...
CONTAINS
 ...
 !###====================================================================
 SUBROUTINE IMPORT_MF2005_MAIN(MFFNAME,OUTNAME)
 !###====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: MFFNAME,OUTNAME
 CHARACTER(LEN=3) :: EXT
 INTEGER :: IU,KU,IOS,I
...
! READ(IU,*) LINE
! LINE=UTL_CAP
! coord_xll 120000.0D0
!coord_yll 298000.0D0
...
! CALL IOSDIRCHANGE('g:\IMOD-MODELS\IBRAHYM_V2.0\DBASE_DLD\IMOD_USER\MODELS\IBRAHYM_V2.0.5_25_NAM\MODELINPUT')
! CALL SYSTEM('DIR')
 ...
 SELECT CASE (EXT)
  CASE ('WEL') 
   CALL IMPORT_MF2005_WEL(IU,KU)
 END SELECT
 
 END SUBROUTINE IMPORT_MF2005_MAIN
 
 !###====================================================================
 SUBROUTINE IMPORT_MF2005_WEL(IU,KU)
 !###====================================================================
 IMPLICIT NONE
