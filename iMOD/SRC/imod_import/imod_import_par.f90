...
INTEGER :: MVERSION
REAL(KIND=DP_KIND) :: XMIN,YMIN,YMAX
REAL(KIND=DP_KIND) :: FT,FL !## transformation factors itminu en ilmuni
INTEGER :: ISUMPCK
...
REAL(KIND=DP_KIND),DIMENSION(:),ALLOCATABLE :: DELR,DELC,TRPY
REAL(KIND=DP_KIND) :: HNOFLOW,HCLOSE,RCLOSE,RELAX
INTEGER,SAVE :: NLAY,ITMUNI,IURUN,MAXITER,NITER,IWDFLG
INTEGER,DIMENSION(:),ALLOCATABLE :: NSTP
REAL(KIND=DP_KIND),DIMENSION(:),ALLOCATABLE :: TPER
REAL(KIND=DP_KIND),DIMENSION(:),ALLOCATABLE :: DTPER,TSMULT
