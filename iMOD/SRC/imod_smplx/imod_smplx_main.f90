...
CONTAINS
 ...
 INTEGER :: POS,I,IND,ITER,J,XDIM,K  !NUMLE,NUMGE
 REAL (DP) :: Z,RERR
 INTEGER,ALLOCATABLE,DIMENSION(:) :: IBASIS !,CONSTR_TYPE
 REAL (DP), ALLOCATABLE,DIMENSION(:,:) :: BI !,A
 REAL (DP), ALLOCATABLE,DIMENSION(:) :: X,TEMP,IMULT !,B,C
 REAL :: XX
 INTEGER ::  KA,N0
