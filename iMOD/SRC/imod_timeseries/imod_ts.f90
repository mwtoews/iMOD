...
USE WINTERACTER
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_CAP,IDATETOJDATE,JDATETOIDATE,UTL_WAITMESSAGE,ITOS,RTOS,UTL_MESSAGEHANDLE,UTL_CREATEDIR
...
CONTAINS
 ...
 JD1 =IDATETOJDATE(JD1)
 !## convert to julian date
 JD2 =IDATETOJDATE(JD2)
 ...
 ALLOCATE(OBS(NPER))
 DO I=1,NPER
  OBS(I)%IDATE=JDATETOIDATE(JD1+I-1)
 END DO
 ALLOCATE(IPER(NPER))
