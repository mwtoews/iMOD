...
CONTAINS
 ...
 IF(LPROF.AND.ASSF(IASSF)%ITOPIC.GT.1)THEN
  ...
  CALL IPFDRAW_DRILLPROF(IASSF,XLOC,DX,PLOTSTYLE,D,XY,YDIS,IFADEOUT,TWIDTH,THEIGHT)
  RETURN
 ENDIF
...
!   ENDIF
 ...
 !###===============================================================================
 SUBROUTINE IPFDRAW_DRILLPROF(IASSF,XLOC,WIDTH,PLOTSTYLE,D,XY,YDIS,IFADEOUT,TWIDTH,THEIGHT)
 !###===============================================================================
 IMPLICIT NONE
