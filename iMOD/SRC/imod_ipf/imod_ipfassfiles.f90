...
USE MOD_UTL, ONLY : UTL_GETUNIT,ITOS,IDATETOJDATE,UTL_DRAWLEGENDBOX,ITIMETOFTIME,UTL_SETTEXTSIZE,UTL_CAP
...
!  XW=0.5*(IWIDTH/MXW) 
 ...
 DO I=1,NLITHO; IF(TRIM(UTL_CAP(ASSF(IASSF)%L(ICOLUMN,IROW),'U')).EQ.TRIM(UTL_CAP(BH(I)%LITHO,'U')))EXIT; END DO
