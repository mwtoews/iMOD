...
10 CONTINUE
 ...
 INTEGER :: I,J,IU,JU,KU,ILAY,KLAY,IEXT,NCOL,NROW,MROW,MCOL,N,JLAY,FLAG,IX,IY,IM,IL,IH
 ...
 DO I=1,NROW
  ...
  HDIFF=ND; DO ILAY=1,NLAY
   READ(STRING(ICOLS(IH)-1+ILAY),*) H1
   IF(H1.NE.ND)HDIFF(ILAY)=H1-H0
  ENDDO
