...
10 CONTINUE
 ...
 IU=UTL_GETUNIT(); OPEN(KU,FILE=INIPF,STATUS='OLD',ACTION='READ')
 DIR=INIPF(:INDEX(INIPF,'\',.TRUE.)-1)
 JU=UTL_GETUNIT(); OPEN(LU,FILE=OUTIPF,STATUS='UNKNOWN',ACTION='WRITE')
 ...
 WRITE(KU,'(A)') TRIM(ITOS(IEXT))//','//TRIM(TXT)
