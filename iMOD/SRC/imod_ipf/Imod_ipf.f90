...
10 CONTINUE
 ...
 IF(PIATTRIB.NE.0)THEN
  ...
  ENDIF
  J=MAX(1,J)
  CALL WGRTEXTSTRING(X,Y+(1.5*DY),TRIM(IPF(IIPF)%INFO(PIATTRIB,I)(J:)))
 ENDIF
 ...
 !###===============================================================================
 SUBROUTINE IPFPLOTLABEL(X,Y,STRING,IATTRIB,NATTRIB,TWIDTH,THEIGHT,ATTRIB,LPROF,IEQ,GANGLE)
 !###===============================================================================
 IMPLICIT NONE
 ...
 REAL,INTENT(IN) :: X,Y
 REAL,INTENT(IN),OPTIONAL :: GANGLE
...
!  CALL WGRTEXTORIENTATION(ALIGNLEFT,ANGLE=90.0)
  IF(PRESENT(GANGLE))THEN
   CALL WGRTEXTORIENTATION(ALIGNLEFT,ANGLE=GANGLE)
  ELSE
   CALL WGRTEXTORIENTATION(ALIGNLEFT,ANGLE=90.0)
  ENDIF
 ...
 IF(IPF(IIPF)%ACOL.LT.0)THEN
  IPF(IIPF)%PCOL   =0
 ELSE
  IPF(IIPF)%PCOL   =IPF(IIPF)%ACOL !##Liduin
 ENDIF
