...
CONTAINS
 ...
 !# initial values
 BH%LITHO=''; BH%LITHOCLR=WRGB(255,255,255); BH%LITHOWIDTH=1.0; BH%LITHOTXT=''
 ...
 DO I=1,MAXNROW 
  ...
  IF(BH(I)%LITHO.NE.''.AND.BH(I)%LITHOCLR.GE.0)THEN
   ...
   BH(J)%LITHOWIDTH=MAX(0.0,BH(I)%LITHOWIDTH)
 ...
 ELSEIF(ID.EQ.ID_OPEN)THEN
  ...
  DO
   ...
   IF(IOS.NE.0)EXIT; NLITHO=NLITHO+1
  ENDDO
  IF(NLITHO.GT.0)THEN
   ...
   DO
    ...
    IF(IOS.NE.0)THEN
     ...
     ENDIF
    ENDIF
    BH(I)%LITHOWIDTH=MAX(0.0,BH(I)%LITHOWIDTH)
