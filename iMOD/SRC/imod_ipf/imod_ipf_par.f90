...
INTEGER,ALLOCATABLE,DIMENSION(:),SAVE :: GRAPHLINESCOLOUR,GRAPHLINESONOFF,GRAPHLINESTHICKNESS,GRAPHLINESNEGATIVE,GRAPHLINESSCALED
REAL,ALLOCATABLE,DIMENSION(:),SAVE :: SCALED
INTEGER,PARAMETER :: GRAPHMAXLINES=10
INTEGER,SAVE :: GRAPHLINESXAXES,GRAPHLINESYAXES,GRAPHLINESSCALE
