...
USE MOD_UTL, ONLY : ITOS,RTOS,UTL_CLOSEUNITS,EQUALNAMES,UTL_CAP,UTL_MESSAGEHANDLE,UTL_WAITMESSAGE,UTL_GETUNIT,UTL_MESSAGEHANDLE, &
                    UTL_HIDESHOWDIALOG,IDFPLOT1BITMAP,IDFPLOT2BITMAP,UTL_INSIDEPOLYGON,UTL_MEASUREMAIN
...
USE MOD_IPF_PAR
USE MOD_IPF, ONLY : IPFREAD,IPFINIT,IPFPLOTPOINT  
...
! CALL IGRPLOTMODE(MODECOPY)
 ...
 SELECT CASE (MESSAGE%WIN)
  ...
  CASE (ID_DIPFINFO)
   SELECT CASE (MESSAGE%VALUE1)
    CASE (IDHELP)
      CALL IMODGETHELP('4.2.3','MMO.IPO.IPFAna')
    CASE (IDCANCEL)
     IEXIT=1
   END SELECT
 ...
 CASE (ID_DIPFINFO_TAB3)
  SELECT CASE (MESSAGE%VALUE1)
   CASE (ID_OPEN,ID_SAVEAS)
    ...
    CALL IPFGETVALUE_OPENSAVECOLOURS('',MESSAGE%VALUE1,ID_DIPFINFO_TAB3,ILEG)
  END SELECT
 ...
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: IIPF,I,J,I1,I2,ICOL,IROW,IRGB,ILEG
 ...
 DO
  ...
  SELECT CASE (ITYPE)
   ...
   CASE (PUSHBUTTON)
    SELECT CASE (MESSAGE%VALUE1)
     CASE (IDHELP)
       CALL IMODGETHELP('4.2.5','MMO.IPO.IPFFin') !ID 1040
     CASE (IDCANCEL)
      EXIT
     CASE (IDOK)
