...
!     WRITE(*,*) 2,LEX
 ...
 ALLOCATE(XPOL(MAXPOL),YPOL(MAXPOL),XPOL2(MAXPOL),YPOL2(MAXPOL))
 NPOL=1
...
!        IF(UTL_INSIDEPOLYGON(IPF(IIPF)%XYZ(1,I),IPF(IIPF)%XYZ(2,I),XPOL,YPOL,XPOL2,YPOL2,NPOL).EQ.1)IPF(IIPF)%IP(I)=INT(IDMENU,1)
!       ENDIF
!      END DO
!     END DO
