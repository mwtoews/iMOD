...
!    write(*,*) '"'//LABELS_TMP(I)//'","'//PARAM(J)%ACRONYM//'"'
 ...
 IF(IPARAM.EQ.1)THEN
  ...
  DO I=1,SIZE(IPEST)
   IF(I.EQ.1)THEN
    CALL DBL_IGRMOVETO(REAL(I-1,8),IPEST(I)%PJ)
   ELSE
    CALL DBL_IGRLINETO(REAL(I-1,8),IPEST(I)%PJ)
   ENDIF
  ENDDO
  CALL IGRCOLOURN(WRGB(0,0,255))
  DO I=1,SIZE(IPEST)
   IF(I.EQ.1)THEN
    CALL DBL_IGRMOVETO(REAL(I-1,8),IPEST(I)%RJ)
   ELSE
    CALL DBL_IGRLINETO(REAL(I-1,8),IPEST(I)%RJ)
   ENDIF
  ENDDO
 ELSE
  DO I=1,SIZE(IPEST)
