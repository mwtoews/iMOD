...
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_GETUNIQUE_INT,ITOS,UTL_MESSAGEHANDLE,UTL_GOODNESS_OF_FIT,RTOS,UTL_GETMED,UTL_GETAXESCALES, &
             SXVALUE,SYVALUE,NSX,NSY,UTL_GETMED,UTL_STDEF,UTL_IDFGETCLASS
USE MOD_DBL
...
!     CALL IPEST_ANALYSE_READLOG('d:\COMPILE\OSSDELTARES\iMOD\TUTORIALS\IMOD_USER\MODELS\TUT_PST_OPTIMIZE\pest')
  ...
  CASE (FIELDCHANGED)
   SELECT CASE (MESSAGE%VALUE2)
    CASE (IDF_TRACKBAR1,IDF_RADIO1,IDF_RADIO2,IDF_RADIO3,IDF_RADIO4,IDF_RADIO5,IDF_RADIO7,IDF_RADIO8,IDF_RADIO9,IDF_RADIO10)
...
!   CASE (4);
 ...
 IF(IPARAM.EQ.1)THEN
  YTITLE='Objective Function Value (Summed Quadratic)'
 ELSEIF(IPARAM.EQ.2)THEN
  YTITLE='Objective Function Value (Summed Absolute)'
 ELSEIF(IPARAM.EQ.3)THEN
  YTITLE='Objective Function Value (Summed Difference)'
 ENDIF
