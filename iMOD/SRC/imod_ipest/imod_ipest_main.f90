  ...
  CASE (PUSHBUTTON)
   SELECT CASE (MESSAGE%VALUE1)
    ...
    CASE (ID_OPEN)
     ...
     CALL IPEST_ANALYSE_READLOG('h:\IMOD-MODELS\A27\REGISMODEL\RESULTS\RESULTS\2_REGIS_A27_V3A_GW1\A27_NAM\IPEST')
...
!     CALL IPEST_ANALYSE_READLOG('d:\IMOD-MODELS\SWISS\CALIBRATION\pest')
 ...
 DO
  ...
  IF(INDEX(LINE,'Parameter Correlation Matrix').GT.0)THEN
   ...
   DO I=1,N !SIZE(PARAM)
    READ(IU,'(A256)') LINE
    READ(LINE,'(15X,999F15.0)',IOSTAT=IOS) (IPEST(NPER)%CORR(IPS(I),IPS(J)),J=1,N) !SIZE(PARAM))
   ENDDO
  ENDIF
