  ...
  CASE (PUSHBUTTON)
   SELECT CASE (MESSAGE%VALUE1)
    ...
    CASE (ID_OPEN)
     ...
     IF(WINFODIALOG(4).EQ.1)CALL IPEST_ANALYSE_READLOG(DIR)
...
!     CALL IPEST_ANALYSE_READLOG('d:\IMOD-MODELS\SWISS\CALIBRATION\pest')
 ...
 IU=UTL_GETUNIT(); OPEN(IU,FILE=TRIM(DIR)//'\log_pest_efficiency.txt',STATUS='OLD',ACTION='READ')
 ...
 IU=UTL_GETUNIT(); OPEN(IU,FILE=TRIM(DIR)//'\log_pest.txt',STATUS='OLD',ACTION='READ')
 !## find number of parameters
 DO I=1,2
  NP=0
  DO
...
!    write(*,*) '"'//LABELS_TMP(I)//'","'//PARAM(J)%ACRONYM//'"'
 ...
 DO I=1,2
  DO J=1,SIZE(IPEST)
   NP=0
   IU=UTL_GETUNIT(); OPEN(IU,FILE=TRIM(DIR)//'\log_pest_residual_'//TRIM(ITOS(J-1))//'.txt',STATUS='OLD',ACTION='READ')
