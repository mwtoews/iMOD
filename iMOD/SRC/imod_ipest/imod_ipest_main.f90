...
USE MOD_IPEST_PAR
USE RESOURCE
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_GETUNIQUE_INT,ITOS,UTL_MESSAGEHANDLE
USE MOD_DBL
...
!   CASE (4);
 ...
 !## set axes
  ...
  SELECT CASE (I)
   ...
   !CASE (3); CALL IPEST_ANALYSE_PLOTGRAPH3()
   CASE (5); CALL IPEST_ANALYSE_PLOTGRAPH5()
...
!  YMIN=MINVAL(IPEST(IPOS)%MEASURE%Y); YMAX=MAXVAL(IPEST(IPOS)%MEASURE%Y)
 ...
 !###====================================================================
 SUBROUTINE IPEST_ANALYSE_PLOTGRAPH5()
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: IPOS,I,IPARAM
