...
!     CALL IPEST_ANALYSE_READLOG('d:\IMOD-MODELS\SWISS\CALIBRATION\pest')
 ...
 IF(IDZ.EQ.ID_ZOOMFULL)THEN
  CALL IPEST_ANALYSE_DIMGRAPH6(X1G6,Y1G6,X2G6,Y2G6) 
...
!    write(*,*) '"'//LABELS_TMP(I)//'","'//PARAM(J)%ACRONYM//'"'
 ...
 IF(ID.EQ.IDF_MENU1.OR.ID.EQ.IDF_MENU2.OR.ID.EQ.IDF_MENU3.OR.ID.EQ.IDF_MENU5)THEN
  ...
  DO I=1,IPEST(IPOS)%NMEASURE
   IPEST(IPOS)%MEASURE(I)%ISEL=IPEST_ANALYSE_QUERY(IPEST(IPOS)%MEASURE(I)%ILAY,IPEST(IPOS)%MEASURE(I)%IDATE,IPEST(IPOS)%MEASURE(I)%FNAME)
  ENDDO
 ENDIF
 ...
 !###====================================================================
 SUBROUTINE IPEST_ANALYSE_DIMGRAPH6(XMIN,YMIN,XMAX,YMAX) 
 !###====================================================================
 IMPLICIT NONE
 REAL(KIND=DP_KIND),INTENT(INOUT) :: XMIN,YMIN,XMAX,YMAX 
 INTEGER :: IPOS,J,IPARAM
 ...
 END SUBROUTINE IPEST_ANALYSE_DIMGRAPH6
...
!!! PEST BOOK 5.3.2.1 Goodness of Fit
 ...
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: IPOS,I,ICLR,IPARAM
 REAL(KIND=DP_KIND) :: D,D1,D2,D3,D4
 ...
 !###======================================================================
 INTEGER FUNCTION IPEST_ANALYSE_QUERY(JLAY,JDATE,FNAME)
 !###======================================================================
 IMPLICIT NONE
