...
!     CALL IPEST_ANALYSE_READLOG('d:\COMPILE\OSSDELTARES\iMOD\TUTORIALS\IMOD_USER\MODELS\TUT_PST_OPTIMIZE\pest')
  ...
  CASE (FIELDCHANGED)
   SELECT CASE (MESSAGE%VALUE2)
    CASE (IDF_TRACKBAR1,IDF_RADIO1,IDF_RADIO2,IDF_RADIO3,IDF_RADIO4,IDF_RADIO5,IDF_RADIO7,IDF_RADIO8,IDF_RADIO9,IDF_RADIO10,IDF_CHECK1)
...
!            BAF  0.5225715      0.6747234      0.8711757
!           FLOD   4.154494       4.893808       5.764686
!          FLUVD   1.814119       2.010956       2.229151
!           SWAD   1.576103       2.045984       2.655948
!          TORRD        Insens.        Insens.        Insens.
...
!  XMIN=-MAX(ABS(XMIN),ABS(XMAX))
 ...
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: I,J,K,IPARAM,IPOS,ICHECK
 REAL(KIND=DP_KIND) :: U,L,A,D,XS
