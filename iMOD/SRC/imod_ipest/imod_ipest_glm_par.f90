...
MODULE MOD_IPEST_GLM_PAR
 ...
 INTEGER,ALLOCATABLE,DIMENSION(:) :: GPARAM,LPARAM
 INTEGER :: IUPESTOUT,IUPESTPROGRESS,IUPESTEFFICIENCY,IUPESTSENSITIVITY,IUPESTRESIDUAL,IUPESTRUNFILE
 ...
 TYPE MSROBJ
  ...
  REAL(KIND=DP_KIND),POINTER,DIMENSION(:,:) :: DHG,DHL !,DH_DUMMY 
