...
MODULE MOD_IPEST_GLM_PAR
 ...
 INTEGER,ALLOCATABLE,DIMENSION(:) :: GPARAM,LPARAM,ISTATUS,STIME,ETIME
 ...
 REAL(KIND=DP_KIND),ALLOCATABLE,DIMENSION(:,:) :: SIGMA  !## stdev of data-error
 REAL(KIND=DP_KIND),ALLOCATABLE,DIMENSION(:,:) :: MU     !## mu of data-error
