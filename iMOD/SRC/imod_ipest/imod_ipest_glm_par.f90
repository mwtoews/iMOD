...
MODULE MOD_IPEST_GLM_PAR
 ...
 CHARACTER(LEN=256),ALLOCATABLE,DIMENSION(:) :: RN
 INTEGER,ALLOCATABLE,DIMENSION(:,:) :: IPROC
 !INTEGER,ALLOCATABLE,DIMENSION(:) :: ICPU
 INTEGER :: IUPESTOUT,IUPESTPROGRESS,IUPESTEFFICIENCY,IUPESTSENSITIVITY,IUPESTRUNFILE,IUPESTRESIDUAL
 ...
 TYPE MSROBJ
  ...
  REAL(KIND=DP_KIND),POINTER,DIMENSION(:) :: X,X_DUMMY
  REAL(KIND=DP_KIND),POINTER,DIMENSION(:) :: Y,Y_DUMMY
