 ...
 N=0; DO ISUB=1,PBMAN%NSUBMODEL
  ...
  IF(NOBS.GT.0)THEN
   ...
   DO IOBS=1,NOBS
    ...
    READ(KU,*)
    DO IPER=1,NPER
     READ(KU,*) H(IOBS,IPER)%ITIME,H(IOBS,IPER)%H,H(IOBS,IPER)%W,H(IOBS,IPER)%ILAY
    ENDDO
   ENDDO
   ...
   DO IOBS=1,NOBS
    ...
    IF(PRJNPER.EQ.1)THEN
     ...
     WRITE(IU,'(A)') TRIM(RTOS(X(IOBS),'F',3))//','//TRIM(RTOS(Y(IOBS),'F',3))//','//TRIM(ITOS(H(IOBS,IPER)%ILAY))//','// &
                     TRIM(RTOS(H(IOBS,IPER)%H,'F',3))//','//TRIM(RTOS(H(IOBS,IPER)%W,'F',3))//','//TRIM(RTOS(H(IOBS,IPER)%M,'F',3))
    ELSE
     FNAME=ONAME(IOBS)
     WRITE(IU,'(A)') TRIM(RTOS(X(IOBS),'F',3))//','//TRIM(RTOS(Y(IOBS),'F',3))//','//TRIM(ITOS(H(IOBS,1)%ILAY))//','// &
                     TRIM(FNAME)//','//TRIM(RTOS(H(IOBS,1)%W,'F',3))
