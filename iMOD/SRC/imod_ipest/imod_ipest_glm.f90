...
!  X1=
 ...
 ELSEIF(CTYPE.EQ.'R')THEN
  IF(ITER.EQ.0)THEN
   WRITE(IUPESTPROGRESS,'(I5,A15,15X,F15.3,30X,F15.7)') IGRAD,'REALS'//TRIM(ITOS(JGRAD)),MSR%TJ,ET
  ELSE
   WRITE(IUPESTPROGRESS,'(I5,A15,15X,F15.3,F15.3,15X,F15.7)') IGRAD,'REALS'//TRIM(ITOS(JGRAD)),MSR%TJ,MSR%TJ-JE(IGRAD,ITER-1),ET
  ENDIF
