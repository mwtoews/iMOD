...
MAINLOOP: DO 
  ...
  IF(ITER.GT.0)THEN
   ...
   IF(.NOT.IPEST_GLM_NEXT(IBATCH,ITER,DIR,LAMBDA,MNAME))THEN
    LAMBDA=LAMBDA*GAMMA
 ...
 !#####=================================================================
 LOGICAL FUNCTION IPEST_GLM_NEXT(IBATCH,ITER,DIR,LAMBDA,MNAME)
 !#####=================================================================
 IMPLICIT NONE
...
!
 ...
 ELSEIF(CTYPE.EQ.'L')THEN
  ...
  ELSE
   WRITE(IUPESTPROGRESS,'(I5,A15,E15.7,2F15.3,15X,3F15.3)') IGRAD,'LAMBDA'//TRIM(ITOS(JGRAD)),X1,MSR%TJ,MSR%TJ-MSR%PJ, &
