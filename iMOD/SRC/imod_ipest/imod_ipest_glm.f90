...
MAINLOOP: DO 
 ...
 REAL(KIND=DP_KIND),POINTER,DIMENSION(:,:) :: XORG,XADJ,ZONE
 ...
 DO I=1,2
  N=0; DO
   ...
   IF(I.EQ.2)THEN
    READ(LINE,*) (IDX(J,N),J=1,3),(X(J,N),J=1,NC)
   ENDIF
  ENDDO
  IF(I.EQ.1)THEN
   ALLOCATE(IDX(3,N),X(NC,N))
  ENDIF
  REWIND(IU)
 ENDDO
 ...
 DO I=1,SIZE(IDX,2)
  WRITE(IU,FRM) (IDX(J,I),J=1,3),(X(J,I),J=1,SIZE(X,1))
 ENDDO
