...
CONTAINS
 ...
 !#####=================================================================
 SUBROUTINE IPEST_GLM_MAIN(DIR,MNAME)
 !#####=================================================================
 IMPLICIT NONE
 ...
 IF(PBMAN%PTEST.EQ.1)THEN; CALL IPEST_GLM_TEST(DIR,MNAME); STOP; ENDIF
 ...
 DO 
  ...
  DO 
   ...
   DO
    ...
    !## define update in pst file
    IF(.NOT.IPEST_GLM_PST(DIR,MNAME,IGRAD,GPARAM(IGRAD),'P'))THEN; WRITE(*,'(/A/)') 'ERROR CREATED PST1 FILE FOR P#'//TRIM(ITOS(GPARAM(IGRAD))); STOP; ENDIF
    !## clear error
 ...
 !###====================================================================
 SUBROUTINE IPEST_GLM_TEST(DIR,MNAME)
 !###====================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,MNAME
