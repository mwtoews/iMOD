...
!  MO=0.5D0*MO  !## balance ...
 ...
 IF(ITER.GT.0)THEN
  ...
  WRITE(IUPESTEFFICIENCY,'(I10,99(1X,F15.3))') ITER,MSR%TJ,F3,SUM(SO),SUM(MO),MSR%J,F1,F2,LAMBDA, &
...
! STOP
 ...
 IF(ITER.GT.0.AND.LMODELERROR)THEN
 ...
 X1=REALS+PM1; IF(ITER.GT.0.AND.LMODELERROR)X1=X1+PM2
...
!SAVEDOUBLE 0
 ...
 WRITE(IUPESTEFFICIENCY,'(A10,10(1X,A15))') 'ITER','TOTAL-ERROR_NEW','TOTAL-ERROR_OLD','DATA-ERROR','MODEL-ERROR','AVG-RESIDUAL','RELATIVE','ABSOLUTE','LAMBDA','MEAN','STDEV'
