...
CONTAINS
 ...
 INTEGER :: I,II,J,K,IU,N,SPACEDIM,TIMEDIM,OBSDIM,IROW,ICOL,IX,IROW2,ICOL2
 TYPE(IDFOBJ) :: IDF
...
!    IF(.NOT.ALLOCATED(AM))ALLOCATE(AM(SPACEDIM,SPACEDIM)); AM=0.0D0
  ...
  DO J=1,SIZE(PEST%PARAM)
   DO K=1,TIMEDIM
    ...
    CALL UTL_STDEF(TMP1,SPACEDIM,PRJIDF%NODATA,PEST%PARAM(J)%STD(K),PEST%PARAM(J)%MEAN(K),N)
