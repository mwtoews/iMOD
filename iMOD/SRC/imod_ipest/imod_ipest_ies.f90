...
CONTAINS
 ...
 INTEGER :: ITER,IGRAD,ILOG,ILAMBDA,JLAMBDA,ILINE,KLINE,JLINE
 ...
 DO WHILE (ITER.LE.PEST%PE_MXITER)
  ...
  IF(ITER.EQ.0)THEN
   ...
   CALL IPEST_IES_WRITE_DHG(DIR,ITER,JLAMBDA,JLINE)    
  ...
  ELSE
   ...
   DO ILAMBDA=1,PBMAN%NLAMBDASEARCH
    ...
    DO ILINE=1,PBMAN%NLINESEARCH
     ...
     !## dump dhg as backstepping might be possible
     CALL IPEST_IES_WRITE_DHG(DIR,ITER,ILAMBDA,ILINE)
    ENDDO
   ...
   CALL IPEST_IES_READ_DHG(DIR,ITER,JLAMBDA,JLINE)    
   
  ENDIF

  !## get update of realisations
  IF(.NOT.IPEST_IES_UPDATE_ENSEMBLES(DIR,ITER,JLAMBDA,JLINE,IBATCH,MNAME))EXIT  
 ...
 !#####=================================================================
 LOGICAL FUNCTION IPEST_IES_UPDATE_ENSEMBLES(DIR,ITER,JLAMBDA,JLINE,IBATCH,MNAME) 
 !#####=================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR,MNAME
 INTEGER,INTENT(IN) :: IBATCH
 ...
 INTEGER :: I,II,JJ,J,K,N,SPACEDIM,TIMEDIM,OBSDIM,IROW,ICOL,IX,ILOG,ILAMBDA,IPARAM,NPOP,ILINE
...
! IF(TL.LT.PEST%PE_PADJ)IPEST_IES_UPDATE_ENSEMBLES=.FALSE.
 ...
 IF(PBMAN%NLAMBDASEARCH.GT.1)THEN !.AND.PBMAN%NLINESEARCH.EQ.1)THEN
  ...
  DO I=1,PBMAN%NLAMBDASEARCH
   MINJ=1.0D21; DO J=1,PBMAN%NLINESEARCH
    CALL IPEST_IES_READ_DHG(DIR,ITER,I,J)
    JJ=SUM(JE(:,ITER))
 ...
 !#####=================================================================
 SUBROUTINE IPEST_IES_WRITE_DHG(DIR,ITER,ILAMBDA,ILINE)
 !#####=================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR
 ...
 !#####=================================================================
 SUBROUTINE IPEST_IES_READ_DHG(DIR,ITER,ILAMBDA,ILINE)
 !#####=================================================================
 IMPLICIT NONE
 CHARACTER(LEN=*),INTENT(IN) :: DIR
 INTEGER,INTENT(IN) :: ITER,ILAMBDA,ILINE
 ...
 IU=UTL_GETUNIT(); OPEN(IU,FILE=TRIM(DIR)//'\IIES\DHG_ITER'//TRIM(ITOS(ITER))//'_ILAMBDA'// &
...
!  CALL UTL_MATMUL(xt3,xt2,xt4)
 ...
 !#####=================================================================
 SUBROUTINE IPEST_IES_COMPUTE_PARTIAL_M(ITER,IPARAM,TIMEDIM,SPACEDIM,OBSDIM,DM,A,REALS,L,LMODELERROR)
 !#####=================================================================
 IMPLICIT NONE
