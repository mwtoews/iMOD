...
CONTAINS
 ...
 REAL(KIND=DP_KIND),ALLOCATABLE,DIMENSION(:,:) :: U,V,AM,DM,TMP1,TMP2,TMP3
...
!## used for testing
 ...
 !## processing the inverse of the prior parameter covariance matrix
 DO I=1,SIZE(PEST%PARAM)
  CALL IPEST_IES_COMPUTE_PARTIAL_M1(I,TIMEDIM,SPACEDIM,OBSDIM,DM,A) 
 ...
 !#####=================================================================
 SUBROUTINE IPEST_IES_COMPUTE_PARTIAL_M1(IPARAM,TIMEDIM,SPACEDIM,OBSDIM,DM,A)
 !#####=================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IPARAM,TIMEDIM,SPACEDIM,OBSDIM
 REAL(KIND=DP_KIND),INTENT(IN) :: A
 REAL(KIND=DP_KIND),DIMENSION(TIMEDIM,SPACEDIM),INTENT(IN) :: DM
 REAL(KIND=DP_KIND),ALLOCATABLE,DIMENSION(:,:) :: X1,X2,X3,X4,X5,PM1,DD
