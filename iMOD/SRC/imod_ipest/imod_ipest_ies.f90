...
! A=LAMBDA+1.0D0
 ...
 ELSE
  ...
  IF(KLOG)THEN
   DO J=1,SPACEDIM; PEST%PARAM(IPARAM)%COV(J,J)=LOG(PEST%PARAM(IPARAM)%PARSTD)**2.0D0; ENDDO
  ELSE
   DO J=1,SPACEDIM; PEST%PARAM(IPARAM)%COV(J,J)=PEST%PARAM(IPARAM)%PARSTD**2.0D0; ENDDO
  ENDIF
