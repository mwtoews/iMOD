...
TYPE MEASOBJ
 REAL(KIND=DP_KIND) :: X,Y,COM,OBS,W,RDATE
 INTEGER :: ILAY,ISEL
 INTEGER :: SLAY,SPER,SFNM
...
CHARACTER(LEN=32),ALLOCATABLE,DIMENSION(:) :: CFNAME
CHARACTER(LEN=16),ALLOCATABLE,DIMENSION(:) :: CPERIOD,CLAY
INTEGER,ALLOCATABLE,DIMENSION(:) :: IPERIOD,ILAY,LPARAM,IFNAME
