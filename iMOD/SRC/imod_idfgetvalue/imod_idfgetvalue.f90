      ...
      IF(IDOWN.EQ.1)THEN
       ...
       DO I=1,NIDFS
        ...
        ELSE
         ...
         CALL IDFGETVALUE_SETPLACES(I,IDFVAL)
!         CALL WGRIDPUTCELLREAL(IDF_GRID1,2,I,IDFVAL,TRIM(IDFFORMAT)) !,'(G15.7)')
        ENDIF
       END DO
       CALL WDIALOGSETFIELD(IDF_LABEL11)
      ENDIF
...
! CALL IDFGETVALUE_FIELDS(0)
 ...
 !###======================================================================
 SUBROUTINE IDFGETVALUE_SETPLACES(IROW,IDFVAL)
 !###======================================================================
 IMPLICIT NONE
 INTEGER,INTENT(IN) :: IROW
 REAL,INTENT(IN) :: IDFVAL
 INTEGER :: PLACES,DECPLACES,IFORM
 CHARACTER(LEN=52) :: STRING,IDFFORMAT
 ...
 CALL WDIALOGRANGEINTEGER(IDF_INTEGER1,1,12)
 CALL WDIALOGRANGEINTEGER(IDF_INTEGER2,0,12) 
 ...
 WRITE(STRING,TRIM(IDFFORMAT)) IDFVAL
 CALL WGRIDPUTCELLSTRING(IDF_GRID1,2,IROW,TRIM(STRING))
