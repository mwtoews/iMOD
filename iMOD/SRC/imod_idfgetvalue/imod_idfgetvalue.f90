...
CONTAINS
 ...
 I=(NIDFS-2)*(268-80)/16
 CALL WDIALOGSIZE(IHEIGHT=130+I)
...
! CALL IDFGETVALUE_FIELDS(0)
 ...
 CALL WDIALOGSELECT(ID_DIDFINFO)
 CALL WDIALOGGETINTEGER(IDF_INTEGER1,PLACES)
 ...
 IF(IDFVALSP.EQ.NODATA)NUMBER='NaN'
 IF(IOS.NE.0)NUMBER='NaN'
 IF(IOS.NE.0)NUMBER='Nodata'
