...
! Y1=MIN(YMIN,YMAX); Y2=MAX(YMIN,YMAX); YMIN=Y1; YMAX=Y2
 ...
 IF(ID.NE.IDF_REAL1)CALL WDIALOGPUTREAL(IDF_REAL1,XMIN,'(G15.7)')
 IF(ID.NE.IDF_REAL2)CALL WDIALOGPUTREAL(IDF_REAL2,YMIN,'(G15.7)')
 IF(ID.NE.IDF_REAL5)CALL WDIALOGPUTREAL(IDF_REAL5,YMAX,'(G15.7)')
 IF(ID.NE.IDF_REAL6)CALL WDIALOGPUTREAL(IDF_REAL6,XMAX,'(G15.7)')
...
!       IC=INT(XA(J)); IR=INT(YA(J))
 ...
 IF(IEDIT.EQ.0)THEN
  ...
  CALL WDIALOGSELECT(ID_DCREATEIDF)
  CALL WDIALOGPUTREAL(IDF_REAL1,XMIN,'(G15.7)')
  CALL WDIALOGPUTREAL(IDF_REAL2,YMIN,'(G15.7)')
  CALL WDIALOGPUTREAL(IDF_REAL5,YMAX,'(G15.7)')
  CALL WDIALOGPUTREAL(IDF_REAL6,XMAX,'(G15.7)')
