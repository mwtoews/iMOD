...
CONTAINS
 ...
 !###====================================================================
 INTEGER FUNCTION COLOUR_RANDOM()
 !###====================================================================
 IMPLICIT NONE
 INTEGER :: ICLR,IR,IG,IB

 ICLR=(IRANDOMNUMBER(1)-0.0101D0)*3+1
 SELECT CASE (ICLR)
  CASE (0,1)
   IR=IRANDOMNUMBER(1)*255
   IG=IRANDOMNUMBER(1)*255
   COLOUR_RANDOM=WRGB(IR,IG,255)
  CASE (2)
   IR=IRANDOMNUMBER(1)*255
   IB=IRANDOMNUMBER(1)*255
   COLOUR_RANDOM=WRGB(IR,255,IB)
  CASE (3)
   IG=IRANDOMNUMBER(1)*255
   IB=IRANDOMNUMBER(1)*255
   COLOUR_RANDOM=WRGB(255,IG,IB)
 END SELECT

 END FUNCTION COLOUR_RANDOM
