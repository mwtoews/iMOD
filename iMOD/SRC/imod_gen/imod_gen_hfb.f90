...
!USE MOD_UTL, ONLY : PRINTTEXT,OPENASC,UTL_SWAPSLASH,UTL_STRING,UTL_CAP,UTL_FILENAME,UTL_GETUNIT, &
!  INTERSECT_NONEQUI,INTERSECT_EQUI
USE MOD_INTERSECT
USE MOD_INTERSECT_PAR
USE MOD_IDF_PAR

!INTEGER,ALLOCATABLE,DIMENSION(:),PRIVATE :: HFBIP
...
CONTAINS
 ...
 ILINE=0
 CALL OPENASC(JU,FNAME,'R')
 DO
  ILINE=ILINE+1
  II=0
  READ(JU,'(A256)') LINE; CALL UTL_STRING(LINE); CALL UTL_CAP(LINE,'U')
  IOS=0
