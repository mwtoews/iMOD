...
CONTAINS
   ...
   SELECT CASE (ITYPE)
    ...
    CASE (PUSHBUTTON)
     ...
     CASE (ID_STAT)
      ...
      CALL INFOSTAT(MP(IPLOT)%IDFNAME,0,0,0)
 ...
 !###======================================================================
 SUBROUTINE INFOSTAT(FNAME,IU,I,IFORMAT,XMIN,YMIN,XMAX,YMAX)
 !###======================================================================
 IMPLICIT NONE
 TYPE(WIN_MESSAGE) :: MESSAGE
 INTEGER,INTENT(IN) :: IU,I,IFORMAT
 ...
 IF(.NOT.INFOADJUST)CALL WMESSAGEBOX(OKONLY,INFORMATIONICON,COMMONOK,'iMOD can not change the IDF.','Information')
