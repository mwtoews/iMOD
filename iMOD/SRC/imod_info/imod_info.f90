...
CONTAINS
 ...
 CALL WGRIDPUTCELLREAL  (IDF_GRID1,2,3,MEAN,'(G15.7)')
 CALL WGRIDPUTCELLSTRING(IDF_GRID1,1,4,'Standard Deviation')
 CALL WGRIDPUTCELLREAL  (IDF_GRID1,2,4,VAR,'(G15.7)')
 CALL WGRIDPUTCELLSTRING(IDF_GRID1,1,5,'Sum')
 CALL WGRIDPUTCELLREAL  (IDF_GRID1,2,5,MEAN*REAL(NPOP),'(G15.7)')
 ...
 IF(IU.EQ.0)THEN
  !## clear all
  DO I=J+1,WINFOGRID(IDF_GRID1,GRIDROWSMAX)
