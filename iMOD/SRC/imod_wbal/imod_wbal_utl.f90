...
CONTAINS
 ...
 BUDGET%IACT=0; N=0; IF(.NOT.UTL_READPOINTER(IU,N,ITMP,'BDGIACT',1,IECHO=0))RETURN
 ...
 !## set units
 IF(IUNIT.EQ.1)CALL WDIALOGPUTRADIOBUTTON(IDF_RADIO1)
 IF(IUNIT.EQ.2)CALL WDIALOGPUTRADIOBUTTON(IDF_RADIO2)
