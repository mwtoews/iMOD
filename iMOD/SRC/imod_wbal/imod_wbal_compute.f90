...
USE MOD_UTL, ONLY : ITOS,UTL_GETUNIT,RTOS,UTL_CAP,JD,UTL_IDATETOJDATE,UTL_SUBST,UTL_GDATE,UTL_JDATETOIDATE,CLOSEUNITS, &
...
! CALL PROFILE_PLOTGRAPH('Time','Volumes (mm/d)',.TRUE.)
 ...
 IF(WBAL_ISTEADY.EQ.0)THEN
  ...
  JDATE=JD(IY,IM,ID)
  LEX=JDATE.GE.WBAL_TYR.AND.JDATE.LE.WBAL_TYR
