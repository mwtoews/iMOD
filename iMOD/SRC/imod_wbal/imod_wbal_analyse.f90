  ...
  CASE (FIELDCHANGED)
   ...
   SELECT CASE (MESSAGE%VALUE2)
    CASE (IDF_RADIO1,IDF_RADIO2,IDF_RADIO3,IDF_RADIO4,IDF_RADIO5)
     ...
     CALL WDIALOGPUTSTRING(ID_PREVIEW,TRIM(TEXT1))
     CALL WDIALOGPUTSTRING(ID_GRAPHICS,TRIM(TEXT2))
   END SELECT
 END SELECT
...
!## in graph plot optie maken om de bmp te saven en terug te keren - loopn of graphnames()
...
! IF(MDATE.GT.NROW)THEN
 ...
 CHARACTER(LEN=256) :: FNAME
 CHARACTER(LEN=16) :: CDATE
 INTEGER :: I,J,K,II,JJ,IROW,ICOL,IZ
   ...
   K=0; DO II=1,NLAY
    ...
    DO JJ=1,NZONE
     ...
     DO IROW=1,IDF%NROW; DO ICOL=1,IDF%NCOL
      ...
      IDF%X(ICOL,IROW)=GRAPH(J,K)%RY(I)
     ENDDO; ENDDO
     
!   WRITE(IU,'(999A14)') TRIM(CDATE),(','//TRIM(RTOS(REAL(GRAPH(J,K)%RY(I)),'G',7)),J=1,MBUDGET)
