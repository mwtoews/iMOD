...
USE MOD_UTL, ONLY : UTL_GETUNIT,UTL_CAP,UTL_IDATETOJDATE,UTL_JDATETOIDATE,ITOS,IDATETOGDATE,UTL_GDATE,UTL_GETUNIQUE_CHAR, &
            UTL_WSELECTFILE,RTOS,UTL_DEBUGLEVEL,UTL_GETUNIQUE_INT,UTL_MESSAGEHANDLE
...
! IF(MDATE.GT.NROW)THEN
 ...
 DO IG=1,MGROUP 
  ...
  WRITE(IU,'(/999A)') 'Period',(','//TRIM(GRAPH(J,IG)%LEGTXT),J=1,MBUDGET)
  WRITE(IU,'(/999A)') (',IN,OUT',J=1,MBUDGET)
