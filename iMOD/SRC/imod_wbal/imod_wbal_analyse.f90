...
!              00/ !## 24 qmodf
 ...
 SELECT CASE (IOPT)
  ...
  CASE (2)
   ...
   IF(ID.EQ.ID_PREVIEW.AND.N.GT.25)THEN
...
! ENDIF
 ...
 DO I=1,SIZE(GRAPHDIM%XTXT)
  ...
  DO J=1,MBUDGET
   ...
   K=0; DO II=1,NLAY
    ...
    FNAME=TRIM(DIR)//'\'//TRIM(GRAPH(J,K)%LEGTXT)//'_'//TRIM(CDATE)//'.IDF'

    !## save idf file
    IF(.NOT.IDFWRITE(IDF,FNAME,0))THEN
 ...
 CALL WMESSAGEBOX(OKONLY,INFORMATIONICON,COMMONOK,'Succesfully saved the current waterbalance to IDF file in:'//CHAR(13)// &
