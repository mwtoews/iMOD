 ...
 SELECT CASE (IOPT)
  ...
  CASE (2)
   ...
   DO IG=1,SIZE(GRAPHNAMES)
    ...
    CALL WBAL_ANALYSE_PLOTIMAGE(ID,IG,I1,I2,DIR,GTITLE,IUNIT,LSUM)
   ENDDO
  !## table
  CASE (3)
...
! IF(IOPT.EQ.1)THEN
 ...
 DO I=1,MBUDGET
  IF(MOD(I,2).EQ.0)THEN
   IF(INET.EQ.0)CALL WGRIDLABELCOLUMN(IDF_GRID1,I,TRIM(GRAPH(I,1)%LEGTXT)//'_out')
   IF(INET.EQ.1)CALL WGRIDLABELCOLUMN(IDF_GRID1,I,'Net_'//TRIM(GRAPH(I,1)%LEGTXT)//'_out')
  ELSE
   IF(INET.EQ.0)CALL WGRIDLABELCOLUMN(IDF_GRID1,I,TRIM(GRAPH(I-1,1)%LEGTXT)//'_in')
   IF(INET.EQ.1)CALL WGRIDLABELCOLUMN(IDF_GRID1,I,'Net_'//TRIM(GRAPH(I-1,1)%LEGTXT)//'_in')
  ENDIF
 ENDDO
 ...
 !###======================================================================
 SUBROUTINE WBAL_ANALYSE_PLOTIMAGE(ID,IG,IP1,IP2,DIR,GTITLE,IUNIT,LSUM)
 !###======================================================================
 IMPLICIT NONE
 ...
 LOGICAL :: LOCAL,LPERC
 INTEGER :: IOS,I,II,J,IBITMAP,IWINDOW,I1,I2,IB,IT,NCF,IZ,IIG
...
!!     Q(12,1)=QEVT_IN   Q(12,1)=QEVT_OUT    Q(24,1)=QMODF_IN  Q(24,1)=QMODF_OUT   
  ...
  ELSE
   ...
   PNGNAME=TRIM(DIR)//'\FIGURE_'//TRIM(ITOS(IT))//'.PNG'
