...
!       CALL WEDITFILE(FNAME,ITYPE=MODAL,IDMENU=0,IFONT=COURIERNEW,ISIZE=10)
 ...
 ENDIF
 IF(ST1ERROR(IOS,'iMOD can not open file '//TRIM(SCFFNAME)).NE.0)RETURN
...
! CALL STMON1TITLE() 
 ...
 IF(TRIM(PREFVAL(10)).EQ.'')THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not initiate SCENARIO-tool since the variable SCENTOOL '//CHAR(13)// &
 ...
 IF(.NOT.LEX)THEN
  CALL WMESSAGEBOX(OKONLY,EXCLAMATIONICON,COMMONOK,'iMOD can not initiate SCENARIO-tool since file: '//CHAR(13)// &
...
!  RES(I)%NFILES=0
 ...
 IF(WINFODIALOG(4).EQ.1)THEN
  IF(.NOT.ST1SAVELOAD(ID_SAVEAS))RETURN  !## yes, do save and quit if succesfull
 ENDIF
