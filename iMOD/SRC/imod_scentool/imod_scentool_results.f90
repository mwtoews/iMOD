...
USE MOD_UTL, ONLY : UTL_HIDESHOWDIALOG,UTL_CREATEDIR,UTL_MESSAGEHANDLE,UTL_GETUNIT,ITOS,RTOS,UTL_JDATETOIDATE,UTL_DEL1TREE, &
                    UTL_IDATETOJDATE,UTL_FILLDATESDIALOG,UTL_DIRINFO,UTL_IDFGETDATE,JDATETOGDATE,UTL_DIALOGSHOW
...
! DIR=SCFFNAME(:INDEX(SCFFNAME,'\',.TRUE.))
...
! IF(ALLOCATED(RY))DEALLOCATE(RY)
 ...
 PBMAN%IDOUBLE=0; PBMAN%ICONSISTENCY=1; PBMAN%MINTHICKNESS=0.0D0
 PBMAN%INT=1; PBMAN%IEXPORTMF2005=1
